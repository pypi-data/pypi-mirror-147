...
# naplan
naplan_folder = "naplan"
naplan_outcomes_folder = ""

naplan_outcomes_dir = os.path.join(root_dir, naplan_folder)
...
pat_sittings_folder = "PAT sittings"
ewrite_sittings_folder = "eWrite sittings"
...
pat_sittings_dir = os.path.join(oars_dir, pat_sittings_folder)
