...
from mcli.api.schema.run import GraphQLRunType, get_run_schema
from mcli.api.types import GraphQLQueryVariable, GraphQLVariableType


def get_runs(include_deleted: bool = False) -> Optional[List[GraphQLRunType]]:
    ...
    response = run_graphql_success_query(
        ...
        return_model_type=GraphQLRunType,
        variables=variables,
    )
