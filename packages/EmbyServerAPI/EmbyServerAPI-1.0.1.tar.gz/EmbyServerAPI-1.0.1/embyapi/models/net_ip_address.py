...
class NetIPAddress(object):
    ...
    def __init__(self, address_family=None, scope_id=None, is_i_pv6_multicast=None, is_i_pv6_link_local=None, is_i_pv6_site_local=None, is_i_pv6_teredo=None, is_i_pv4_mapped_to_i_pv6=None, address=None, _configuration=None):  # noqa: E501
    ...
    def address_family(self, address_family):
        ...
        if (self._configuration.client_side_validation and
                address_family not in allowed_values):
            raise ValueError(
