...
class ProvidersSongInfo(object):
    ...
    def __init__(self, album_artists=None, album=None, artists=None, composers=None, name=None, metadata_language=None, metadata_country_code=None, provider_ids=None, year=None, index_number=None, parent_index_number=None, premiere_date=None, is_automated=None, enable_adult_metadata=None, _configuration=None):  # noqa: E501
