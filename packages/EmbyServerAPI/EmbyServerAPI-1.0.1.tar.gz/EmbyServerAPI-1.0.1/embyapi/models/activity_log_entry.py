...
class ActivityLogEntry(object):
    ...
    def __init__(self, id=None, name=None, overview=None, short_overview=None, type=None, item_id=None, _date=None, user_id=None, user_primary_image_tag=None, severity=None, _configuration=None):  # noqa: E501
