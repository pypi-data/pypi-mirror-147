...
class TranscodingInfo(object):
    ...
    def transcode_reasons(self, transcode_reasons):
        ...
        if (self._configuration.client_side_validation and
                not set(transcode_reasons).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
