...
class UpdatesInstallationInfo(object):
    ...
    def __init__(self, id=None, name=None, assembly_guid=None, version=None, update_class=None, percent_complete=None, _configuration=None):  # noqa: E501
    ...
    def update_class(self, update_class):
        ...
        if (self._configuration.client_side_validation and
                update_class not in allowed_values):
            raise ValueError(
