...
class ItemLookupServiceApi(object):
    ...
    def get_items_remotesearch_image_with_http_info(self, image_url, provider_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('image_url' not in params or
                                                       params['image_url'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('provider_name' not in params or
                                                       params['provider_name'] is None):  # noqa: E501
    ...
    def post_items_remotesearch_apply_by_id(self, id, body, **kwargs):  # noqa: E501
        """Applies search criteria to an item and refreshes metadata  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_remotesearch_apply_by_id(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_items_remotesearch_apply_by_id_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_items_remotesearch_apply_by_id_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def post_items_remotesearch_apply_by_id_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Applies search criteria to an item and refreshes metadata  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_remotesearch_apply_by_id_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'body', 'replace_all_images']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
