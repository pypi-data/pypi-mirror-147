...
class PlayerStateInfo(object):
    ...
    def __init__(self, position_ticks=None, can_seek=None, is_paused=None, is_muted=None, volume_level=None, audio_stream_index=None, subtitle_stream_index=None, media_source_id=None, play_method=None, repeat_mode=None, subtitle_offset=None, playback_rate=None, _configuration=None):  # noqa: E501
    ...
    def play_method(self, play_method):
        ...
        if (self._configuration.client_side_validation and
                play_method not in allowed_values):
            raise ValueError(
    ...
    def repeat_mode(self, repeat_mode):
        ...
        if (self._configuration.client_side_validation and
                repeat_mode not in allowed_values):
            raise ValueError(
