...
class PlayRequest(object):
    ...
    def __init__(self, controlling_user_id=None, subtitle_stream_index=None, audio_stream_index=None, media_source_id=None, start_index=None, _configuration=None):  # noqa: E501
