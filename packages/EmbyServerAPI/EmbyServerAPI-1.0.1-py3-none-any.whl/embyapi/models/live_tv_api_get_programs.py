...
class LiveTVApiGetPrograms(object):
    ...
    def __init__(self, is_airing=None, tag_ids=None, exclude_item_ids=None, enable_total_record_count=None, series_timer_id=None, library_series_id=None, series_from_program_id=None, showings_from_program_id=None, group_programs_by_series=None, _configuration=None):  # noqa: E501
