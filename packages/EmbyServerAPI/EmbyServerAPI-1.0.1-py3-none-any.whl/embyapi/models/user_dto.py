...
class UserDto(object):
    ...
    def __init__(self, name=None, server_id=None, server_name=None, connect_user_name=None, connect_link_type=None, id=None, primary_image_tag=None, has_password=None, has_configured_password=None, has_configured_easy_password=None, enable_auto_login=None, last_login_date=None, last_activity_date=None, configuration=None, policy=None, primary_image_aspect_ratio=None, _configuration=None):  # noqa: E501
    ...
    def connect_link_type(self, connect_link_type):
        ...
        if (self._configuration.client_side_validation and
                connect_link_type not in allowed_values):
            raise ValueError(
