...
class BaseItemDto(object):
    ...
    def video3_d_format(self, video3_d_format):
        ...
        if (self._configuration.client_side_validation and
                video3_d_format not in allowed_values):
            raise ValueError(
    ...
    def play_access(self, play_access):
        ...
        if (self._configuration.client_side_validation and
                play_access not in allowed_values):
            raise ValueError(
    ...
    def air_days(self, air_days):
        ...
        if (self._configuration.client_side_validation and
                not set(air_days).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def locked_fields(self, locked_fields):
        ...
        :type: list[str]
        """
        allowed_values = ["Cast", "Genres", "ProductionLocations", "Studios", "Tags", "Name", "Overview", "Runtime", "OfficialRating", "Collections", "ChannelNumber"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(locked_fields).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
    ...
    def image_orientation(self, image_orientation):
        ...
        if (self._configuration.client_side_validation and
                image_orientation not in allowed_values):
            raise ValueError(
