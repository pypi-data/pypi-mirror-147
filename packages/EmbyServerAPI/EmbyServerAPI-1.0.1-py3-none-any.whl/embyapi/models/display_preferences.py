...
class DisplayPreferences(object):
    ...
    def __init__(self, id=None, view_type=None, sort_by=None, index_by=None, remember_indexing=None, primary_image_height=None, primary_image_width=None, custom_prefs=None, scroll_direction=None, show_backdrop=None, remember_sorting=None, sort_order=None, client=None, _configuration=None):  # noqa: E501
    ...
    def scroll_direction(self, scroll_direction):
        ...
        if (self._configuration.client_side_validation and
                scroll_direction not in allowed_values):
            raise ValueError(
