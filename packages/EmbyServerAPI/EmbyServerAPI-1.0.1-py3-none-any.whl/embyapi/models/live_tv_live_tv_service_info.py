...
class LiveTvLiveTvServiceInfo(object):
    ...
    def __init__(self, name=None, home_page_url=None, status=None, status_message=None, version=None, has_update_available=None, is_visible=None, tuners=None, _configuration=None):  # noqa: E501
