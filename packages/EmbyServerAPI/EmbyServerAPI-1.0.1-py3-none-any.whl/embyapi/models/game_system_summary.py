...
class GameSystemSummary(object):
    ...
    def __init__(self, name=None, display_name=None, game_count=None, game_file_extensions=None, client_installed_game_count=None, _configuration=None):  # noqa: E501
