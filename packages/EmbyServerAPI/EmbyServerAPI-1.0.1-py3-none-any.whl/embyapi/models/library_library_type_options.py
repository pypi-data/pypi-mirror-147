...
class LibraryLibraryTypeOptions(object):
    ...
    def __init__(self, type=None, metadata_fetchers=None, image_fetchers=None, supported_image_types=None, default_image_options=None, _configuration=None):  # noqa: E501
    ...
    def supported_image_types(self, supported_image_types):
        ...
        if (self._configuration.client_side_validation and
                not set(supported_image_types).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
