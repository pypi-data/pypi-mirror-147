...
class UpdatesPackageVersionInfo(object):
    ...
    def __init__(self, name=None, guid=None, version_str=None, classification=None, description=None, required_version_str=None, source_url=None, checksum=None, target_filename=None, info_url=None, runtimes=None, _configuration=None):  # noqa: E501
