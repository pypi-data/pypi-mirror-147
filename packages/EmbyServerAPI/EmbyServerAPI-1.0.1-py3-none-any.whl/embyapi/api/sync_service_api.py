...
class SyncServiceApi(object):
    ...
    def post_sync_by_itemid_status(self, item_id, body, **kwargs):  # noqa: E501
        """Gets sync status for an item.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_sync_by_itemid_status(item_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_sync_by_itemid_status_with_http_info(item_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_sync_by_itemid_status_with_http_info(item_id, body, **kwargs)  # noqa: E501
            return data

    def post_sync_by_itemid_status_with_http_info(self, item_id, body, **kwargs):  # noqa: E501
        """Gets sync status for an item.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_sync_by_itemid_status_with_http_info(item_id, body, async_req=True)
        >>> result = thread.get()
    ...
    def post_sync_jobs_by_id(self, id, body, **kwargs):  # noqa: E501
        """Updates a sync job.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_sync_jobs_by_id(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_sync_jobs_by_id_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_sync_jobs_by_id_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def post_sync_jobs_by_id_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Updates a sync job.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_sync_jobs_by_id_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
