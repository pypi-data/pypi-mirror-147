...
class ScheduledTaskServiceApi(object):
    ...
    def post_scheduledtasks_by_id_triggers(self, id, body, **kwargs):  # noqa: E501
        """Updates the triggers for a scheduled task  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_scheduledtasks_by_id_triggers(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_scheduledtasks_by_id_triggers_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_scheduledtasks_by_id_triggers_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def post_scheduledtasks_by_id_triggers_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Updates the triggers for a scheduled task  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_scheduledtasks_by_id_triggers_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
