...
class EnvironmentServiceApi(object):
    ...
    def post_environment_validatepath(self, path, body, **kwargs):  # noqa: E501
        """Gets the contents of a given directory in the file system  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_environment_validatepath(path, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_environment_validatepath_with_http_info(path, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_environment_validatepath_with_http_info(path, body, **kwargs)  # noqa: E501
            return data

    def post_environment_validatepath_with_http_info(self, path, body, **kwargs):  # noqa: E501
        """Gets the contents of a given directory in the file system  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_environment_validatepath_with_http_info(path, body, async_req=True)
        >>> result = thread.get()
