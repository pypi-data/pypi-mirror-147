...
class DisplayPreferencesServiceApi(object):
    ...
    def post_displaypreferences_by_displaypreferencesid(self, display_preferences_id, user_id, body, **kwargs):  # noqa: E501
        """Updates a user's display preferences for an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_displaypreferences_by_displaypreferencesid(display_preferences_id, user_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_displaypreferences_by_displaypreferencesid_with_http_info(display_preferences_id, user_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_displaypreferences_by_displaypreferencesid_with_http_info(display_preferences_id, user_id, body, **kwargs)  # noqa: E501
            return data

    def post_displaypreferences_by_displaypreferencesid_with_http_info(self, display_preferences_id, user_id, body, **kwargs):  # noqa: E501
        """Updates a user's display preferences for an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_displaypreferences_by_displaypreferencesid_with_http_info(display_preferences_id, user_id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['display_preferences_id', 'user_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('display_preferences_id' not in params or
                                                       params['display_preferences_id'] is None):  # noqa: E501
