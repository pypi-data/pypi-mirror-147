...
class MediaInfoServiceApi(object):
    ...
    def post_items_by_id_playbackinfo(self, id, body, **kwargs):  # noqa: E501
        """Gets live playback media info for an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_playbackinfo(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_items_by_id_playbackinfo_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_items_by_id_playbackinfo_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def post_items_by_id_playbackinfo_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Gets live playback media info for an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_playbackinfo_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
    ...
    def post_livestreams_close_with_http_info(self, live_stream_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('live_stream_id' not in params or
                                                       params['live_stream_id'] is None):  # noqa: E501
