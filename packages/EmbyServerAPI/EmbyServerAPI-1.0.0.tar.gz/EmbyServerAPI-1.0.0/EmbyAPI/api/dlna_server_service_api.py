...
class DlnaServerServiceApi(object):
    ...
    def get_dlna_by_uuid_connectionmanager_connectionmanager_with_http_info(self, uu_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('uu_id' not in params or
                                                       params['uu_id'] is None):  # noqa: E501
    ...
    def post_dlna_by_uuid_connectionmanager_control(self, uu_id, body, **kwargs):  # noqa: E501
        """Processes a control request  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_dlna_by_uuid_connectionmanager_control(uu_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_dlna_by_uuid_connectionmanager_control_with_http_info(uu_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_dlna_by_uuid_connectionmanager_control_with_http_info(uu_id, body, **kwargs)  # noqa: E501
            return data

    def post_dlna_by_uuid_connectionmanager_control_with_http_info(self, uu_id, body, **kwargs):  # noqa: E501
        """Processes a control request  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_dlna_by_uuid_connectionmanager_control_with_http_info(uu_id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['uu_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_dlna_by_uuid_contentdirectory_control(self, uu_id, body, **kwargs):  # noqa: E501
        """Processes a control request  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_dlna_by_uuid_contentdirectory_control(uu_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_dlna_by_uuid_contentdirectory_control_with_http_info(uu_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_dlna_by_uuid_contentdirectory_control_with_http_info(uu_id, body, **kwargs)  # noqa: E501
            return data

    def post_dlna_by_uuid_contentdirectory_control_with_http_info(self, uu_id, body, **kwargs):  # noqa: E501
        """Processes a control request  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_dlna_by_uuid_contentdirectory_control_with_http_info(uu_id, body, async_req=True)
        >>> result = thread.get()
