...
class RemoteImageInfo(object):
    ...
    def __init__(self, provider_name=None, url=None, thumbnail_url=None, height=None, width=None, community_rating=None, vote_count=None, language=None, display_language=None, type=None, rating_type=None, _configuration=None):  # noqa: E501
    ...
    def rating_type(self, rating_type):
        ...
        if (self._configuration.client_side_validation and
                rating_type not in allowed_values):
            raise ValueError(
