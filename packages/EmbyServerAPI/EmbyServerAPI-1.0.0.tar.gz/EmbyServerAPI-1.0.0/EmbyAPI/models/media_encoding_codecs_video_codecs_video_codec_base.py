...
class MediaEncodingCodecsVideoCodecsVideoCodecBase(object):
    ...
    swagger_types = {
        ...
        'min_bit_rate': 'EmbyMediaModelTypesBitRate',
    ...
    def codec_kind(self, codec_kind):
        ...
        if (self._configuration.client_side_validation and
                codec_kind not in allowed_values):
            raise ValueError(
    ...
    def video_media_type(self, video_media_type):
        ...
        if (self._configuration.client_side_validation and
                video_media_type not in allowed_values):
            raise ValueError(
    ...
    def secondary_framework(self, secondary_framework):
        ...
        if (self._configuration.client_side_validation and
                secondary_framework not in allowed_values):
            raise ValueError(
