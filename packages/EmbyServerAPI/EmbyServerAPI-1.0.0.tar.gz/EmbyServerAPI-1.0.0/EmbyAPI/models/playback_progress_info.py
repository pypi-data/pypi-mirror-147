...
class PlaybackProgressInfo(object):
    ...
    def event_name(self, event_name):
        ...
        if (self._configuration.client_side_validation and
                event_name not in allowed_values):
            raise ValueError(
