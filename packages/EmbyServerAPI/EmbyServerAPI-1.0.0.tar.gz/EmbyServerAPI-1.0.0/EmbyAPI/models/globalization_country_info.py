...
class GlobalizationCountryInfo(object):
    ...
    def __init__(self, name=None, display_name=None, english_name=None, two_letter_iso_region_name=None, three_letter_iso_region_name=None, _configuration=None):  # noqa: E501
