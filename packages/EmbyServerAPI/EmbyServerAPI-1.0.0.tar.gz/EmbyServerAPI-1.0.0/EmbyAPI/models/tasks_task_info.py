...
class TasksTaskInfo(object):
    ...
    def __init__(self, name=None, state=None, current_progress_percentage=None, id=None, last_execution_result=None, triggers=None, description=None, category=None, is_hidden=None, key=None, _configuration=None):  # noqa: E501
