...
class TasksTaskResult(object):
    ...
    def __init__(self, start_time_utc=None, end_time_utc=None, status=None, name=None, key=None, id=None, error_message=None, long_error_message=None, _configuration=None):  # noqa: E501
