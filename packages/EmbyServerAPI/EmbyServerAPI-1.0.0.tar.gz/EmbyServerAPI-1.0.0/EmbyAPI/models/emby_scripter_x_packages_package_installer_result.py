...
class EmbyScripterXPackagesPackageInstallerResult(object):
    ...
    def __init__(self, package_id=None, package_name=None, package_version=None, installation_id=None, installation_name=None, package_description=None, install_result=None, error_message=None, _configuration=None):  # noqa: E501
    ...
    def install_result(self, install_result):
        ...
        if (self._configuration.client_side_validation and
                install_result not in allowed_values):
            raise ValueError(
