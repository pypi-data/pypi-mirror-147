...
class DevicesDeviceInfo(object):
    ...
    def __init__(self, name=None, id=None, last_user_name=None, app_name=None, app_version=None, last_user_id=None, date_last_activity=None, icon_url=None, _configuration=None):  # noqa: E501
