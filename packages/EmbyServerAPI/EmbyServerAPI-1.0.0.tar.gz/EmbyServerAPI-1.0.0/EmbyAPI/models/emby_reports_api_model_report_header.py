...
class EmbyReportsApiModelReportHeader(object):
    ...
    def __init__(self, header_field_type=None, name=None, field_name=None, sort_field=None, type=None, item_view_type=None, visible=None, display_type=None, show_header_label=None, can_group=None, _configuration=None):  # noqa: E501
    ...
    def header_field_type(self, header_field_type):
        ...
        if (self._configuration.client_side_validation and
                header_field_type not in allowed_values):
            raise ValueError(
    ...
    def field_name(self, field_name):
        ...
        if (self._configuration.client_side_validation and
                field_name not in allowed_values):
            raise ValueError(
    ...
    def item_view_type(self, item_view_type):
        ...
        if (self._configuration.client_side_validation and
                item_view_type not in allowed_values):
            raise ValueError(
