...
class VirtualFolderInfo(object):
    ...
    def __init__(self, name=None, locations=None, collection_type=None, library_options=None, item_id=None, primary_image_item_id=None, refresh_progress=None, refresh_status=None, _configuration=None):  # noqa: E501
