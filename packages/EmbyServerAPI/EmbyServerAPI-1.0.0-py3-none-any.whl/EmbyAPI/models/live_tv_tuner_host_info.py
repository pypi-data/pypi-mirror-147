...
class LiveTvTunerHostInfo(object):
    ...
    def __init__(self, id=None, url=None, type=None, device_id=None, friendly_name=None, import_favorites_only=None, allow_hw_transcoding=None, source=None, tuner_count=None, user_agent=None, referrer=None, _configuration=None):  # noqa: E501
