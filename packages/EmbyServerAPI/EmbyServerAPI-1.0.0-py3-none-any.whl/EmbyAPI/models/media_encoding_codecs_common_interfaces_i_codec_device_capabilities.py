...
class MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities(object):
    ...
    def __init__(self, supports_hw_upload=None, supports_hw_download=None, supports_standalone_device_init=None, supports10_bit_processing=None, supports_native_tone_mapping=None, _configuration=None):  # noqa: E501
