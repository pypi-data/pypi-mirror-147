...
class SystemInfo(object):
    ...
    def system_update_level(self, system_update_level):
        ...
        if (self._configuration.client_side_validation and
                system_update_level not in allowed_values):
            raise ValueError(
