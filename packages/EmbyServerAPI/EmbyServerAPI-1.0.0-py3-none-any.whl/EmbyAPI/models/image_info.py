...
class ImageInfo(object):
    ...
    def __init__(self, image_type=None, image_index=None, path=None, filename=None, height=None, width=None, size=None, _configuration=None):  # noqa: E501
    ...
    def image_type(self, image_type):
        ...
        if (self._configuration.client_side_validation and
                image_type not in allowed_values):
            raise ValueError(
