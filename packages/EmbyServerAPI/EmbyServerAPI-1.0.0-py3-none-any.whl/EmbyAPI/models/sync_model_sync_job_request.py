...
class SyncModelSyncJobRequest(object):
    ...
    def __init__(self, target_id=None, item_ids=None, category=None, parent_id=None, quality=None, profile=None, container=None, video_codec=None, audio_codec=None, name=None, user_id=None, unwatched_only=None, sync_new_content=None, item_limit=None, bitrate=None, downloaded=None, _configuration=None):  # noqa: E501
