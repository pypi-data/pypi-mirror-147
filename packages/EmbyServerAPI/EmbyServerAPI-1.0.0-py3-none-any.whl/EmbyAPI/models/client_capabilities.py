...
class ClientCapabilities(object):
    ...
    def __init__(self, playable_media_types=None, supported_commands=None, supports_media_control=None, push_token=None, push_token_type=None, supports_sync=None, device_profile=None, icon_url=None, app_id=None, _configuration=None):  # noqa: E501
