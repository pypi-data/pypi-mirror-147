...
class MediaEncodingCodecsCommonInterfacesICodecDeviceInfo(object):
    ...
    def __init__(self, capabilities=None, adapter=None, name=None, desription=None, driver=None, driver_version=None, api_version=None, vendor_id=None, device_id=None, device_identifier=None, hardware_context_framework=None, dev_path=None, drm_node=None, vendor_name=None, device_name=None, _configuration=None):  # noqa: E501
    ...
    def hardware_context_framework(self, hardware_context_framework):
        ...
        if (self._configuration.client_side_validation and
                hardware_context_framework not in allowed_values):
            raise ValueError(
