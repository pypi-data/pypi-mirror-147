...
class EmbyReportsApiModelReportRow(object):
    ...
    def __init__(self, id=None, has_image_tags_backdrop=None, has_image_tags_primary=None, has_image_tags_logo=None, has_local_trailer=None, has_lock_data=None, has_embedded_image=None, has_subtitles=None, has_specials=None, columns=None, row_type=None, user_id=None, _configuration=None):  # noqa: E501
    ...
    def row_type(self, row_type):
        ...
        if (self._configuration.client_side_validation and
                row_type not in allowed_values):
            raise ValueError(
