...
class TagServiceApi(object):
    ...
    def post_items_by_id_tags_add(self, id, body, **kwargs):  # noqa: E501
        """Adds new tags to an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_tags_add(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_items_by_id_tags_add_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_items_by_id_tags_add_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def post_items_by_id_tags_add_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Adds new tags to an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_tags_add_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
