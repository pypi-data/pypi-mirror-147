...
class ItemUpdateServiceApi(object):
    ...
    def post_items_by_itemid(self, item_id, body, **kwargs):  # noqa: E501
        """Updates an item  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_itemid(item_id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_items_by_itemid_with_http_info(item_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_items_by_itemid_with_http_info(item_id, body, **kwargs)  # noqa: E501
            return data

    def post_items_by_itemid_with_http_info(self, item_id, body, **kwargs):  # noqa: E501
        """Updates an item  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_itemid_with_http_info(item_id, body, async_req=True)
        >>> result = thread.get()
