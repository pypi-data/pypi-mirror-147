...
class ReportsServiceApi(object):
    ...
    def get_reports_activities_with_http_info(self, report_view, display_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('report_view' not in params or
                                                       params['report_view'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('display_type' not in params or
                                                       params['display_type'] is None):  # noqa: E501
