...
class DeviceServiceApi(object):
    ...
    def post_devices_camerauploads(self, device_id, album, name, id, body, **kwargs):  # noqa: E501
        """Uploads content  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_devices_camerauploads(device_id, album, name, id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_devices_camerauploads_with_http_info(device_id, album, name, id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_devices_camerauploads_with_http_info(device_id, album, name, id, body, **kwargs)  # noqa: E501
            return data

    def post_devices_camerauploads_with_http_info(self, device_id, album, name, id, body, **kwargs):  # noqa: E501
        """Uploads content  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_devices_camerauploads_with_http_info(device_id, album, name, id, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['device_id', 'album', 'name', 'id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_devices_options(self, body, **kwargs):  # noqa: E501
        """Updates device options  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_devices_options(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_devices_options_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_devices_options_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_devices_options_with_http_info(self, body, **kwargs):  # noqa: E501
        """Updates device options  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_devices_options_with_http_info(body, async_req=True)
        >>> result = thread.get()
