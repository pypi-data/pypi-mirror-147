...
!==============================================================================
subroutine invertCholesky(AA, nn)
!==============================================================================
...
!==============================================================================
  ...
  elseif (Error > 0) then
    call stopMLatomF('invertCholesky: Cholesky factorization could not be completed')
  elseif (Error < 0) then
...
!==============================================================================
  ...
  if (option%matDecomp == 'Cholesky') then
    call solveSysLinEqsCholesky(nn, nrhs, AA, bb, xx)
  elseif (option%matDecomp == 'LU') then
...
!==============================================================================
subroutine solveSysLinEqsCholesky(nn, nrhs, AA, bb, xx)
!==============================================================================
! Subroutine solves a system of linear equations AA*xx = bb
! It uses Cholesky factorization and MKL/Lapack subroutines
!==============================================================================
  ...
  elseif (Error > 0) then
    call stopMLatomF('solveSysLinEqsCholesky: Cholesky factorization could not be completed')
  elseif (Error < 0) then
