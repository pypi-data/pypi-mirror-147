...
class Sys:
    _hx_class_name = "Sys"
    __slots__ = ()
    _hx_statics = ["environ", "get_environ", "args", "environment", "systemName", "stdin", "stdout"]
    environ = None
...
class com_sdtk_std_FileReader(com_sdtk_std_AbstractReader):

    def __init__(self,sName):
        self._path = None
        super().__init__(sys_io_File.read(sName))
        self._path = sName

    def reset(self):
        super().reset()
        self._reader = sys_io_File.read(self._path)

    def convertToStringReader(self):
        sb_b = python_lib_io_StringIO()
        if (self._next is not None):
            sb_b.write(Std.string(self._next))
        s = self._reader.readString(10000)
        while ((s is not None) and ((len(s) > 0))):
            sb_b.write(Std.string(s))
            try:
                s = self._reader.readString(10000)
            except BaseException as _g:
                None
                s = None
        sr = com_sdtk_std_StringReader(sb_b.getvalue())
        self.dispose()
        return sr
...
class com_sdtk_std_FileWriter(com_sdtk_std_AbstractWriter):
    _hx_class_name = "com.sdtk.std.FileWriter"
    __slots__ = ()
    _hx_fields = []
    _hx_methods = ["convertToStringWriter"]
    _hx_statics = ["createWriter"]
    _hx_interfaces = []
    _hx_super = com_sdtk_std_AbstractWriter


    def __init__(self,sName,bAppend):
        super().__init__(com_sdtk_std_FileWriter.createWriter(sName,bAppend))
    ...
    @staticmethod
    def createWriter(sName,bAppend):
        if bAppend:
            return sys_io_File.append(sName,False)
        else:
            return sys_io_File.write(sName,False)

com_sdtk_std_FileWriter._hx_class = com_sdtk_std_FileWriter
...
class com_sdtk_std_StdinReader(com_sdtk_std_AbstractReader):

    def __init__(self):
        super().__init__(Sys.stdin())


class com_sdtk_std_StdoutWriter(com_sdtk_std_AbstractWriter):
...
class com_sdtk_table_AbstractTableRowWriter(com_sdtk_table_DataTableRowWriter):
    ...
    def __init__(self,tdInfo,oElement,sHeader):
        ...
        self._header = None
        super().__init__()
        self.reuse(tdInfo,oElement,sHeader)

    def reuse(self,tdInfo,oElement,sHeader):
        self._info = tdInfo
        self._element = oElement
        self._header = sHeader

    def getTag(self):
        return python_internal_ArrayImpl._get(self._info.Cell(), 0)
...
class com_sdtk_table_Converter:
    ...
    def convert(oSource,oTarget):
        com_sdtk_table_Converter.convertWithOptions(oSource,None,oTarget,None,None,None,None,None,None,False,False)

    @staticmethod
    def convertWithOptions(oSource,fSource,oTarget,fTarget,sFilterColumnsExclude,sFilterColumnsInclude,sFilterRowsExclude,sFilterRowsInclude,sSortRowsBy,leftTrim,rightTrim):
        com_sdtk_table_Converter._watch.start()
        aStages = list()
        error = None
        try:
            if ((sSortRowsBy is not None) and ((len(sSortRowsBy) > 0))):
                awWriter = com_sdtk_table_Array2DWriter.writeToExpandableArray(None)
                x = com_sdtk_table_ConverterStageStandard(oSource,fSource,awWriter,com_sdtk_table_Format.ARRAY,sFilterColumnsExclude,sFilterColumnsInclude,sFilterRowsExclude,sFilterRowsInclude,leftTrim,rightTrim)
                aStages.append(x)
                x = com_sdtk_table_ConverterStageSort.createWithArrayAndColumnsString(awWriter.getArray(),sSortRowsBy)
                aStages.append(x)
                arReader = awWriter.flip()
                x = com_sdtk_table_ConverterStageStandard(arReader,com_sdtk_table_Format.ARRAY,oTarget,fTarget,None,None,None,None,False,False)
                aStages.append(x)
            else:
                x = com_sdtk_table_ConverterStageStandard(oSource,fSource,oTarget,fTarget,sFilterColumnsExclude,sFilterColumnsInclude,sFilterRowsExclude,sFilterRowsInclude,leftTrim,rightTrim)
                aStages.append(x)
            _g = 0
...
class com_sdtk_table_ConverterInputFormatOptions:
    ...
    def csv(self):
        return self.setSourceFormat(com_sdtk_table_Format.CSV)

    def psv(self):
        return self.setSourceFormat(com_sdtk_table_Format.PSV)

    def tsv(self):
        return self.setSourceFormat(com_sdtk_table_Format.TSV)
...
class com_sdtk_table_ConverterOutputFormatOptions:
    ...
    def csv(self):
        return self.setTargetFormat(com_sdtk_table_Format.CSV)

    def psv(self):
        return self.setTargetFormat(com_sdtk_table_Format.PSV)

    def tsv(self):
        return self.setTargetFormat(com_sdtk_table_Format.TSV)

    def sql(self):
        return self.setTargetFormat(com_sdtk_table_Format.SQL)
...
class com_sdtk_table_ConverterOutputOperationsOptions:
    ...
    def execute(self,callback = None):
        result = None
        com_sdtk_table_Converter.convertWithOptions(self._values.h.get("source",None),self._values.h.get("sourceFormat",None),self._values.h.get("target",None),self._values.h.get("targetFormat",None),None,None,None,None,None,False,False)
        _g = self._values.h.get("targetType",None)
        if (_g == "array"):
            result = self._values.h.get("target",None)
        elif (_g == "string"):
            result = Reflect.field(self._values.h.get("target",None),"toString")()
        else:
            pass
        if (callback is None):
            return result
...
class com_sdtk_table_ConverterStageStandard:
    ...
    def __init__(self,oSource,fSource,oTarget,fTarget,sFilterColumnsExclude,sFilterColumnsInclude,sFilterRowsExclude,sFilterRowsInclude,leftTrim,rightTrim):
        self._reader = None
        self._writer = None
            ...
            if (self._writer is None):
                ...
                if (fTarget is not None):
                    ...
                    if (tmp == 0):
                        ...
                        self._writer = com_sdtk_table_TableWriter.createStandardTableWriter(oTarget)
                    elif (tmp == 14):
                        self._writer = com_sdtk_table_Array2DWriter.writeToExpandableArray(oTarget)
                    elif (tmp == 18):
                        pass
                    else:
                        pass
                if (diTarget is not None):
                    self._writer = com_sdtk_table_DelimitedWriter(diTarget,oTarget)
            ...
            if (self._reader is None):
                ...
                if (fSource is not None):
                    ...
                    if (tmp == 0):
                        ...
                        self._reader = com_sdtk_table_Array2DReader.readWholeArray(oSource)
                    elif (tmp == 18):
                        self._reader = com_sdtk_table_DatabaseReader.read(oSource)
                    else:
                        pass
                if (diSource is not None):
                    self._reader = com_sdtk_table_DelimitedReader(diSource,oSource)
                else:
            ...
            while ((hasNext and (((iGettingValue >= 0) or (((sChar != rowDelimiter) and ((sChar != delimiter))))))) and (not self._done)):
                ...
                if (iGettingValue >= 0):
                    if (iGettingValue == self.isEnd(sChar)):
                        bEndValue = True
                        bSkip = True
                elif (sChar == self._info.delimiter()):
                    bSkip = True
                elif (sChar == self._info.rowDelimiter()):
                    bSkip = True
                    self._done = True
                elif (sChar == "\r"):
                    bSkip = True
...
class com_sdtk_table_Format(Enum):
    ...
    _hx_constructs = ["CSV", "PSV", "TSV", "DIR", "INI", "JSON", "PROPERTIES", "SQL", "Haxe", "Python", "Java", "CSharp", "SPLUNK", "HTMLTable", "ARRAY", "MAP", "ARRAYMAP", "MAPARRAY", "DB"]
...
class com_sdtk_table_Parameters(com_sdtk_std_Parameters):
    ...
    def __init__(self):
        ...
        if (_g == 0):
            ...
            _hx_str = "More than two files specified.  This indicates that the tool was run improperly."
            python_Lib.printString((("" + ("null" if _hx_str is None else _hx_str)) + HxOverrides.stringOrNull(python_Lib.lineEnd)))
...
class com_sdtk_table_TableHeaderRowWriter(com_sdtk_table_AbstractTableRowWriter):
    ...
    def getTag(self):
        return python_internal_ArrayImpl._get(self._info.HeaderCell(), 0)
...
class com_sdtk_table_TableWriter(com_sdtk_table_DataTableWriter):
    ...
    def writeStartI(self,name,index,rowWriter):
        ...
        index1 = index
        if (index1 == 0):
            rowWriter = com_sdtk_table_TableFirstRowWriter(self._info,oRow,self._header)
        elif (index1 == 1):
            rowWriter = com_sdtk_table_TableRowWriter(self._info,oRow,self._header)
        elif (rowWriter is None):
            rowWriter = com_sdtk_table_TableRowWriter(self._info,oRow,self._header)
        else:
            rw = rowWriter
            rw.reuse(self._info,oRow,self._header)
        return rowWriter

    def writeHeader(self):
        oRow = None
        return com_sdtk_table_TableHeaderRowWriter(self._info,oRow,self._header)
    ...
    @staticmethod
    def createStandardTableWriter(oElement):
        return com_sdtk_table_TableWriter(com_sdtk_table_StandardTableInfo.instance,oElement)
...
class com_sdtk_table_Tests:
    ...
    def testCSVToPSV(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.PSV,None,None,None,None,None,False,False)
    ...
    def testExcludeColumns(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.CSV,"B",None,None,None,None,False,False)
    ...
    def testExcludeRows(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.CSV,None,None,"#2",None,None,False,False)
            return com_sdtk_table_Tests.compareResults(recordPass,verbose,sTest,sExcluded,StringTools.replace(sbBuffer.b.getvalue(),"\"",""))
        except BaseException as _g:
            None
            msg = haxe_Exception.caught(_g).unwrap()
    ...
    def testIncludeColumns(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.CSV,None,"B",None,None,None,False,False)
    ...
    def testIncludeRows(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.CSV,None,None,None,"#2",None,False,False)
            return com_sdtk_table_Tests.compareResults(recordPass,verbose,sTest,sExcluded,StringTools.replace(sbBuffer.b.getvalue(),"\"",""))
        except BaseException as _g:
            None
            msg = haxe_Exception.caught(_g).unwrap()
    ...
    def testOrderBy(recordPass,verbose):
        ...
        sbBuffer = StringBuf()
        try:
            com_sdtk_table_Converter.convertWithOptions(com_sdtk_table_Tests.sCSV,com_sdtk_table_Format.CSV,sbBuffer,com_sdtk_table_Format.CSV,None,None,None,None,"C",False,False)
