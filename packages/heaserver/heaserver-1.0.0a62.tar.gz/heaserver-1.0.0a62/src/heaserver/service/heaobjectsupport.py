...
class PermissionGroup(EnumWithAttrs):
    ...
    GETTER_PERMS = [Permission.VIEWER, Permission.COOWNER, Permission.EDITOR]
    PUTTER_PERMS = [Permission.EDITOR, Permission.COOWNER]
...
def has_permissions(obj: DesktopObject, sub: str, permissions: List[Permission]) -> bool:
    """
