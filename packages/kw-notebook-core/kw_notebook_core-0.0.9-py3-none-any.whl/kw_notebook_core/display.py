...
def notebook_caution():
    ...
    <p>せっかく編集して自分好みの内容になっても、保存できなければ意味がありません。そこで、ノートブックを共有されたら、作業を始める前に<strong>自分のノートブックとして保存</strong>しましょう。

    <p>いったん自分のノートブックとして保存すれば、それを自分の好きに編集し、保存できるようになります。''',
        title='## 超重要：落とし穴に注意')
