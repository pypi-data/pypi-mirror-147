...
class ShadowWalker:
    ...
    def __init__(self, clash_bin=os.path.join(abs_dir(__file__), "clash-{}".format("win32" if IS_WIN32 else "linux")), exclude_country=["US", "CA", "CN"]):
