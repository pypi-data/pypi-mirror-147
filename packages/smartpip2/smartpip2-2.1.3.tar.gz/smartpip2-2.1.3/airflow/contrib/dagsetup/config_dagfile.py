...
def S_{filename}():
    job = ETL_FILE_PATH + '{project_name}/{filename}.json'
...
def S_{filename}():
    job = ETL_FILE_PATH + '{project_name}/{filename}.sql'
    para_dict = dict(zip('{param}'.split(','),[{param}]))
...
def S_{filename}():
    path = ETL_FILE_PATH + '{project_name}/{filename}.json'
    para_dict = dict(zip('{param}'.split(','),[{param}]))
