...
def gen_airflow_dag(*args, **kwargs):
    ...
    for item in job_list:
        ...
        elif driver == 'starrocks':
            etl_str = etl_str + execute_starrocks_format.format(project_name=project_name, filename=item[1], param=item[2])
        elif driver == 'datax':
