...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, username=None, sock_connect_timeout=None, total_timeout=None, sock_read_timeout=None, password=None, proxy_url=None, pulp_labels=None, url=None, rate_limit=None, proxy_username=None, ca_cert=None, download_concurrency=None, connect_timeout=None, headers=None, name=None, client_cert=None, tls_validation=None, proxy_password=None, max_retries=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
