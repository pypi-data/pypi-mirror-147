...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_connect_timeout=None, pulp_last_updated=None, total_timeout=None, sock_read_timeout=None, pulp_created=None, pulp_href=None, proxy_url=None, pulp_labels=None, url=None, rate_limit=None, ca_cert=None, download_concurrency=None, connect_timeout=None, headers=None, name=None, client_cert=None, tls_validation=None, max_retries=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
