...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, password=None, pulp_labels=None, max_retries=None, client_key=None, sock_connect_timeout=None, total_timeout=None, client_cert=None, rate_limit=None, ca_cert=None, headers=None, download_concurrency=None, tls_validation=None, url=None, proxy_url=None, sock_read_timeout=None, proxy_username=None, username=None, proxy_password=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
