...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_labels=None, max_retries=None, sock_connect_timeout=None, total_timeout=None, client_cert=None, rate_limit=None, ca_cert=None, pulp_last_updated=None, pulp_href=None, headers=None, download_concurrency=None, tls_validation=None, url=None, proxy_url=None, sock_read_timeout=None, pulp_created=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
