...
def ortodromic (latA: float, lonA: float, latB: float, lonB: float) -> Tuple[float, float]:
	p1 = LatLon3.LatLon(LatLon3.Latitude(latA), LatLon3.Longitude(lonA))
	p2 = LatLon3.LatLon(LatLon3.Latitude(latB), LatLon3.Longitude(lonB))
...
def routagePointDistance (latA: float, lonA: float, distance: float, hdg: float, unit: str='nm') -> Tuple[float, float]:
	...
	p = LatLon3.LatLon(LatLon3.Latitude(latA), LatLon3.Longitude(lonA))
