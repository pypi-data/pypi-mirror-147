...
`,is:"app-header-layout",behaviors:[S],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return t(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var t=this.header;if(this.isAttached&&t){this.$.wrapper.classList.remove("initializing"),t.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var e=t.offsetHeight;this.hasScrollingRegion?(t.style.left="",t.style.right=""):requestAnimationFrame(function(){var e=this.getBoundingClientRect(),i=document.documentElement.clientWidth-e.right;t.style.left=e.left+"px",t.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;t.fixed&&!t.condenses&&this.hasScrollingRegion?(i.marginTop=e+"px",i.paddingTop=""):(i.paddingTop=e+"px",i.marginTop="")}}});class L extends(customElements.get("app-header-layout")){static get template(){return a`
    ...
    `}},{kind:"method",key:"_addDevice",value:async function(){var t,e;t=this,e={hass:this.hass,insteon:this.insteon,title:this.insteon.localize("device.actions.add"),callback:async(t,e)=>this._handleDeviceAdd(t,e)},f(t,"show-dialog",{dialogTag:"dialog-insteon-add-device",dialogImport:A,dialogParams:e})}},{kind:"method",key:"_handleDeviceAdd",value:async function(t,e){var i,o;await T(this.hass,t,e),i=this,o={hass:this.hass,insteon:this.insteon,multiple:e,address:t,title:"Adding Insteon Device"},f(i,"show-dialog",{dialogTag:"dialog-insteon-adding-device",dialogImport:M,dialogParams:o})}},{kind:"method",key:"_handleRowClicked",value:async function(t){const e=t.detail.id;y("/insteon/device/properties/"+e)}},{kind:"get",static:!0,key:"styles",value:function(){return[m,h`
      ...
      `]}}]}}),n);export{B as InsteonDevicesPanel};
