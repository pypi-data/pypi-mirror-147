import{P as e,h as t,d as i,_ as a,s,e as o,x as n,l,$ as r,n as d,i as h,t as c,j as u,k as m,a4 as p,o as b,p as v,r as _}from"./main-ff869e06.js";import"./c.3bd9d58e.js";import{s as f,a as g}from"./c.a3c85da2.js";import{I as y,b as k,P as w,c as $,f as x,e as z,g as L,l as C,w as B,h as R,i as T,j as D,k as S,m as A}from"./c.18e68cd7.js";import{insteonDeviceTabs as U}from"./c.40a39b51.js";import{c as E}from"./c.0a038163.js";e({_template:t`
    <style>
      :host {
...
`,is:"paper-textarea",behaviors:[w,$],properties:{_ariaLabelledBy:{observer:"_ariaLabelledByChanged",type:String},_ariaDescribedBy:{observer:"_ariaDescribedByChanged",type:String},value:{type:String},rows:{type:Number,value:1},maxRows:{type:Number,value:0}},get selectionStart(){return this.$.input.textarea.selectionStart},set selectionStart(e){this.$.input.textarea.selectionStart=e},get selectionEnd(){return this.$.input.textarea.selectionEnd},set selectionEnd(e){this.$.input.textarea.selectionEnd=e},_ariaLabelledByChanged:function(e){this._focusableElement.setAttribute("aria-labelledby",e)},_ariaDescribedByChanged:function(e){this._focusableElement.setAttribute("aria-describedby",e)},get _focusableElement(){return this.inputElement.textarea}}),a([d("insteon-aldb-data-table")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[o({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[o({attribute:!1})],key:"insteon",value:void 0},{kind:"field",decorators:[o({type:Boolean})],key:"narrow",value:()=>!1},{kind:"field",decorators:[o()],key:"records",value:()=>[]},{kind:"field",decorators:[o({type:Boolean})],key:"isLoading",value:()=>!1},{kind:"field",decorators:[o({type:Boolean})],key:"showWait",value:()=>!1},{kind:"field",decorators:[n("insteon-data-table")],key:"_dataTable",value:void 0},{kind:"field",key:"_records",value:()=>l(e=>{if(!e)return[];return e.map(e=>({...e}))})},{kind:"field",key:"_columns",value(){return l(e=>e?{in_use:{title:this.insteon.localize("aldb.fields.in_use"),template:e=>e?r`${this.hass.localize("ui.common.yes")}`:r`${this.hass.localize("ui.common.no")}`,sortable:!0,width:"15%"},dirty:{title:this.insteon.localize("aldb.fields.modified"),template:e=>e?r`${this.hass.localize("ui.common.yes")}`:r`${this.hass.localize("ui.common.no")}`,sortable:!0,width:"15%"},target:{title:this.insteon.localize("aldb.fields.target"),sortable:!0,grows:!0},group:{title:this.insteon.localize("aldb.fields.group"),sortable:!0,width:"15%"},is_controller:{title:this.insteon.localize("aldb.fields.mode"),template:e=>e?r`${this.insteon.localize("aldb.mode.controller")}`:r`${this.insteon.localize("aldb.mode.responder")}`,sortable:!0,width:"25%"}}:{mem_addr:{title:this.insteon.localize("aldb.fields.id"),template:e=>e<0?r`New`:r`${e}`,sortable:!0,direction:"desc",width:"10%"},in_use:{title:this.insteon.localize("aldb.fields.in_use"),template:e=>e?r`${this.hass.localize("ui.common.yes")}`:r`${this.hass.localize("ui.common.no")}`,sortable:!0,width:"10%"},dirty:{title:this.insteon.localize("aldb.fields.modified"),template:e=>e?r`${this.hass.localize("ui.common.yes")}`:r`${this.hass.localize("ui.common.no")}`,sortable:!0,width:"10%"},target:{title:this.insteon.localize("aldb.fields.target"),sortable:!0,width:"15%"},target_name:{title:this.insteon.localize("aldb.fields.target_device"),sortable:!0,grows:!0},group:{title:this.insteon.localize("aldb.fields.group"),sortable:!0,width:"10%"},is_controller:{title:this.insteon.localize("aldb.fields.mode"),template:e=>e?r`${this.insteon.localize("aldb.mode.controller")}`:r`${this.insteon.localize("aldb.mode.responder")}`,sortable:!0,width:"12%"}})}},{kind:"method",key:"_noDataText",value:function(e){return e?"":this.insteon.localize("aldb.no_data")}},{kind:"method",key:"clearSelection",value:function(){this._dataTable.clearSelection()}},{kind:"method",key:"render",value:function(){return this.showWait?r` <ha-circular-progress active alt="Loading"></ha-circular-progress> `:r`
    ...
    `}},{kind:"method",key:"_getRecords",value:function(){var e;this._device?z(this.hass,null===(e=this._device)||void 0===e?void 0:e.address).then(e=>{this._allRecords=e,this._records=this._filterRecords(this._allRecords,this._showUnused)}):this._records=[]}},{kind:"method",key:"_createRecord",value:function(){M(this,{hass:this.hass,insteon:this.insteon,schema:L(this.insteon),record:{mem_addr:0,in_use:!0,is_controller:!0,highwater:!1,group:0,target:"",target_name:"",data1:0,data2:0,data3:0,dirty:!0},title:this.insteon.localize("aldb.actions.new"),callback:async e=>this._handleRecordCreate(e)})}},{kind:"method",key:"_onImageLoad",value:function(e){e.target.style.display="inline-block"}},{kind:"method",key:"_onImageError",value:function(e){e.target.style.display="none"}},{kind:"method",key:"_onLoadALDBClick",value:async function(){await f(this,{text:this.insteon.localize("common.warn.load"),confirmText:this.hass.localize("ui.common.yes"),dismissText:this.hass.localize("ui.common.no"),confirm:()=>this._load()})}},{kind:"method",key:"_load",value:function(){this._subscribe(),C(this.hass,this._device.address),this._isLoading=!0,this._records=[]}},{kind:"method",key:"_onShowHideUnusedClicked",value:async function(){this._showUnused=!this._showUnused,this._showUnused?this._showHideUnused="hide":this._showHideUnused="show",this._records=this._filterRecords(this._allRecords,this._showUnused)}},{kind:"method",key:"_onWriteALDBClick",value:async function(){await f(this,{text:this.insteon.localize("common.warn.write"),confirmText:this.hass.localize("ui.common.yes"),dismissText:this.hass.localize("ui.common.no"),confirm:()=>this._write()})}},{kind:"method",key:"_write",value:function(){this._subscribe(),B(this.hass,this._device.address),this._isLoading=!0,this._records=[]}},{kind:"method",key:"_onResetALDBClick",value:async function(){R(this.hass,this._device.address),this._getRecords()}},{kind:"method",key:"_onAddDefaultLinksClicked",value:async function(){await f(this,{text:this.insteon.localize("common.warn.add_default_links"),confirm:()=>this._addDefaultLinks()})}},{kind:"method",key:"_addDefaultLinks",value:async function(){this._subscribe(),T(this.hass,this._device.address),this._records=[]}},{kind:"method",key:"_handleRecordChange",value:async function(e){D(this.hass,this._device.address,e),e.in_use||(this._showUnused=!0),this._getRecords()}},{kind:"method",key:"_handleRecordCreate",value:async function(e){S(this.hass,this._device.address,e),this._getRecords()}},{kind:"method",key:"_handleRowClicked",value:async function(e){const t=e.detail.id,i=this._records.find(e=>e.mem_addr===+t);M(this,{hass:this.hass,insteon:this.insteon,schema:A(this.insteon),record:i,title:this.insteon.localize("aldb.actions.change"),callback:async e=>this._handleRecordChange(e)}),history.back()}},{kind:"method",key:"_handleBackTapped",value:async function(){this._dirty()?await f(this,{text:this.hass.localize("ui.panel.config.common.editor.confirm_unsaved"),confirmText:this.hass.localize("ui.common.yes"),dismissText:this.hass.localize("ui.common.no"),confirm:()=>this._goBack()}):v("/insteon/devices")}},{kind:"method",key:"_handleMenuAction",value:async function(e){switch(e.detail.index){case 0:await this._onShowHideUnusedClicked();break;case 1:await this._addDefaultLinks();break;case 2:await this._onLoadALDBClick();break;case 3:await this._onWriteALDBClick();break;case 4:await this._onResetALDBClick()}}},{kind:"method",key:"_goBack",value:function(){R(this.hass,this._device.address),v("/insteon/devices")}},{kind:"method",key:"_handleMessage",value:function(e){"record_loaded"===e.type&&this._getRecords(),"status_changed"===e.type&&(x(this.hass,this.deviceId).then(e=>{this._device=e}),this._isLoading=e.is_loading,e.is_loading||this._unsubscribe())}},{kind:"method",key:"_unsubscribe",value:function(){this._refreshDevicesTimeoutHandle&&clearTimeout(this._refreshDevicesTimeoutHandle),this._subscribed&&(this._subscribed.then(e=>e()),this._subscribed=void 0)}},{kind:"method",key:"_subscribe",value:function(){var e;this.hass&&(this._subscribed=this.hass.connection.subscribeMessage(e=>this._handleMessage(e),{type:"insteon/aldb/notify",device_address:null===(e=this._device)||void 0===e?void 0:e.address}),this._refreshDevicesTimeoutHandle=window.setTimeout(()=>this._unsubscribe(),12e5))}},{kind:"method",key:"_noDeviceError",value:function(){g(this,{text:this.insteon.localize("common.error.device_not_found")}),this._goBack(),this._goBack()}},{kind:"get",static:!0,key:"styles",value:function(){return _`
      :host {
