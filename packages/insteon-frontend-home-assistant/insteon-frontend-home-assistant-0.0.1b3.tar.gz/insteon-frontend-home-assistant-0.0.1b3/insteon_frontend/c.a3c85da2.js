import{J as e,h as t,_ as a,s as i,e as o,y as r,t as s,$ as n,O as l,R as d,f as c,r as h,n as p,l as u,j as v,k as b,z as f,i as k}from"./main-ff869e06.js";import{r as m}from"./c.18e68cd7.js";import{a as g}from"./c.0a038163.js";customElements.define("ha-service-description",class extends e{static get template(){return t` [[_getDescription(hass, domain, service)]] `}static get properties(){return{hass:Object,domain:String,service:String}}_getDescription(e,t,a){const i=e.services[t];if(!i)return"";const o=i[a];return o?o.description:""}});a([p("ha-tab")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[o({type:Boolean,reflect:!0})],key:"active",value:()=>!1},{kind:"field",decorators:[o({type:Boolean,reflect:!0})],key:"narrow",value:()=>!1},{kind:"field",decorators:[o()],key:"name",value:void 0},{kind:"field",decorators:[r("mwc-ripple")],key:"_ripple",value:void 0},{kind:"field",decorators:[s()],key:"_shouldRenderRipple",value:()=>!1},{kind:"method",key:"render",value:function(){return n`
    ...
    `}}]}}),i);const y=()=>import("./c.fcbdd8de.js"),w=(e,t,a)=>new Promise(i=>{const o=t.cancel,r=t.confirm;k(e,"show-dialog",{dialogTag:"dialog-box",dialogImport:y,dialogParams:{...t,...a,cancel:()=>{i(!(null==a||!a.prompt)&&null),o&&o()},confirm:e=>{i(null==a||!a.prompt||e),r&&r(e)}}})}),x=(e,t)=>w(e,t),$=(e,t)=>w(e,t,{confirmation:!0});export{x as a,$ as s};
