...
# Form implementation generated from reading ui file 'guardata/client/gui/forms/settings_widget.ui'
#
...
"")
        ...
        self.check_box_tray.setStyleSheet("color: #000000")
        ...
        self.check_box_check_at_startup.setStyleSheet("color: #000000")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_check_version.sizePolicy().hasHeightForWidth())
        self.button_check_version.setSizePolicy(sizePolicy)
        self.button_check_version.setMinimumSize(QtCore.QSize(0, 32))
        self.button_check_version.setMaximumSize(QtCore.QSize(280, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.check_box_show_confined.setStyleSheet("color: #000000")
...
from guardata.client.gui.custom_widgets import ComboBox
