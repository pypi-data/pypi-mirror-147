...
class Job:
    ...
    def __init__(self, func, tigger, args=None, job_id=None, next_time=None, group='', subgroup='', status_last_time=0, deal_max_time= 60_000, **kwargs):
        ...
        self.deal_max_time = deal_max_time
