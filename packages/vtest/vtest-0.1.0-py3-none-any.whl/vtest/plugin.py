...
from vtest.generate import GeneratePlugin
from vtest.report import ReportPlugin
from vtest.logger import Logger
...
def pytest_configure(config):
    if config.getoption("testset"):
        ...
        generate1 = GeneratePlugin(testset)
