...
class S3URIMixin:
    ...
    def set_s3_uri_from_bucket_and_key(self, bucket: str, key: Optional[str] = None):
        """
        ...
        """
        self.__s3_uri = s3_uri(bucket, key)


def s3_uri(bucket: str, key: Optional[str]) -> str:
    """
