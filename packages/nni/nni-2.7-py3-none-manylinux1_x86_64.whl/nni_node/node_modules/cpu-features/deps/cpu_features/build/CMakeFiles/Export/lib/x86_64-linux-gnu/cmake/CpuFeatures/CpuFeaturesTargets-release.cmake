...
set_target_properties(CpuFeatures::cpu_features PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libcpu_features.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS CpuFeatures::cpu_features )
list(APPEND _IMPORT_CHECK_FILES_FOR_CpuFeatures::cpu_features "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libcpu_features.a" )
