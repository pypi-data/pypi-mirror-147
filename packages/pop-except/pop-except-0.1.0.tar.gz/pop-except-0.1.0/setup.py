...
NAME = "pop_except"
DESC = "Contracts, subs, and environment for handling exceptions in POP"

# Version info -- read without importing
_locals = {}
with pathlib.Path("pop_except", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/vmware/pop/pop-except",
    version=VERSION,
