...
class StagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.stages_list = _Endpoint(
            settings={
                'response_type': (PaginatedStageList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/stages',
            ...
            callable=__stages_list
        )

        def __stages_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.stages_retrieve = _Endpoint(
            settings={
                'response_type': (Stage,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/stages/{id}',
