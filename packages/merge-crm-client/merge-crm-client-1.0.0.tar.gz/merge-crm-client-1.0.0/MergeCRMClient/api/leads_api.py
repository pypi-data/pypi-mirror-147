...
class LeadsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.leads_list = _Endpoint(
            settings={
                'response_type': (PaginatedLeadList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/leads',
            ...
            api_client=api_client,
            callable=__leads_list
        )

        def __leads_meta_post_retrieve(
            self,
            x_account_token,
            **kwargs
        ):
        ...
        self.leads_meta_post_retrieve = _Endpoint(
            settings={
                'response_type': (MetaResponse,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/leads/meta/post',
            ...
            api_client=api_client,
            callable=__leads_meta_post_retrieve
        )

        def __leads_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.leads_retrieve = _Endpoint(
            settings={
                'response_type': (Lead,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/leads/{id}',
