...
def jetroutine_decorator(
    ...
    *,
    ...
    Raises:
        ...
        RuntimeError (jetpack.errors.RuntimeError): Raised if there was a jetpack-system or
          kubernetes error during execution of the jetroutine. This is usually not an error
          caused by incorrect business logic. `RuntimeError` is a subtype of `JetpackError` (`jetpack.errors.JetpackError`)
    """
