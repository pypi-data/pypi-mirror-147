...
def Get_pyGL_Version():
    print(colorama.Fore.BLUE+'Pygl version (19.7)'+colorama.Fore.RESET)
...
class Display_init_:
    ...
    def __GL_show_exit_button__(self,bool : bool = False):
        if bool==True:
            ...
            self.eb = Widgets_.Buttons(self.screen,[1900,0],[20,20],'X',(255,255,255),20,20,(200,10,20),(255,20,30),(100,30,30),0,Passing)
        else:
            self.exit_button_show = False
