...
class RedisHelper:
    ...
    async def hset(self, name, key=None, value=None, mapping=None, time=None):
        ...
        await con.hset(name, key=key, value=value, mapping=mapping)
        if time:
