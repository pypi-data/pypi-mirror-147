...
def eureka_get(path="", data=None, return_type="json", app_name="DATA_SERVICE", pack=True, **kwargs):
...
def eureka_post(path="", data=None, return_type="json", app_name="DATA_SERVICE", pack=True, **kwargs):
    if tornado.options.options.running_env != "local":
        kwargs.pop("base_url")
