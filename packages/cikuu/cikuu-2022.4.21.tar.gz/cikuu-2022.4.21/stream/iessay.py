#2022.4.17  python -m stream xessay iessay   | for i+1 class
from stream import * 

def process(xid, arr:dict={"rid":100876, "uid":1001, "tid":0, "type":"essay", "essay":"She has ready. It are ok."}): 
	...
	if latest is not None and latest.startswith(essaymd5): 
		if redis.debug:  print(f"duplicated content: {essay}")
