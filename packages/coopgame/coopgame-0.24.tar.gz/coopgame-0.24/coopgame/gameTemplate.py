...
class GameTemplate(MonitoredClass):
    ...
    def _update(self):
        ...
        delta_time_ms = (t - self.fps_tracker.ticks)
        self.ticks = t
        self.fps_tracker.calculate_fps(delta_time_ms)
    ...
    def _draw(self, frames: int):
        ...
        if self._debug_mode:
            ...
            self.draw_text(self.fps_tracker.run_time, hud=self.screen, offset_rect=cRect(0, self.screen.get_height() - 50, 20, 100))
