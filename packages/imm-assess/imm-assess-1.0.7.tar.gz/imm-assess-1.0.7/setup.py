...
setup(
    ...
    description='A python client library used to assess client immigration possibilities.',
    ...
    keywords='Canada, Immigration, Assess, Model, Programs, APIs',
    ...
    entry_points={
        'console_scripts':[
            'noc=assess.noc:main',
            'bcsp=assess.bcsp:main',
            'qa=assess.quickassess:main'
        ]
    }
)