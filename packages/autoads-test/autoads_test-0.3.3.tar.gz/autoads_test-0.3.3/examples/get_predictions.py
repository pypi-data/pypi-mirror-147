...
from autoads.keywords import get_keywords_from_api,get_keywords_from_google, get_keywords_from_scrape
...
#Credentials/Settings for Dataforseo Api #Credentials/Settings for Dataforseo Api 
...
df_api = asyncio.run(get_keywords_from_api(
            email = email,
            api_key=api_key,
            seed_keywords=seed_keywords,
            depth=depth))

df_scrape = get_keywords_from_scrape(urls,exclude,depth)
