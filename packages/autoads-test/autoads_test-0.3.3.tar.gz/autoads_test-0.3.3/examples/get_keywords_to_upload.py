...
seed_organic_description = asyncio.run(get_organic_description(email,api_key,seed_keywords))
...
organic_description = asyncio.run(get_organic_description(email,api_key,all_keywords))
