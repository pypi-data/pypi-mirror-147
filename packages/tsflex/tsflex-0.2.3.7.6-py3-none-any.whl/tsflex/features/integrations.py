...
#         self.__name__ = "[wrapped_transformer]__" + transformer.__repr__()
...
#         memo[id(self.transformer)] = result
#         from copy import deepcopy
#         # result.__dict__.update(copy(self.transformer.__dict__))
#         for k, v in self.transformer.__dict__.items():
#             setattr(result, k, deepcopy(v, memo))
#         print(result)
#         return WrappedTransformer(result)
...
#     assert hasattr(transformer, "fit_transform")# and hasattr(transformer, "transform")

#     func_wrapper_kwargs["vectorized"] = True
    
#     # from copy import copy

#     wrapped_transformer = WrappedTransformer(transformer)
#     # wrapped_transformer.__name__ = "[wrapped_transformer]__" + transformer.__repr__()
#     return FuncWrapper(wrapped_transformer, **func_wrapper_kwargs)
