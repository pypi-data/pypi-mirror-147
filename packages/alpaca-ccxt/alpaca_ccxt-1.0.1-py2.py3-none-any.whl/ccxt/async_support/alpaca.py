...
class alpaca(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        assets = await self.privateGetAssets(self.extend(request, params))
        # {
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.cryptoPrivateGetCryptoSymbolXbboLatest(self.extend(request, params))
        # {
        #     "symbol": "BTCUSD",
        #     "xbbo": {
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.cryptoPrivateGetCryptoSymbolTrades(self.extend(request, params))
        # {
        #     "symbol": "BTCUSD",
        #     "trades": [
        #          {
    ...
    async def fetch_balance(self, params={}):
        ...
        total = {}
        currencies = {}
        accountResponse = await self.privateGetAccount()
        # {
        ...
        positions = await self.privateGetPositions()
        # [
        #     {
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        _orders = await self.privateGetOrders(params)
