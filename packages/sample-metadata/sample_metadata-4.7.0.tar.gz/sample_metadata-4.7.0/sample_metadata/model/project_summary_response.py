...
class ProjectSummaryResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, participants, total_samples, sample_keys, sequence_keys, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, participants, total_samples, sample_keys, sequence_keys, *args, **kwargs):  # noqa: E501
        """ProjectSummaryResponse - a model defined in OpenAPI
