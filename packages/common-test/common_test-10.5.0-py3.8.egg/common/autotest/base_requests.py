...
class BaseRequest(APIDriver):
    # @classmethod
    # def get_session(cls):
    #     return APIDriver.get_session()
    #
    # @classmethod
    # def http_request(cls, url, method, parametric_key=None, header=None, data=None, file=None, cookie=None, _auth=None,_log:bool=True) -> object:
    #     return APIDriver.http_request(url,method, parametric_key, header, data, file, cookie, _auth,_log)
