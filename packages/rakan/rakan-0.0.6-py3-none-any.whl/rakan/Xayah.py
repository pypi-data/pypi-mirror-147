...
class RiotAPI:
    ...
    def make_request(self, url: str) -> dict[str, str]:
        header_data = {
    ...
    def get_champion_mastery_by_summoner_id(self, summoner_id: str, region: str) -> dict[str, str]:
    ...
    def get_champion_mastery_by_summoner_id_and_champion_id(self, summoner_id: str, champion_id: int, region: str) -> dict[str, str]:
    ...
    def get_server_status(self, region: str) -> dict[str, str]:
        url = f'https://{region}.api.riotgames.com/lol/status/v4/platform-data'
        return self.make_request(url=url)

    def get_in_game_info_by_summoner_id(self, summoner_id: str, region: str) -> dict[str, str]:
        url = f'https://{region}.api.riotgames.com/lol/spectator/v4/active-games/by-summoner/{summoner_id}'
        return self.make_request(url=url)

    def get_summoner_by_summoner_id(self, summoner_id: str, region: str) -> dict[str, str]:
        """
    ...
    def get_summoner_by_name(self, name: str, region: str) -> dict[str, str]:
        """
    ...
    def get_summoner_by_puuid(self, puuid: str, region: str) -> dict[str, str]:
        """
    ...
    def get_summoner_by_account_id(self, account_id: str, region: str) -> dict[str, str]:
        """
...
class MMR_API:
    user_agent_string = f'{platform.system()}:rakan_python_package:0.0.6'
