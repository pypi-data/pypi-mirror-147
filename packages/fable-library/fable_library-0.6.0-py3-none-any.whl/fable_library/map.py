...
from typing import (TypeVar, Generic, Optional, Any, Tuple, Callable)
...
def MapTreeModule_size(x: Optional[MapTreeLeaf_2[_A, _B]]=None) -> int:
...
def MapTreeModule_partition1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: _A, acc1: Optional[MapTreeLeaf_2[_KEY, _A]]=None, acc2: Optional[MapTreeLeaf_2[_KEY, _A]]=None) -> Tuple[Optional[MapTreeLeaf_2[_KEY, _A]], Optional[MapTreeLeaf_2[_KEY, _A]]]:
    if f(k, v):
...
def MapTreeModule_partition(comparer: IComparer[_KEY], f: Any, m: Optional[MapTreeLeaf_2[_KEY, _A]]=None) -> Tuple[Optional[MapTreeLeaf_2[_KEY, _A]], Optional[MapTreeLeaf_2[_KEY, _A]]]:
    return MapTreeModule_partitionAux(comparer, f, m, MapTreeModule_empty(), MapTreeModule_empty())


def MapTreeModule_filter1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: _A, acc: Optional[MapTreeLeaf_2[_KEY, _A]]=None) -> Optional[MapTreeLeaf_2[_KEY, _A]]:
    if f(k, v):
...
def MapTreeModule_filter(comparer: IComparer[_KEY], f: Any, m: Optional[MapTreeLeaf_2[_KEY, _A]]=None) -> Optional[MapTreeLeaf_2[_KEY, _A]]:
...
def MapTreeModule_iter(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> None:
    MapTreeModule_iterOpt(f, m)


def MapTreeModule_tryPickOpt(f_mut: Any, m_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]]) -> Optional[_A]:
    while True:
        (f, m) = (f_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
            if isinstance(m2, MapTreeNode_2):
                match_value : Optional[_A] = MapTreeModule_tryPickOpt(f, MapTreeNode_2__get_Left(m2))
                if match_value is None:
                    match_value_1 : Optional[_A] = f(MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2))
...
def MapTreeModule_tryPick(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> Optional[_C]:
...
def MapTreeModule_exists(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> bool:
...
def MapTreeModule_forall(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> bool:
...
def MapTreeModule_mapi(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> Optional[MapTreeLeaf_2[_A, _C]]:
    return MapTreeModule_mapiOpt(f, m)


def MapTreeModule_foldBackOpt(f_mut: Any, m_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x_mut: _A) -> _A:
    while True:
...
def MapTreeModule_foldBack(f: Any, m: Optional[MapTreeLeaf_2[_A, _B]], x: _C) -> _C:
    return MapTreeModule_foldBackOpt(f, m, x)


def MapTreeModule_foldOpt(f_mut: Any, x_mut: _A, m_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]]) -> _A:
    while True:
...
def MapTreeModule_fold(f: Any, x: _A, m: Optional[MapTreeLeaf_2[_B, _C]]=None) -> _A:
    return MapTreeModule_foldOpt(f, x, m)


def MapTreeModule_foldSectionOpt(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x: _A) -> _A:
    def fold_from_to(f_1_mut: Any, m_1_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x_1_mut: _B, comparer: IComparer[_KEY]=comparer, lo: _KEY=lo, hi: _KEY=hi, f: Any=f, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=m, x: _A=x) -> _B:
        while True:
            ...
            if m_1 is not None:
                ...
                if isinstance(m2, MapTreeNode_2):
                    ...
                    x_2 : _B = fold_from_to(f_1, MapTreeNode_2__get_Left(m2), x_1) if (c_lo_key < 0) else x_1
                    x_3 : _B = f_1(MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2), x_2) if ((c_key_hi <= 0) if (c_lo_key <= 0) else False) else x_2
                    if c_key_hi < 0:
                        f_1_mut = f_1
...
def MapTreeModule_foldSection(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, _A]], x: _B) -> _B:
...
def MapTreeModule_copyToArray(m: Optional[MapTreeLeaf_2[_A, _B]], arr: Array[Any], i: int) -> None:
    j : int = i or 0
    def arrow_270(x: _A, y: _B, m: Optional[MapTreeLeaf_2[_A, _B]]=m, arr: Array[Any]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0
...
def MapTreeModule_toArray(m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> Array[Any]:
...
def MapTreeModule_ofList(comparer: IComparer[_A], l: FSharpList[Tuple[_A, _B]]) -> Optional[MapTreeLeaf_2[_A, _B]]:
    def arrow_271(acc: Optional[MapTreeLeaf_2[_A, _B]], tupled_arg: Tuple[_A, _B], comparer: IComparer[_A]=comparer, l: FSharpList[Tuple[_A, _B]]=l) -> Optional[MapTreeLeaf_2[_A, _B]]:
        return MapTreeModule_add(comparer, tupled_arg[0], tupled_arg[1], acc)

    return fold_1(arrow_271, MapTreeModule_empty(), l)


def MapTreeModule_mkFromEnumerator(comparer_mut: IComparer[_A], acc_mut: Optional[MapTreeLeaf_2[_A, _B]], e_mut: IEnumerator[Tuple[_A, _B]]) -> Optional[MapTreeLeaf_2[_A, _B]]:
    while True:
        (comparer, acc, e) = (comparer_mut, acc_mut, e_mut)
        if e.System_Collections_IEnumerator_MoveNext():
            pattern_input : Tuple[_A, _B] = e.System_Collections_Generic_IEnumerator_00601_get_Current()
            comparer_mut = comparer
...
def MapTreeModule_ofArray(comparer: IComparer[_KEY], arr: Array[Tuple[_KEY, _VALUE]]) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
...
def MapTreeModule_mkIterator(m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> MapTreeModule_MapIterator_2[_A, _B]:
    return MapTreeModule_MapIterator_2(MapTreeModule_collapseLHS(singleton(m)), False)


def MapTreeModule_notStarted() -> _A:
    raise Exception("enumeration not started")


def MapTreeModule_alreadyFinished() -> _A:
...
def MapTreeModule_mkIEnumerator(m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> IEnumerator[Any]:
    ...
    class ObjectExpr273(IEnumerator[Any]):
        def System_Collections_Generic_IEnumerator_00601_get_Current(self, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> Any:
            return MapTreeModule_current(i)

        def System_Collections_IEnumerator_get_Current(self, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> Any:
            return MapTreeModule_current(i)

        def System_Collections_IEnumerator_MoveNext(self, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> bool:
            return MapTreeModule_moveNext(i)

        def System_Collections_IEnumerator_Reset(self, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> None:
            nonlocal i
            i = MapTreeModule_mkIterator(m)

        def Dispose(self, m: Optional[MapTreeLeaf_2[_A, _B]]=m) -> None:
            pass

    return ObjectExpr273()


def MapTreeModule_toSeq(s: Optional[MapTreeLeaf_2[_A, _B]]=None) -> IEnumerable[Any]:
    def generator(en_1: IEnumerator[Any], s: Optional[MapTreeLeaf_2[_A, _B]]=s) -> Optional[Tuple[Any, IEnumerator[Any]]]:
...
class FSharpMap(Generic[_KEY, _VALUE]):
    ...
    def System_Collections_Generic_ICollection_00601_CopyToZ2E171D71(self, arr: Array[Any], i: int) -> None:
        m : FSharpMap[_KEY, _VALUE] = self
...
def FSharpMap__TryPick(m: FSharpMap[_KEY, _VALUE], f: Any) -> Optional[_A]:
    return MapTreeModule_tryPick(f, m.tree)


def FSharpMap__Exists(m: FSharpMap[_KEY, _VALUE], predicate: Any) -> bool:
    return MapTreeModule_exists(predicate, m.tree)


def FSharpMap__Filter(m: FSharpMap[_KEY, _VALUE], predicate: Any) -> FSharpMap[_KEY, _VALUE]:
    return FSharpMap__ctor(m.comparer, MapTreeModule_filter(m.comparer, predicate, m.tree))


def FSharpMap__ForAll(m: FSharpMap[_KEY, _VALUE], predicate: Any) -> bool:
    return MapTreeModule_forall(predicate, m.tree)


def FSharpMap__Fold(m: FSharpMap[_KEY, _VALUE], f: Any, acc: _A) -> _A:
    return MapTreeModule_foldBack(f, m.tree, acc)


def FSharpMap__FoldSection(m: FSharpMap[_KEY, _VALUE], lo: _KEY, hi: _KEY, f: Any, acc: _Z) -> _Z:
    return MapTreeModule_foldSection(m.comparer, lo, hi, f, m.tree, acc)


def FSharpMap__Iterate(m: FSharpMap[_KEY, _VALUE], f: Any) -> None:
...
def FSharpMap__Map(m: FSharpMap[_KEY, _VALUE], f: Any) -> FSharpMap[_KEY, _B]:
    return FSharpMap__ctor(m.comparer, MapTreeModule_mapi(f, m.tree))


def FSharpMap__Partition(m: FSharpMap[_KEY, _VALUE], predicate: Any) -> Tuple[FSharpMap[_KEY, _VALUE], FSharpMap[_KEY, _VALUE]]:
...
def FSharpMap__ComputeHashCode(this: FSharpMap[_KEY, _VALUE]) -> int:
    ...
    with get_enumerator(this) as enumerator:
        while enumerator.System_Collections_IEnumerator_MoveNext():
            active_pattern_result6644 : Tuple[_KEY, _VALUE] = enumerator.System_Collections_Generic_IEnumerator_00601_get_Current()
            res = combine_hash(res, structural_hash(active_pattern_result6644[0])) or 0
            res = combine_hash(res, structural_hash(active_pattern_result6644[1])) or 0
    return res


def is_empty(table: FSharpMap[_A, _B]) -> bool:
    return FSharpMap__get_IsEmpty(table)


def add(key: _A, value: _B, table: FSharpMap[_A, _B]) -> FSharpMap[_A, _B]:
    return FSharpMap__Add(table, key, value)


def change(key: _A, f: Callable[[Optional[_B]], Optional[_B]], table: FSharpMap[_A, _B]) -> FSharpMap[_A, _B]:
    return FSharpMap__Change(table, key, f)


def find(key: _A, table: FSharpMap[_A, _B]) -> _B:
    return FSharpMap__get_Item(table, key)


def try_find(key: _A, table: FSharpMap[_A, _B]) -> Optional[_B]:
    return FSharpMap__TryFind(table, key)


def remove(key: _A, table: FSharpMap[_A, _B]) -> FSharpMap[_A, _B]:
    return FSharpMap__Remove(table, key)


def contains_key(key: _A, table: FSharpMap[_A, _B]) -> bool:
    return FSharpMap__ContainsKey(table, key)


def iterate(action: Any, table: FSharpMap[_A, _B]) -> None:
    FSharpMap__Iterate(table, action)


def try_pick(chooser: Any, table: FSharpMap[_A, _B]) -> Optional[_C]:
    return FSharpMap__TryPick(table, chooser)


def pick(chooser: Any, table: FSharpMap[_A, _B]) -> _C:
    match_value : Optional[_C] = try_pick(chooser, table)
    if match_value is not None:
        return value_1(match_value)
...
def exists(predicate: Any, table: FSharpMap[_A, _B]) -> bool:
    return FSharpMap__Exists(table, predicate)


def filter(predicate: Any, table: FSharpMap[_A, _B]) -> FSharpMap[_A, _B]:
    return FSharpMap__Filter(table, predicate)


def partition(predicate: Any, table: FSharpMap[_A, _B]) -> Tuple[FSharpMap[_A, _B], FSharpMap[_A, _B]]:
    return FSharpMap__Partition(table, predicate)


def for_all(predicate: Any, table: FSharpMap[_A, _B]) -> bool:
    return FSharpMap__ForAll(table, predicate)


def map(mapping: Any, table: FSharpMap[_A, _B]) -> FSharpMap[_A, _C]:
    return FSharpMap__Map(table, mapping)


def fold(folder: Any, state: _STATE, table: FSharpMap[_KEY, _T]) -> _STATE:
    return MapTreeModule_fold(folder, state, FSharpMap__get_Tree(table))


def fold_back(folder: Any, table: FSharpMap[_KEY, _T], state: _STATE) -> _STATE:
    return MapTreeModule_foldBack(folder, FSharpMap__get_Tree(table), state)


def to_seq(table: FSharpMap[_A, _B]) -> IEnumerable[Tuple[_A, _B]]:
    def mapping(kvp: Any, table: FSharpMap[_A, _B]=table) -> Tuple[_A, _B]:
        return (kvp[0], kvp[1])

    return map_1(mapping, table)


def find_key(predicate: Any, table: FSharpMap[_A, _B]) -> _A:
    def chooser(kvp: Any, predicate: Any=predicate, table: FSharpMap[_A, _B]=table) -> Optional[_A]:
        k : _A = kvp[0]
...
def try_find_key(predicate: Any, table: FSharpMap[_A, _B]) -> Optional[_A]:
    def chooser(kvp: Any, predicate: Any=predicate, table: FSharpMap[_A, _B]=table) -> Optional[_A]:
        k : _A = kvp[0]
        if predicate(k, kvp[1]):
            return some(k)
...
def of_seq(elements: IEnumerable[Tuple[_T, _A]], comparer: IComparer[_T]) -> FSharpMap[_T, _A]:
    return FSharpMap__ctor(comparer, MapTreeModule_ofSeq(comparer, elements))


def of_array(elements: Array[Tuple[_KEY, _VALUE]], comparer: IComparer[_KEY]) -> FSharpMap[_KEY, _VALUE]:
    return FSharpMap__ctor(comparer, MapTreeModule_ofSeq(comparer, elements))


def to_list(table: FSharpMap[_A, _B]) -> FSharpList[Tuple[_A, _B]]:
    return FSharpMap__ToList(table)


def to_array(table: FSharpMap[_A, _B]) -> Array[Any]:
...
def count(table: FSharpMap[_A, _B]) -> int:
