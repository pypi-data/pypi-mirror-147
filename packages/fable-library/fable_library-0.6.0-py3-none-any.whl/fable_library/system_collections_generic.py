...
def expr_19(gen0: TypeInfo) -> TypeInfo:
...
def Stack_1__Ensure_Z524259A4(this: Stack_1[_T], new_size: int) -> None:
    old_size : int = len(this.contents) or 0
    if new_size > old_size:
        old : Array[_T] = this.contents
...
def Stack_1__get_Count(this: Stack_1[_T]) -> int:
    return this.count
...
def Stack_1__Contains_2B595(this: Stack_1[_T], x: _T) -> bool:
    found : bool = False
    i : int = 0
...
def Stack_1__Clear(this: Stack_1[_T]) -> None:
    this.count = 0
...
def Stack_1__ToArray(this: Stack_1[_T]) -> Array[_T]:
    def arrow_22(i: int, this: Stack_1[_T]=this) -> _T:
...
def Queue_1__Contains_2B595(this: Queue_1[_T], x: _T) -> bool:
    found : bool = False
    i : int = 0
    while (not found) if (i < this.count) else False:
...
def Queue_1__Clear(this: Queue_1[_T]) -> None:
    this.count = 0
    this.head = 0
    this.tail = 0
...
def Queue_1__TrimExcess(this: Queue_1[_T]) -> None:
    if (this.count / len(this.contents)) > 0.9:
        Queue_1__ensure_Z524259A4(this, this.count)



def Queue_1__ToArray(this: Queue_1[_T]) -> Array[_T]:
    return to_array(Queue_1__toSeq(this))


def Queue_1__CopyTo_Z2E171D71(this: Queue_1[_T], target: Array[_T], start: int) -> None:
    i : int = start or 0
