...
def SetTreeModule_count(s: Optional[SetTreeLeaf_1[_A]]=None) -> int:
...
def SetTreeModule_rebalance(t1: Optional[SetTreeLeaf_1[_T]], v: _T, t2: Optional[SetTreeLeaf_1[_T]]=None) -> Optional[SetTreeLeaf_1[_T]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, SetTreeNode_1):
            def arrow_249(t1: Optional[SetTreeLeaf_1[_T]]=t1, v: _T=v, t2: Optional[SetTreeLeaf_1[_T]]=t2) -> int:
        ...
        if isinstance(match_value_2, SetTreeNode_1):
            def arrow_250(t1: Optional[SetTreeLeaf_1[_T]]=t1, v: _T=v, t2: Optional[SetTreeLeaf_1[_T]]=t2) -> int:
...
def SetTreeModule_foldBackOpt(f_mut: Any, t_mut: Optional[SetTreeLeaf_1[_T]], x_mut: _A) -> _A:
    while True:
...
def SetTreeModule_foldBack(f: Any, m: Optional[SetTreeLeaf_1[_A]], x: _B) -> _B:
    return SetTreeModule_foldBackOpt(f, m, x)


def SetTreeModule_foldOpt(f_mut: Any, x_mut: _A, t_mut: Optional[SetTreeLeaf_1[_T]]) -> _A:
    while True:
...
def SetTreeModule_fold(f: Any, x: _A, m: Optional[SetTreeLeaf_1[_B]]=None) -> _A:
...
def SetTreeModule_subset(comparer: IComparer[_A], a: Optional[SetTreeLeaf_1[_A]]=None, b: Optional[SetTreeLeaf_1[_A]]=None) -> bool:
    def arrow_251(x: Optional[_A]=None, comparer: IComparer[_A]=comparer, a: Optional[SetTreeLeaf_1[_A]]=a, b: Optional[SetTreeLeaf_1[_A]]=b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    return SetTreeModule_forall(arrow_251, a)


def SetTreeModule_properSubset(comparer: IComparer[_A], a: Optional[SetTreeLeaf_1[_A]]=None, b: Optional[SetTreeLeaf_1[_A]]=None) -> bool:
    def arrow_252(x: Optional[_A]=None, comparer: IComparer[_A]=comparer, a: Optional[SetTreeLeaf_1[_A]]=a, b: Optional[SetTreeLeaf_1[_A]]=b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    if SetTreeModule_forall(arrow_252, a):
        def arrow_253(x_1: Optional[_A]=None, comparer: IComparer[_A]=comparer, a: Optional[SetTreeLeaf_1[_A]]=a, b: Optional[SetTreeLeaf_1[_A]]=b) -> bool:
...
def SetTreeModule_filter(comparer: IComparer[_A], f: Callable[[_A], bool], s: Optional[SetTreeLeaf_1[_A]]=None) -> Optional[SetTreeLeaf_1[_A]]:
...
def SetTreeModule_diff(comparer: IComparer[_A], a: Optional[SetTreeLeaf_1[_A]]=None, b: Optional[SetTreeLeaf_1[_A]]=None) -> Optional[SetTreeLeaf_1[_A]]:
...
def SetTreeModule_intersection(comparer: IComparer[_A], a: Optional[SetTreeLeaf_1[_A]]=None, b: Optional[SetTreeLeaf_1[_A]]=None) -> Optional[SetTreeLeaf_1[_A]]:
    return SetTreeModule_intersectionAux(comparer, b, a, SetTreeModule_empty())


def SetTreeModule_partition1(comparer: IComparer[_A], f: Callable[[_A], bool], k: _A, acc1: Optional[SetTreeLeaf_1[_A]]=None, acc2: Optional[SetTreeLeaf_1[_A]]=None) -> Tuple[Optional[SetTreeLeaf_1[_A]], Optional[SetTreeLeaf_1[_A]]]:
    if f(k):
...
def SetTreeModule_partitionAux(comparer_mut: IComparer[_T], f_mut: Callable[[_T], bool], t_mut: Optional[SetTreeLeaf_1[_T]], acc_0_mut: Optional[SetTreeLeaf_1[_T]], acc_1_mut: Optional[SetTreeLeaf_1[_T]]) -> Tuple[Optional[SetTreeLeaf_1[_T]], Optional[SetTreeLeaf_1[_T]]]:
    while True:
        (comparer, f, t, acc_0, acc_1) = (comparer_mut, f_mut, t_mut, acc_0_mut, acc_1_mut)
        acc : Tuple[Optional[SetTreeLeaf_1[_T]], Optional[SetTreeLeaf_1[_T]]] = (acc_0, acc_1)
        if t is not None:
            t2 : SetTreeLeaf_1[_T] = t
            if isinstance(t2, SetTreeNode_1):
                acc_2 : Tuple[Optional[SetTreeLeaf_1[_T]], Optional[SetTreeLeaf_1[_T]]] = SetTreeModule_partitionAux(comparer, f, SetTreeNode_1__get_Right(t2), acc[0], acc[1])
                acc_3 : Tuple[Optional[SetTreeLeaf_1[_T]], Optional[SetTreeLeaf_1[_T]]] = SetTreeModule_partition1(comparer, f, SetTreeLeaf_1__get_Key(t2), acc_2[0], acc_2[1])
                comparer_mut = comparer
                f_mut = f
                t_mut = SetTreeNode_1__get_Left(t2)
                acc_0_mut = acc_3[0]
...
def SetTreeModule_partition(comparer: IComparer[_A], f: Callable[[_A], bool], s: Optional[SetTreeLeaf_1[_A]]=None) -> Tuple[Optional[SetTreeLeaf_1[_A]], Optional[SetTreeLeaf_1[_A]]]:
...
def SetTreeModule_minimumElement(s: Optional[SetTreeLeaf_1[_A]]=None) -> _A:
    match_value : Optional[_A] = SetTreeModule_minimumElementOpt(s)
...
def SetTreeModule_maximumElement(s: Optional[SetTreeLeaf_1[_A]]=None) -> _A:
    match_value : Optional[_A] = SetTreeModule_maximumElementOpt(s)
    if match_value is None:
        raise Exception("Set contains no elements")
...
def SetTreeModule_mkIterator(s: Optional[SetTreeLeaf_1[_A]]=None) -> SetTreeModule_SetIterator_1[_A]:
    return SetTreeModule_SetIterator_1(SetTreeModule_collapseLHS(singleton_1(s)), False)


def SetTreeModule_notStarted() -> _A:
    raise Exception("Enumeration not started")


def SetTreeModule_alreadyFinished() -> _A:
    raise Exception("Enumeration already started")


def SetTreeModule_current(i: SetTreeModule_SetIterator_1[_A]) -> _A:
    if i.started:
        match_value : FSharpList[Optional[SetTreeLeaf_1[_A]]] = i.stack
...
def SetTreeModule_mkIEnumerator(s: Optional[SetTreeLeaf_1[_A]]=None) -> IEnumerator[_A]:
    ...
    class ObjectExpr255(IEnumerator[_A_]):
...
def SetTreeModule_compareStacks(comparer_mut: IComparer[_T], l1_mut: FSharpList[Optional[SetTreeLeaf_1[_T]]], l2_mut: FSharpList[Optional[SetTreeLeaf_1[_T]]]) -> int:
    while True:
        ...
        match_value : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
        if not is_empty_1(match_value[0]):
            if not is_empty_1(match_value[1]):
                if head(match_value[1]) is not None:
                    if head(match_value[0]) is not None:
                        ...
                        if isinstance(x1_3, SetTreeNode_1):
                            if SetTreeNode_1__get_Left(x1_3) is None:
                                if isinstance(x2_3, SetTreeNode_1):
                                    if SetTreeNode_1__get_Left(x2_3) is None:
                                        ...
                                        match_value_3 : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
                                ...
                                match_value_4 : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
                            ...
                            if SetTreeNode_1__get_Left(x2_3) is None:
                                ...
                                match_value_5 : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
                        ...
                        match_value_1 : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
                    ...
                    match_value_2 : Tuple[FSharpList[Optional[SetTreeLeaf_1[_T]]], FSharpList[Optional[SetTreeLeaf_1[_T]]]] = (l1, l2)
...
def SetTreeModule_choose(s: Optional[SetTreeLeaf_1[_A]]=None) -> _A:
...
def SetTreeModule_copyToArray(s: Optional[SetTreeLeaf_1[_A]], arr: Array[_A], i: int) -> None:
    j : int = i or 0
    def arrow_256(x: Optional[_A]=None, s: Optional[SetTreeLeaf_1[_A]]=s, arr: Array[_A]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = x
        j = (j + 1) or 0
...
def SetTreeModule_toArray(s: Optional[SetTreeLeaf_1[_A]]=None) -> Array[_A]:
    n : int = SetTreeModule_count(s) or 0
    res : Array[_A] = fill([0] * n, 0, n, None)
    SetTreeModule_copyToArray(s, res, 0)
    return res


def SetTreeModule_mkFromEnumerator(comparer_mut: IComparer[_A], acc_mut: Optional[SetTreeLeaf_1[_A]], e_mut: IEnumerator[_A]) -> Optional[SetTreeLeaf_1[_A]]:
    while True:
...
def SetTreeModule_ofArray(comparer: IComparer[_A], l: Array[_A]) -> Optional[SetTreeLeaf_1[_A]]:
    def arrow_257(acc: Optional[SetTreeLeaf_1[_A]], k: _A, comparer: IComparer[_A]=comparer, l: Array[_A]=l) -> Optional[SetTreeLeaf_1[_A]]:
        return SetTreeModule_add(comparer, k, acc)

    return fold_1(arrow_257, SetTreeModule_empty(), l)


def SetTreeModule_ofList(comparer: IComparer[_A], l: FSharpList[_A]) -> Optional[SetTreeLeaf_1[_A]]:
    def arrow_258(acc: Optional[SetTreeLeaf_1[_A]], k: _A, comparer: IComparer[_A]=comparer, l: FSharpList[_A]=l) -> Optional[SetTreeLeaf_1[_A]]:
        return SetTreeModule_add(comparer, k, acc)
...
class FSharpSet(Generic[_T]):
    ...
    def __str__(self) -> str:
        this : FSharpSet[_T] = self
        def arrow_259(x: Optional[_T]=None) -> str:
            copy_of_struct : _T = x
    ...
    def has(self, k: Optional[_T]=None) -> bool:
        s : FSharpSet[_T] = self
...
def FSharpSet__Fold(s: FSharpSet[_T], f: Any, z: _A) -> _A:
    f_1 : Any = f
    def arrow_261(x: _A, z_1: _T, s: FSharpSet[_T]=s, f: Any=f, z: _A=z) -> _A:
        return f_1(z_1, x)
...
def FSharpSet__Map(s: FSharpSet[_T], f: Callable[[_T], _U], comparer: IComparer[_U]) -> FSharpSet[_U]:
    def arrow_262(acc: Optional[SetTreeLeaf_1[_U]], k: _T, s: FSharpSet[_T]=s, f: Callable[[_T], _U]=f, comparer: IComparer[_U]=comparer) -> Optional[SetTreeLeaf_1[_U]]:
...
def union_many(sets: IEnumerable[FSharpSet[_T]], comparer: IComparer[_T]) -> FSharpSet[_T]:
    def arrow_265(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: IEnumerable[FSharpSet[_T]]=sets, comparer: IComparer[_T]=comparer) -> FSharpSet[_T]:
...
def is_subset_of(s1: Set_1[_T], s2: IEnumerable[_T]) -> bool:
    s2_1 : Set_1[_T] = new_mutable_set_with(s1, s2)
    def predicate(arg00: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable[_T]=s2) -> bool:
        return arg00 in s2_1
...
def is_proper_superset_of(s1: Set_1[_T], s2: IEnumerable[_T]) -> bool:
    ...
    if exists_1(predicate, s2_1):
        def predicate_1(arg00_1: Optional[_T]=None, s1: Set_1[_T]=s1, s2: IEnumerable[_T]=s2) -> bool:
            return arg00_1 in s1
