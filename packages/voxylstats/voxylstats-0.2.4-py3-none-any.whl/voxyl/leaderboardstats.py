    ...
    def get_player(self, ign):
        ...
        for i in self.lbInfo:
            if i["uuid"] == member:
                ...
                return WeightedLevelLBPlayer(gen=info, over=over, game=game["stats"], placing=i["position"])
    ...
    def get_player(self, ign):
        ...
        for i in self.lbInfo:
            if i["uuid"] == member:
                ...
                return TechniqueLBPlayer(gen=info, over=over, game=game["stats"], placing=i["position"], time=i["time"], subtime=i["submittime"])
