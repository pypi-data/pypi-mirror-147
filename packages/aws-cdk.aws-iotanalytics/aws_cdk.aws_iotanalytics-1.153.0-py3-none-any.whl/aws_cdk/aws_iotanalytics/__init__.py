...
class CfnChannel(
    ...
    def __init__(
        ...
        *,
        ...
        channel_storage: typing.Optional[typing.Union["CfnChannel.ChannelStorageProperty", aws_cdk.core.IResolvable]] = None,
...
class CfnDataset(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        actions: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, "CfnDataset.ActionProperty"]]],
