...
class FinalDfUserController:
    ...
    def get_final_df_user_profile(df_customer=None, df_user_pay_tv=None):
        ...
        # chunking value every 1000 records
        n = 1000
        chunk_value = [
            df_customer[i : i + n] for i in range(0, df_customer.shape[0], n)
        ]
        for ch in chunk_value:
            ...
            for val in ch:
                ...
                yield final_df_user_profile, result_not_correct_df
