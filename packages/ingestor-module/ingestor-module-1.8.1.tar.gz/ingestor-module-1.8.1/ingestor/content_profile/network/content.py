            ...
            try:
                ...
                for property_num, property_val in payload.iterrows():
                    ...
                    if property_val[CONTENT_ID] and property_val[CONTENT_ID] is not None and \
                        ...
                        find_content_obj = Node(
                            **{LABEL: content_label, PROPERTIES: {CONTENT_ID: int(property_val[CONTENT_ID])}})
        ...
        try:
            ...
            if len(content_nodes) > 0:
                ...
                for record in content_nodes:
                    ...
                    SimilarityUtils.add_content_similarity_property(content_label, content_homepage_id, self.graph)
            else:
