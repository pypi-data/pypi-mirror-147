...
_package_data: Dict[str, Any] = dict(
    ...
    version_info=(0, 2, 0),
    __version__='0.2.0',
    version_timestamp='2022-04-20 15:01:17',
...
def split(
    path: Path, yaml: Optional[Any] = None, cmnt: Optional[int] = None
) -> Generator[Any, None, None]:
    for res in YamlDocStreamSplitter(path=path, cmnt=cmnt).iter(yaml=yaml):
        yield res
