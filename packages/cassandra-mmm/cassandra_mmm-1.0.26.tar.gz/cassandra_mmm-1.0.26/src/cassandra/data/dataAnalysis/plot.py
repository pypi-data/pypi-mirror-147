...
def show_metric_trend(metric_array, name_metric='mape'):
    fig = go.Figure(
        layout=dict(xaxis_title='Iterations', yaxis_title=name_metric, title=name_metric + ' Trend',
                    legend_title='Legend'))
    fig.add_trace(go.Scatter(y=metric_array))
    fig.show()
