...
def load_model_state(run_id: str, model: LightningModule, filename: str = 'last') -> None:
...
def load_state(run_id: str, model: LightningModule, trainer: Trainer, filename: str = 'last') -> None:
    device = torch.device('cuda') if torch.cuda.device_count() else torch.device('cpu')
