...
class Db2Connection(BaseModel):
    ...
    type: Optional[Db2Type] = Field('Db2', description='Service Type')
    scheme: Optional[Db2Scheme] = Field(
        'db2+ibm_db', description='SQLAlchemy driver scheme options.'
    )
    username: str = Field(
        ...,
    ...
    hostPort: str = Field(..., description='Host and port of the DB2')
