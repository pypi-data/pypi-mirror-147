...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 427,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 428,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 429,
    SBK_QLOCALE_IDX                                          = 174,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 184,
    SBK_QLOCKFILE_IDX                                        = 183,
    SBK_QMARGINS_IDX                                         = 185,
    SBK_QMARGINSF_IDX                                        = 186,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 187,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 188,
    SBK_QMETACLASSINFO_IDX                                   = 189,
    SBK_QMETAENUM_IDX                                        = 190,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 192,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 193,
    SBK_QMETAMETHOD_IDX                                      = 191,
    SBK_QMETAOBJECT_CALL_IDX                                 = 195,
    SBK_QMETAOBJECT_IDX                                      = 194,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 196,
    SBK_QMETAPROPERTY_IDX                                    = 197,
    SBK_QMETATYPE_TYPE_IDX                                   = 199,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 200,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 111,
    SBK_QMETATYPE_IDX                                        = 198,
    SBK_QMIMEDATA_IDX                                        = 201,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 203,
    SBK_QMIMEDATABASE_IDX                                    = 202,
    SBK_QMIMETYPE_IDX                                        = 204,
    SBK_QMODELINDEX_IDX                                      = 205,
    SBK_QMODELROLEDATA_IDX                                   = 206,
    SBK_QMUTEX_IDX                                           = 207,
    SBK_QOBJECT_IDX                                          = 208,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 210,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 209,
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 212,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 211,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 213,
    SBK_QPAUSEANIMATION_IDX                                  = 214,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 215,
    SBK_QPLUGINLOADER_IDX                                    = 216,
    SBK_QPOINT_IDX                                           = 217,
    SBK_QPOINTF_IDX                                          = 218,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 224,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 225,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 222,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 223,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 221,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 220,
    SBK_QPROCESS_IDX                                         = 219,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 227,
    SBK_QPROCESSENVIRONMENT_IDX                              = 226,
    SBK_QPROPERTYANIMATION_IDX                               = 228,
    SBK_QRANDOMGENERATOR_IDX                                 = 229,
    SBK_QRANDOMGENERATOR64_IDX                               = 230,
    SBK_QREADLOCKER_IDX                                      = 231,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 233,
    SBK_QREADWRITELOCK_IDX                                   = 232,
    SBK_QRECT_IDX                                            = 234,
    SBK_QRECTF_IDX                                           = 235,
    SBK_QRECURSIVEMUTEX_IDX                                  = 236,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 240,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 113,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 239,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 238,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 112,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 241,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 114,
    SBK_QREGULAREXPRESSION_IDX                               = 237,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 242,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 243,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 245,
    SBK_QRESOURCE_IDX                                        = 244,
    SBK_QRUNNABLE_IDX                                        = 246,
    SBK_QSAVEFILE_IDX                                        = 247,
    SBK_QSEMAPHORE_IDX                                       = 248,
    SBK_QSEMAPHORERELEASER_IDX                               = 249,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 250,
    SBK_QSETTINGS_STATUS_IDX                                 = 254,
    SBK_QSETTINGS_FORMAT_IDX                                 = 252,
    SBK_QSETTINGS_SCOPE_IDX                                  = 253,
    SBK_QSETTINGS_IDX                                        = 251,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 256,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 257,
    SBK_QSHAREDMEMORY_IDX                                    = 255,
    SBK_QSIGNALBLOCKER_IDX                                   = 258,
    SBK_QSIGNALMAPPER_IDX                                    = 259,
    SBK_QSIZE_IDX                                            = 260,
    SBK_QSIZEF_IDX                                           = 261,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 262,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 264,
    SBK_QSOCKETNOTIFIER_IDX                                  = 263,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 265,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 268,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 267,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 115,
    SBK_QSTANDARDPATHS_IDX                                   = 266,
    SBK_QSTORAGEINFO_IDX                                     = 269,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 271,
    SBK_QSTRINGCONVERTER_IDX                                 = 270,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 273,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 116,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 272,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 274,
    SBK_QSTRINGDECODER_IDX                                   = 275,
    SBK_QSTRINGENCODER_IDX                                   = 276,
    SBK_QSTRINGLISTMODEL_IDX                                 = 277,
    SBK_QSYSINFO_SIZES_IDX                                   = 280,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 279,
    SBK_QSYSINFO_IDX                                         = 278,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 282,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 283,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 281,
    SBK_QTEMPORARYDIR_IDX                                    = 284,
    SBK_QTEMPORARYFILE_IDX                                   = 285,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 288,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 287,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 117,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 286,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 292,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 290,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 293,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 291,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 118,
    SBK_QTEXTSTREAM_IDX                                      = 289,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 294,
    SBK_QTHREAD_PRIORITY_IDX                                 = 296,
    SBK_QTHREAD_IDX                                          = 295,
    SBK_QTHREADPOOL_IDX                                      = 297,
    SBK_QTIME_IDX                                            = 298,
    SBK_QTIMELINE_STATE_IDX                                  = 301,
    SBK_QTIMELINE_DIRECTION_IDX                              = 300,
    SBK_QTIMELINE_IDX                                        = 299,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 305,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 303,
    SBK_QTIMEZONE_IDX                                        = 302,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 304,
    SBK_QTIMER_IDX                                           = 306,
    SBK_QTIMEREVENT_IDX                                      = 307,
    SBK_QTRANSLATOR_IDX                                      = 308,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 309,
    SBK_QURL_PARSINGMODE_IDX                                 = 313,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 314,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 312,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 120,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 315,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 122,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 311,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 119,
    SBK_QURL_IDX                                             = 310,
    SBK_QURLQUERY_IDX                                        = 316,
    SBK_QUUID_VARIANT_IDX                                    = 319,
    SBK_QUUID_VERSION_IDX                                    = 320,
    SBK_QUUID_STRINGFORMAT_IDX                               = 318,
    SBK_QUUID_IDX                                            = 317,
    SBK_QVARIANTANIMATION_IDX                                = 321,
    SBK_QVERSIONNUMBER_IDX                                   = 322,
    SBK_QWAITCONDITION_IDX                                   = 323,
    SBK_QWRITELOCKER_IDX                                     = 324,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 325,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 326,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 327,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 328,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 329,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 330,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 334,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 333,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 332,
    SBK_QXMLSTREAMREADER_IDX                                 = 331,
    SBK_QXMLSTREAMWRITER_IDX                                 = 335,
    SBK_QT_GLOBALCOLOR_IDX                                   = 370,
    SBK_QT_MOUSEBUTTON_IDX                                   = 386,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 136,
    SBK_QT_ORIENTATION_IDX                                   = 391,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 138,
    SBK_QT_FOCUSPOLICY_IDX                                   = 365,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 404,
    SBK_QT_SORTORDER_IDX                                     = 402,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 403,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 140,
    SBK_QT_TILERULE_IDX                                      = 409,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 337,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 123,
    SBK_QT_TEXTFLAG_IDX                                      = 406,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 405,
    SBK_QT_WHITESPACEMODE_IDX                                = 418,
    SBK_QT_HITTESTACCURACY_IDX                               = 372,
    SBK_QT_WINDOWTYPE_IDX                                    = 423,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 145,
    SBK_QT_WINDOWSTATE_IDX                                   = 422,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 144,
    SBK_QT_APPLICATIONSTATE_IDX                              = 340,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 124,
    SBK_QT_SCREENORIENTATION_IDX                             = 396,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 139,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 419,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 339,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 373,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 130,
    SBK_QT_BGMODE_IDX                                        = 344,
    SBK_QT_KEY_IDX                                           = 380,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 381,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 134,
    SBK_QT_MODIFIER_IDX                                      = 385,
    SBK_QT_ARROWTYPE_IDX                                     = 341,
    SBK_QT_PENSTYLE_IDX                                      = 394,
    SBK_QT_PENCAPSTYLE_IDX                                   = 392,
    SBK_QT_PENJOINSTYLE_IDX                                  = 393,
    SBK_QT_BRUSHSTYLE_IDX                                    = 345,
    SBK_QT_SIZEMODE_IDX                                      = 401,
    SBK_QT_UIEFFECT_IDX                                      = 417,
    SBK_QT_CURSORSHAPE_IDX                                   = 354,
    SBK_QT_TEXTFORMAT_IDX                                    = 407,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 342,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 357,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 125,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 358,
    SBK_QT_TOOLBARAREA_IDX                                   = 412,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 142,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 413,
    SBK_QT_DATEFORMAT_IDX                                    = 355,
    SBK_QT_TIMESPEC_IDX                                      = 410,
    SBK_QT_DAYOFWEEK_IDX                                     = 356,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 397,
    SBK_QT_CASESENSITIVITY_IDX                               = 346,
    SBK_QT_CORNER_IDX                                        = 353,
    SBK_QT_EDGE_IDX                                          = 360,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 127,
    SBK_QT_CONNECTIONTYPE_IDX                                = 350,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 399,
    SBK_QT_FILLRULE_IDX                                      = 363,
    SBK_QT_MASKMODE_IDX                                      = 383,
    SBK_QT_CLIPOPERATION_IDX                                 = 349,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 378,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 379,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 416,
    SBK_QT_AXIS_IDX                                          = 343,
    SBK_QT_FOCUSREASON_IDX                                   = 366,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 351,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 375,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 132,
    SBK_QT_INPUTMETHODHINT_IDX                               = 374,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 131,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 361,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 414,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 382,
    SBK_QT_ANCHORPOINT_IDX                                   = 338,
    SBK_QT_FINDCHILDOPTION_IDX                               = 364,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 128,
    SBK_QT_DROPACTION_IDX                                    = 359,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 126,
    SBK_QT_CHECKSTATE_IDX                                    = 347,
    SBK_QT_ITEMDATAROLE_IDX                                  = 376,
    SBK_QT_ITEMFLAG_IDX                                      = 377,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 133,
    SBK_QT_MATCHFLAG_IDX                                     = 384,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 135,
    SBK_QT_WINDOWMODALITY_IDX                                = 421,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 408,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 141,
    SBK_QT_EVENTPRIORITY_IDX                                 = 362,
    SBK_QT_SIZEHINT_IDX                                      = 400,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 420,
    SBK_QT_COORDINATESYSTEM_IDX                              = 352,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 415,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 143,
    SBK_QT_GESTURESTATE_IDX                                  = 368,
    SBK_QT_GESTURETYPE_IDX                                   = 369,
    SBK_QT_GESTUREFLAG_IDX                                   = 367,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 129,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 389,
    SBK_QT_NAVIGATIONMODE_IDX                                = 390,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 431,
    SBK_QT_TIMERTYPE_IDX                                     = 411,
    SBK_QT_SCROLLPHASE_IDX                                   = 398,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 388,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 387,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 137,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 348,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 371,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 395,
    SBK_QtCoreQT_IDX                                         = 336,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 425,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 426,
    SBK_QtCore_IDX_COUNT                                     = 432
};
