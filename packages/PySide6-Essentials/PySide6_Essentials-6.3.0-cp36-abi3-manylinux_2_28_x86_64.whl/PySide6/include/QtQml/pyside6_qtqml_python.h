...
enum : int {
    ...
    SBK_QQMLDEBUGGINGENABLER_STARTMODE_IDX                   = 25,
    SBK_QQMLDEBUGGINGENABLER_IDX                             = 24,
    SBK_QQMLENGINE_IDX                                       = 26,
    SBK_QQMLERROR_IDX                                        = 27,
    SBK_QQMLEXPRESSION_IDX                                   = 28,
    SBK_QQMLEXTENSIONINTERFACE_IDX                           = 29,
    SBK_QQMLEXTENSIONPLUGIN_IDX                              = 30,
    SBK_QQMLFILE_STATUS_IDX                                  = 32,
    SBK_QQMLFILE_IDX                                         = 31,
    SBK_QQMLFILESELECTOR_IDX                                 = 33,
    SBK_QQMLIMAGEPROVIDERBASE_IMAGETYPE_IDX                  = 36,
    SBK_QQMLIMAGEPROVIDERBASE_FLAG_IDX                       = 35,
    SBK_QFLAGS_QQMLIMAGEPROVIDERBASE_FLAG_IDX                = 1,
    SBK_QQMLIMAGEPROVIDERBASE_IDX                            = 34,
    SBK_QQMLINCUBATIONCONTROLLER_IDX                         = 37,
    SBK_QQMLINCUBATOR_INCUBATIONMODE_IDX                     = 39,
    SBK_QQMLINCUBATOR_STATUS_IDX                             = 40,
    SBK_QQMLINCUBATOR_IDX                                    = 38,
    SBK_QQMLLISTREFERENCE_IDX                                = 41,
    SBK_QQMLNETWORKACCESSMANAGERFACTORY_IDX                  = 43,
    SBK_QQMLPARSERSTATUS_IDX                                 = 44,
    SBK_QQMLPROPERTY_PROPERTYTYPECATEGORY_IDX                = 46,
    SBK_QQMLPROPERTY_TYPE_IDX                                = 47,
    SBK_QQMLPROPERTY_IDX                                     = 45,
    SBK_QQMLPROPERTYMAP_IDX                                  = 48,
    SBK_QQMLPROPERTYVALUESOURCE_IDX                          = 49,
    SBK_QQMLSCRIPTSTRING_IDX                                 = 50,
    SBK_QQMLTYPESEXTENSIONINTERFACE_IDX                      = 51,
    SBK_QML_HAS_ATTACHED_PROPERTIES_IDX                      = 14,
    SBK_QQMLMODULEIMPORTSPECIALVERSIONS_IDX                  = 42,
    SBK_QtQml_IDX_COUNT                                      = 53
};
...
enum : int {
    ...
    SBK_QTQML_QLIST_QQMLABSTRACTURLINTERCEPTORPTR_IDX        = 7, // QList<QQmlAbstractUrlInterceptor* >
