...
def wave2_demodulation(s, T, gamma, wavelet):
    ...
    amplitude = amplitude[ridge, y, x] / 1.6  # scaling to get to real amplitude for some reason
...
def demodulate(signal, calibration, return_amplitude=False, return_ridge=False):
