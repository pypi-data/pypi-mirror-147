...
class OWWiserPythonScript(widget.OWWidget):
    name = "Wiser Python Script"
    ...
    def __init__(self):
        ...
        self.splitCanvas = QSplitter(Qt.Vertical, txt_tab)
        txt_tab.layout().addWidget(self.splitCanvas)
        ...
        self.runBox = gui.widgetBox(self.mainArea, '', addSpace=False)
        gui.button(self.runBox, self, "Execute Selected Script", callback=self.execute)
