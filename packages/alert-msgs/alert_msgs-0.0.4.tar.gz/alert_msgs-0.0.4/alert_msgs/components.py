...
class Table(AlertComponent):
    ...
    def md(self, slack_format: bool, include_table_rows: bool = True) -> str:
        if slack_format:
            return self._slack_md(include_table_rows)
        return self._md(include_table_rows)

    def _md(self, include_table_rows: bool) -> str:
    ...
    def _slack_md(self, include_table_rows: bool) -> str:
        data = [self.caption._slack_md()]
        if include_table_rows:
            ...
            data.append(table)
        data.append(self.kv_data._slack_md())
        return "\n\n".join(data).strip()
