...
class ml360nlppre:
    ...
    def create_preprocessing_pipeline(self):
        ...
        estimators = [('preprocess', pipelinize(self.preprocess)),
                      ('stopword', pipelinize(self.stopword)),
                      ('remove_accented_chars', pipelinize(self.remove_accented_chars)),
                      ('single_characters', pipelinize(self.single_characters)),
                      ('num_to_words', pipelinize(self.num_to_words)),
                      ('remove_single_char', pipelinize(self.remove_single_char)),
                      ('remov_duplicates', pipelinize(self.remov_duplicates)),
                      ('lemmatizer', pipelinize(self.lemmatizer))]
