...
from .__util_validation import (validate_file_labels, validate_file_meta,
                                validate_file_tags)
from .type_hints import Label
...
class Context:
    ...
    def add_labels(
        self, 
        file: File, 
        labels: t.Iterable[t.Dict[str, t.Any]],
