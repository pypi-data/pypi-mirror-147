...
class GAsset(BaseModel):
    ...
    name: Optional[str] = Field('',
                                title='Object Name',
                                description='Automatically update to the config file name.'
                                'It\'s a read-only property.')

    gmap: Optional[GMap] = Field(None,
                                 title='Map Generator Definition',
                                 description='Represent the parameters '
                                 'of procedual map generation.'
                                 )
