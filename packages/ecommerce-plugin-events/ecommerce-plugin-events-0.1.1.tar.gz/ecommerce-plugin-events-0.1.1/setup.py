...
VERSION = get_version('events', '__init__.py')
...
setup(
    name='ecommerce-plugin-events',
    version=VERSION,
    description="""Plugin to handle events consumed by ecommerce""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/edx/ecommerce-plugin-events',
    packages=[
        'events',
    ],
    ...
    entry_points={
        "ecommerce.djangoapp": [
            "events = events.apps:EventsConfig",
        ]
    }
)
