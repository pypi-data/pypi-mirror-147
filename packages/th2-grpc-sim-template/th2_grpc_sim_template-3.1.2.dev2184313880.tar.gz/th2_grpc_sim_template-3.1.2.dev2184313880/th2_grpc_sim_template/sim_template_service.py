...
class SimTemplateService(object):
    ...
    def createOrderNewRule(self, request, timeout=None):
        return self.connector.create_request('createOrderNewRule', request, timeout)

    def createOrderAmendRule(self, request, timeout=None):
        return self.connector.create_request('createOrderAmendRule', request, timeout)

    def createOrderCancelRule(self, request, timeout=None):
        return self.connector.create_request('createOrderCancelRule', request, timeout)