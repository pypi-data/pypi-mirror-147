...
class CfnAnomalyMonitor(
    ...
    def __init__(
        ...
        *,
        ...
        resource_tags: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnAnomalyMonitor.ResourceTagProperty", _IResolvable_a771d0ef]]]] = None,
    ) -> None:
...
class CfnAnomalySubscription(
    ...
    def __init__(
        ...
        *,
        ...
        resource_tags: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnAnomalySubscription.ResourceTagProperty", _IResolvable_a771d0ef]]]] = None,
    ) -> None:
