...
class CfnPlaybackConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        avail_suppression: typing.Optional[typing.Union["CfnPlaybackConfiguration.AvailSuppressionProperty", _IResolvable_a771d0ef]] = None,
        bumper: typing.Optional[typing.Union["CfnPlaybackConfiguration.BumperProperty", _IResolvable_a771d0ef]] = None,
        cdn_configuration: typing.Optional[typing.Union["CfnPlaybackConfiguration.CdnConfigurationProperty", _IResolvable_a771d0ef]] = None,
        configuration_aliases: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Any]]] = None,
        dash_configuration: typing.Optional[typing.Union["CfnPlaybackConfiguration.DashConfigurationForPutProperty", _IResolvable_a771d0ef]] = None,
        live_pre_roll_configuration: typing.Optional[typing.Union["CfnPlaybackConfiguration.LivePreRollConfigurationProperty", _IResolvable_a771d0ef]] = None,
        manifest_processing_rules: typing.Optional[typing.Union["CfnPlaybackConfiguration.ManifestProcessingRulesProperty", _IResolvable_a771d0ef]] = None,
    ...
    def dash_configuration(
        self,
    ) -> typing.Optional[typing.Union["CfnPlaybackConfiguration.DashConfigurationForPutProperty", _IResolvable_a771d0ef]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnPlaybackConfiguration.DashConfigurationForPutProperty", _IResolvable_a771d0ef]], jsii.get(self, "dashConfiguration"))

    @dash_configuration.setter
    def dash_configuration(
        self,
        value: typing.Optional[typing.Union["CfnPlaybackConfiguration.DashConfigurationForPutProperty", _IResolvable_a771d0ef]],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_mediatailor.CfnPlaybackConfiguration.DashConfigurationForPutProperty",
        jsii_struct_bases=[],
        name_mapping={
            "mpd_location": "mpdLocation",
            "origin_manifest_type": "originManifestType",
    ...
    class ManifestProcessingRulesProperty:
        def __init__(
            self,
            *,
            ad_marker_passthrough: typing.Optional[typing.Union["CfnPlaybackConfiguration.AdMarkerPassthroughProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            '''
...
class CfnPlaybackConfigurationProps:
    ...
    def dash_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnPlaybackConfiguration.DashConfigurationForPutProperty, _IResolvable_a771d0ef]], result)
