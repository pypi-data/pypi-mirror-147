...
from .instructions import (
    build_entropy_redeem_accrued_instructions,
...
# # 🥭 PerpMarket class
#
# This class encapsulates our knowledge of a Entropy perps market.
#
...
class PerpMarketInstructionBuilder(MarketInstructionBuilder):
    ...
    def build_redeem_instructions(self) -> CombinableInstructions:
        return build_entropy_redeem_accrued_instructions(
            self.context,
            self.wallet,
            self.perp_market,
            self.group,
