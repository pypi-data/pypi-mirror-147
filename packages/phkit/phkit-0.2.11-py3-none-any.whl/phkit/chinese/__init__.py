...
from .sequence import text2sequence, text2phoneme, pinyin2phoneme, phoneme2sequence, sequence2phoneme, phoneme2pinyin
from .sequence import symbol_chinese, ph2id_dict, id2ph_dict

from .symbol import symbol_chinese as symbols
from .phoneme import shengyun2ph_dict, pinyin2ph_dict
...
def sequence_to_text(src):
    """音素和拼音不是完全可逆的变换，序列逆变换为拼音只提供其中一种拼音的可能。"""
    phs = sequence2phoneme(src)
    pins = phoneme2pinyin(phs)
    return " ".join(pins)
