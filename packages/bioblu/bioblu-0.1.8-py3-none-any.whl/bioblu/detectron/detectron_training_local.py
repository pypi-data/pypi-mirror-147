...
if __name__ == "__main__":
    ...
    with open("/home/findux/Desktop/img_dicts.json", "w") as f:
        f.write(json.dumps(train_imgs, indent=4))

    sys.exit(0)
    classes = materials_dict #.values()  # Using only the values seems to lead to an error
