...
def create_fallbacK_material_dict_coco(ds_root_dir):
    pass
    # ToDo
...
def load_coco_ds(coco_root_dir: str) -> (pd.DataFrame, pd.DataFrame):
    """
    ...
    """
    json_path = os.path.join(coco_root_dir, 'annotations/annotations.json')
...
def load_yolo_annotations(fpath_annotations_txt: str, img_fpath: str, materials_dict=None) -> List[BBox]:
    ...
    logging.debug(f"Successfully loaded annotations file {fpath_annotations_txt}")
    return bboxes
...
def make_json_readable(fpath_json, overwrite=True) -> None:
    """Overwrites an already existing json with a neatly formatted version of itself"""
    json_data = load_json(fpath_json)
    file_out = fpath_json
    if not overwrite:
        tstamp = format(datetime.datetime.now(), '%Y_%m_%d-%H%M')
...
def show_all_annotations_coco(img_directory: str, annotations_df: pd.DataFrame):
    """
...
def show_img_annotations_coco(img_name: str, img_dir: str, annotations_df: pd.DataFrame, prefix_text: str = ""):
    ...
    _img_annotations = annotations_df.loc[annotations_df['file_name'] == img_name, :]
...
def show_img_annotations_yolo(fpath_img: str, fpath_annotations: str, prefix_text: str = '', color="red",
                              materials_dict=None):
    """
...
def show_planned_cuts(fpath_img: str, vcut_locations: List[int], hcut_locations: List[int], fpath_annot: str = None):
    if fpath_annot is not None:
        show_img_annotations_yolo(fpath_img, fpath_annot)
    else:
...
def show_yolo_predictions_and_ground_truths(fpath_img, fpath_gt_annotations, fpath_pred_annotations,
...
# ToDo: (perhaps put these into ds_convert
def labelme_to_coco():
    pass
...
if __name__ == '__main__':
    ...
    # coco_root_dir = '/media/findux/DATA/Documents/Malta_II/datasets/uavvaste_coco/UAVVaste/'
    # imgs, annots = load_coco_ds(coco_root_dir)
    # annots.to_csv('/home/findux/Desktop/annotations.csv')

    # annots_merged = merge_img_info_into_labels(imgs, annots)
    # annots_merged.to_csv('/home/findux/Desktop/annotations_merged.csv')
    # print('IMAGES:')
    # print(imgs.columns)
    # print(imgs.head())
    # print('ANNOTATIONS:')
    ...
    # Maybe
    # labelme_root_dir = '/media/findux/DATA/Documents/Malta_II/datasets/2021-12-16_paradise_bay/tiles_2022-01-06/checked/'
    # materials_set = extract_materials_from_labelme_jsons(labelme_root_dir)
    # materials_dict = create_materials_dict(materials_set)
    # print(materials_dict)

    # fdir = '/media/findux/DATA/Documents/Malta_II/datasets/2021-12-16_paradise_bay/tiles_2022-01-06/checked/'
    # annot_count = count_annotations(fdir)
    # print(annot_count)

    # fpath_img = "/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/images/test/DJI_0544_0-1.tif"
    # fpath_ann = "/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/labels/test/DJI_0544_0-1.txt"
    # fpath_pre = "/media/findux/DATA/Documents/Malta_II/yolov5/runs/detect/exp/labels/DJI_0544_0-1.txt"
    # savepath = "/home/findux/Desktop/"
    # mats = {0: "plastic"}

    # show_yolo_predictions_and_ground_truths(fpath_img, fpath_ann, fpath_pre, mats, savepath, additional_text="0.001 NMS IoU threshold.")
    # testline = "0 0.22087830442137382 0.06256459584065807 0.01587183654515905 0.016468871272679035"
    # annotations = extract_annotation_from_line(testline)
    # print(annotations)

    # fpath_json = "/media/findux/DATA/Documents/Malta_II/datasets/2021-12-16_paradise_bay/tiles_2022-01-06/checked/DJI_0461_1-1.json"
    # fpath_img = "/media/findux/DATA/Documents/Malta_II/datasets/2021-12-16_paradise_bay/tiles_2022-01-06/checked/DJI_0461_1-1.tif"
    # json_data = load_json(fpath_json)
    # encoded_img = encode_img_for_labelme(fpath_img)
    # print(f"Encoded: {type(encoded_img)} | json array: {type(json_data['imageData'])}")
    # print(f"Same: {encoded_img == json_data['imageData']}")
    # print(type(encoded_img))
    #
    # decoded_img = decode_labelme_imgdata(encoded_img)
    # print(type(decoded_img))
    # decoded_img.show()

    # img_fpath = "/home/findux/Pictures/anthony-trujillo-highresscreenshot00022.jpg"
    # print(Image.open(img_fpath).size)

    # Tile re-cutting
    # annotation_fpath = "/media/findux/DATA/Documents/Malta_II/datasets/tile_recutting_tests/DJI_0477_1-2.txt"
    # img_fpath = "/media/findux/DATA/Documents/Malta_II/datasets/tile_recutting_tests/DJI_0477_1-2.tif"
    #
    # cut_annotated_img(img_fpath=img_fpath, annotations_fpath=annotation_fpath, vertical_cuts_n=1, horizontal_cuts_n=1,
    #                   materials_dict={0: "plastic"}, show_preview=True)

    # # Prediction verification
    # fpath_img = "/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/images/test/DJI_0612_1-2.tif"
    # fpath_gt = "/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/labels/test/DJI_0612_1-2.txt"
    # #fpath_pred = "/media/findux/DATA/Documents/Malta_II/results/4224_2022-03-14_165833/detect/4224_1824/labels/DJI_0612_1-2.txt"
    # fpath_pred = "/media/findux/DATA/Documents/Malta_II/results/4272_2022-03-18_133714/detect_912_batch_4/labels/DJI_0612_1-2.txt"
    # show_yolo_predictions_and_ground_truths(fpath_img, fpath_gt, fpath_pred, {0:"plastic"},
    #                                         save_location="/home/findux/Desktop/",
    #                                         additional_text="Training & inference 912 px, batch size 4.")

    # ds_base_dir ="/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/"
    # save_groundtruth_visualisations(ds_base_dir)

    # print(get_box_location(BBox([0.5, 0.2, 0.1, 0.12], "plastic", "yolo", 5472, 3648), 2, 1))

    # Counting annotations
    # fpath = "/media/findux/DATA/Documents/Malta_II/datasets/dataset_01_paradise_bay/"
    # print(count_yolo_annotations(fpath))
    # fpath = "/media/findux/HDD/Malta_II/surveys/2022-01-28_Gnejna_beach/Test_Gnejna_bay 28-01-2022/RGB images/5m altitude/Gnejna_tiles_2022-02-08/"
    # print(count_yolo_annotations(fpath, False))

    # # turn yolo annotations into labelme annotations
    # yolo_annot = "/home/findux/Desktop/New Folder/DJI_0506_1-0.txt"
    # img_fpath = "/home/findux/Desktop/New Folder/DJI_0506_1-0.tif"
    #
    # yolo_annotations = load_yolo_annotations(yolo_annot, img_fpath, {0: "plastic"})
    # annotation = LabelmeAnnotation(img_fpath, yolo_annotations)
    # annotation.to_json("/home/findux/Desktop/New Folder/")

    # fpath = "/media/findux/DATA/Documents/Malta_II/surveys/2022-01-28_Gnejna_beach/Test_Gnejna_bay 28-01-2022/RGB images/5m altitude/Gnejna_tiles_2022-02-08/"
    # fpath = "/home/findux/Desktop/material_update_test/"
    # update_all_labelme_materials(fpath, "plastic", "trash", os.path.join(fpath, "backup"))

    # dsdir = "/media/findux/DATA/Documents/Malta_II/surveys/2022-01-28_Gnejna_beach/Test_Gnejna_bay 28-01-2022/RGB images/5m altitude/with_duplicates/"
    # mats = extract_materials_from_labelme_jsons(dsdir)
    # print(mats)

    # fpath_in = "/home/findux/Desktop/balloon_dataset/balloon/train/via_region_data.json"
    # fpath_out = "/home/findux/Desktop/via_region_data_readable.json"
    # save_readable_json(fpath_in, fpath_out)

    make_json_readable("/home/findux/Desktop/balloon_dataset/balloon/train/via_region_data.json")
