...
if __name__ == "__main__":
    ...
    ds_root_dir = "/opt/nfs/shared/scratch/bioblu/datasets/dataset_04_gnejna_with_duplicates"
    coco_ds = ds_root_dir + "_coco"
    logging.info(f"Yolo ds: {ds_root_dir}")
    logging.info(f"Coco ds: {coco_ds}")

    ds_convert.convert_yolo_to_coco(ds_root_dir, coco_ds, materials_dict)

    coco_ds = "/opt/nfs/shared/scratch/bioblu/datasets/dataset_04_gnejna_with_duplicates_coco"
