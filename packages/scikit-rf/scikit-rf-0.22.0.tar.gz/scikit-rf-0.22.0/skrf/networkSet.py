...
class NetworkSet(object):
    ...
    def to_mdif(self, output_file: str, comments=[]):
        """Convert the NetworkSet to a (G)MDIF file.
    
        if values==None then use networkset name
    ...
    def __create_optionstring(self, nports: int):
