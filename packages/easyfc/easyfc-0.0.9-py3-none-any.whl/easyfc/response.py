...
def ok_json_start_response_with_token(token: str):
    ...
    :return:
    """
    return '200 ok', [('Content-type', 'application/json'), ('E-Token', token), ('Access-Control-Expose-Headers',  'Authorization')]
...
def err_json_start_response_with_token(token: str):
    ...
    :return:
    """
    return '500 err', [('Content-type', 'application/json'), ('E-Token', token), ('Access-Control-Expose-Headers',  'Authorization')]
