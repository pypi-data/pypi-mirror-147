...
def create_zone_from_bounding_box(bounding_box, name: str = ..., description: str = ..., img_width: Any | None = ..., img_height: Any | None = ...): ...
...
class Zone:
    def __init__(self, name: str = ..., points: Any | None = ..., type: Any | None = ..., description: str = ..., width: Any | None = ..., height: Any | None = ...) -> None: ...
...
class ZoneList:
    ...
    @property
    def height(self): ...
    def update_dimensions(self, width: Any | None = ..., height: Any | None = ...) -> None: ...
    ...
    def markup_image_with_zones(self, frame, zone_names: Any | None = ..., show_labels: bool = ..., show_boundaries: bool = ..., fill_zones: bool = ..., color=..., line_thickness: int = ..., font_size: float = ..., font_thickness: int = ..., alpha: float = ...): ...
