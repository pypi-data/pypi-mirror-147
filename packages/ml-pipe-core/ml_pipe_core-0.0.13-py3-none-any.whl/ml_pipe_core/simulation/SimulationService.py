...
from ..machine_topics import MACHINE_EVENTS, SIMULATION_EVENTS
from ..message import Headers
from ..config import KAFKA_SERVER_URL
from ..simulation.update_message_types import UpdateMessage
from src.ml_pipe_core.event_utls.consumer import consume
...
class SimulationService(Service):
    ...
    def post_init(self):
        for msg in consume([MACHINE_EVENTS], timeout_poll=0.1, group_id=self.type, bootstrap_server=KAFKA_SERVER_URL):
