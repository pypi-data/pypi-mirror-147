...
class KafkaPipeClient():
    ...
    def _get_results_from_observer(self, package_id: str, service_type: str, timeout=30, poll_time=0.05):
    ...
    def get_service_results(self, service_id: ServiceId):
        return AgentResultMessage.from_byte_string(self._get_results_from_observer(service_id.id, service_id.name, timeout=30, poll_time=0.05)['data'])
