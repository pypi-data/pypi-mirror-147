...
class AnalysisFramework(object):
    ...
    **Advanced Usage(extend APIs)**
    ...
    @classmethod
    def from_yaml(cls, yaml_file, cache_graph,use_cache=True, prefetch_setting=None):
        ...
        return cls(obj, use_cache=use_cache, prefetch_setting=prefetch_setting, cache_graph=cache_graph)
    ...
    def __init__(self, graph: py2neo.Graph or Dict or Namespace = None, use_cache: bool = True,
                 prefetch_setting=None, cache_graph = None):
        ...
        self.graph_map = None
        if isinstance(graph, py2neo.Graph):
            ...
            self.neo4j_graph = copy.deepcopy(graph)
        else:
        ...
        self.cache = cache_graph  # type:BasicCacheGraph
        assert isinstance(self.cache, BasicCacheGraph), "customize CacheGraph must extend BasicCacheGraph"
        # self._threadPool = PrefetchThreadPool(cache_pool=self.cache,
