...
class SFM(I2CSensor):
    ...
    def get_data(self):
        """
        :param scale_factor: sensor specific parameter for the calculation of the volumeflow
        :param offset: sensor specific parameter for the calculation of the volumeflow
