...
- [Tables from lists](#show_table)
- [Syntax highlighting](#markdown_syntax_highlighting)

### Styling

- [Background Color](#styling_background)
- [Text Color](#styling_color)
- [Border Color](#styling_border)
- [Align Text](#styling_align)
- [Sizing](#styling_size)
- [Margin](#styling_margin)
- [Padding](#styling_padding)
...
- [Pattern](#image_background_pattern)
...
- [Vertical Alignment](#layout_vertical_alignment)
...
- [Setting a theme](#theme_basic_noop)
- [Theme switching](#theme_switching)
- [Dark mode](#theme_dark_mode)
- [Color variables](#theme_colors)
- [Sample themes](#theme_samples)
...
nitro = View(
    ...
    menu=[
        ...
        option(main, "Markdown", icon="TextDocument", options=[
            ...
            option(markdown_table, "Tables", icon="TextDocument"),
            option(show_table, "Tables from lists", icon="TextDocument"),
            option(markdown_syntax_highlighting, "Syntax highlighting", icon="TextDocument"),
        ]),
        option(main, "Styling", icon="TextDocument", options=[
            option(styling_background, "Background Color", icon="TextDocument"),
            option(styling_color, "Text Color", icon="TextDocument"),
            option(styling_border, "Border Color", icon="TextDocument"),
            option(styling_align, "Align Text", icon="TextDocument"),
            option(styling_size, "Sizing", icon="TextDocument"),
            option(styling_margin, "Margin", icon="TextDocument"),
            option(styling_padding, "Padding", icon="TextDocument"),
        ]),
        option(main, "Images", icon="TextDocument", options=[
            option(image_basic, "Basic", icon="TextDocument"),
            option(image_resize, "Resize", icon="TextDocument"),
            option(image_fit, "Fit", icon="TextDocument"),
            option(image_background, "Background", icon="TextDocument"),
            option(image_background_pattern, "Pattern", icon="TextDocument"),
        ]),
        option(main, "Layout", icon="TextDocument", options=[
            ...
            option(layout_vertical_alignment, "Vertical Alignment", icon="TextDocument"),
        ]),
        ...
        option(main, "Checkbox", icon="TextDocument", options=[
            ...
            option(checkbox_value, "Value", icon="TextDocument"),
        ]),
        ...
        option(main, "Theming", icon="TextDocument", options=[
            option(theme_basic_noop, "Setting a theme", icon="TextDocument"),
            option(theme_switching, "Theme switching", icon="TextDocument"),
            option(theme_dark_mode, "Dark mode", icon="TextDocument"),
            option(theme_colors, "Color variables", icon="TextDocument"),
            option(theme_samples, "Sample themes", icon="TextDocument"),
        ]),
