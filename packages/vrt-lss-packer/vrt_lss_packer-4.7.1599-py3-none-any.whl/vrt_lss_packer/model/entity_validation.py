...
class EntityValidation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type': (EntityValidationType,),  # noqa: E501
            'entities': ([EntityPath],),  # noqa: E501
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            entities ([EntityPath]): List of entities related to validation.. defaults to []  # noqa: E501
            ...
            info (str, none_type): Information about validation.. [optional]  # noqa: E501
        """
