...
class CalculationSettings(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'max_calculation_time': (str,),  # noqa: E501
            'max_waiting_time': (str,),  # noqa: E501
            'result_ttl': (str,),  # noqa: E501
            'treat_validations_as_errors': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        'max_calculation_time': 'max_calculation_time',  # noqa: E501
        'max_waiting_time': 'max_waiting_time',  # noqa: E501
        'result_ttl': 'result_ttl',  # noqa: E501
        'treat_validations_as_errors': 'treat_validations_as_errors',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            max_calculation_time (str): Max calculation time. The countdown starts from the time when data is uploaded to the server and calculation starts. . [optional] if omitted the server will use the default value of "PT20M"  # noqa: E501
            max_waiting_time (str): Max calculation time. The countdown starts from the time when data is uploaded to the server. . [optional] if omitted the server will use the default value of "PT30M"  # noqa: E501
            result_ttl (str): Calculation result lifetime. The countdown starts from the time when the calculation is completed. . [optional] if omitted the server will use the default value of "PT20M"  # noqa: E501
            treat_validations_as_errors (bool): Treat validations as errors. . [optional] if omitted the server will use the default value of False  # noqa: E501
        """
