...
class CalculationProgress(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (int): Calculation progress as a percentage. The progress displays the current number of completed steps. . if omitted defaults to 0  # noqa: E501

        Keyword Args:
            value (int): Calculation progress as a percentage. The progress displays the current number of completed steps. . if omitted defaults to 0  # noqa: E501
