...
class Blueprint(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([PackageLayout]): A product layout plan as a list of packaging locations. The first level contains a list of pallet stacks. .  # noqa: E501

        Keyword Args:
            value ([PackageLayout]): A product layout plan as a list of packaging locations. The first level contains a list of pallet stacks. .  # noqa: E501
