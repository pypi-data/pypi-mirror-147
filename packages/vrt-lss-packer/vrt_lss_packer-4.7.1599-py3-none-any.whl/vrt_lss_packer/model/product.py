...
class Product(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'max_pressure': (int,),  # noqa: E501
            'compatible_package_keys': ([str],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'max_pressure': 'max_pressure',  # noqa: E501
        'compatible_package_keys': 'compatible_package_keys',  # noqa: E501
        'attributes': 'attributes',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, dimensions, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            count (int): Number of products.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            max_pressure (int): The maximum permissible top load that this product can withstand, in kg/m2.. [optional] if omitted the server will use the default value of 100000  # noqa: E501
            compatible_package_keys ([str]): List of keys of compatible packages. If the list is empty, then all packages are considered compatible. . [optional] if omitted the server will use the default value of []  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, dimensions, *args, **kwargs):  # noqa: E501
        """Product - a model defined in OpenAPI
