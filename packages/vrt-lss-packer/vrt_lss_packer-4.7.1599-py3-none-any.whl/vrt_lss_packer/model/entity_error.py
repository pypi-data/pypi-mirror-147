...
class EntityError(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'type': (EntityErrorType,),  # noqa: E501
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            entities ([EntityPath]): List of entities related to error.. defaults to []  # noqa: E501
            ...
            info (str, none_type): Information about error.. [optional]  # noqa: E501
        """
