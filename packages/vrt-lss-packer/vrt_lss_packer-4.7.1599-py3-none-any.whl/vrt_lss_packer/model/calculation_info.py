...
class CalculationInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'status': (CalculationStatus,),  # noqa: E501
            'result_version': (int,),  # noqa: E501
            'calculation_time': (TimeDuration,),  # noqa: E501
            'waiting_time': (TimeDuration,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, result_version, calculation_time, waiting_time, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, result_version, calculation_time, waiting_time, *args, **kwargs):  # noqa: E501
        """CalculationInfo - a model defined in OpenAPI
