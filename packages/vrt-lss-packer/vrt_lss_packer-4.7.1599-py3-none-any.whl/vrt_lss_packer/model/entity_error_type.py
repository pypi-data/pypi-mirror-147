...
class EntityErrorType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Error type:   * `UNIQUE_IDS_VIOLATION` - all keys must be unique   * `INCONSISTENT_REFERENCE` - bad reference key ., must be one of ["UNIQUE_IDS_VIOLATION", "INCONSISTENT_REFERENCE", ]  # noqa: E501

        Keyword Args:
            value (str): Error type:   * `UNIQUE_IDS_VIOLATION` - all keys must be unique   * `INCONSISTENT_REFERENCE` - bad reference key ., must be one of ["UNIQUE_IDS_VIOLATION", "INCONSISTENT_REFERENCE", ]  # noqa: E501
