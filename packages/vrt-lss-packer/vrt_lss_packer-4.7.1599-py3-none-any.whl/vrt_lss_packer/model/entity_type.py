...
class EntityType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Entity type.., must be one of ["TASK", "SETTINGS", "PRODUCT", "PACKAGE", ]  # noqa: E501

        Keyword Args:
            value (str): Entity type.., must be one of ["TASK", "SETTINGS", "PRODUCT", "PACKAGE", ]  # noqa: E501
