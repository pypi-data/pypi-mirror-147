...
class EntityValidationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Validation type:   * `NO_COMPATIBLE_PACKAGE` - product does not fit into any package . if omitted defaults to "NO_COMPATIBLE_PACKAGE", must be one of ["NO_COMPATIBLE_PACKAGE", ]  # noqa: E501

        Keyword Args:
            value (str): Validation type:   * `NO_COMPATIBLE_PACKAGE` - product does not fit into any package . if omitted defaults to "NO_COMPATIBLE_PACKAGE", must be one of ["NO_COMPATIBLE_PACKAGE", ]  # noqa: E501
