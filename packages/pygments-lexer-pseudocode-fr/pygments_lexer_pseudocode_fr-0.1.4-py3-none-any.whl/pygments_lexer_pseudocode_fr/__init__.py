...
class PseudocodefrLexer(RegexLexer, PseudocodefrStyle):
    '''
    ...
    tokens = {
        ...
        'core':[ # Statements
                 (r'\b(debut|début|fin|si|alors|sinon|fin[_ ]si|tant[ _]que|tantque|fin[ _]tantque|faire|répéter'
                  ...
                  r'pour|fin[ _]pour|à|déclarations?|jusque|spécialise|specialise|comporte|super|public|privé|protégé|'
                  r'afficher|saisir|allant|variant|de|'
                  r'classe'
                  r')\s*\b', Keyword),
