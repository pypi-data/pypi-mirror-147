    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.custom-resources==1.153.0",
        "aws-cdk.lambda-layer-awscli==1.153.0",
        "aws-cdk.lambda-layer-kubectl==1.153.0",
        "aws-cdk.lambda-layer-node-proxy-agent==1.153.0",
