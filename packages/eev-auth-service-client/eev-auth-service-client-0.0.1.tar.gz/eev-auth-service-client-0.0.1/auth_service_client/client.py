...
class AuthClient(BaseClient):
    ...
    def email_login(self, username: str, password: str, platform: str) -> Any:
        return self.post('email_login', username=username, password=password, platform=platform)
    ...
    def check_user_email(self,
        ...
        return self.get('check_user_email',
                         auth_user_email=auth_user_email,
                         auth_user_type=auth_user_type,
                         password_reset=password_reset)

    def check_link_token(self, auth_user_link_token: str) -> Any:
        return self.get('check_link_token', auth_user_link_token=auth_user_link_token)
...
class AccountClient(BaseClient):
    ...
    def edit_user_account(self,
                 ...
                 seller_account_balance: float) -> Any:
