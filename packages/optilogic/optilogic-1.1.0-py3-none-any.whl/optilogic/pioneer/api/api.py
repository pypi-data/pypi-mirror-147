...
App Key Management
https://atlas.optilogic.com/dashboard/#/user-account?tab=appkey
...
class Api():
    ...
    EXAMPLE CONFIG
    :{'user': 'username', 'pass': 'password', 'auth_legacy': True}
    :{'user': 'username', 'app_key': 'base64str'}
