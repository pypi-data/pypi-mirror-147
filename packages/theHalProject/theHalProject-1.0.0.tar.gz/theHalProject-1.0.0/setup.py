...
setup(
    ...
    install_requires=['speech_recognition', 'datetime', 'wikipedia', 'webbrowser', 'gtts', 'pygame', 'mutagen', 'art', 'requests', 'python-dotenv', 'bs4', 'base64', 'datetime', 'argparse', 'requests'],
