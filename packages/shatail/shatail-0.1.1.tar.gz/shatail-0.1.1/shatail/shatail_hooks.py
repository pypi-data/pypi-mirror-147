...
from shatail.coreutils import get_content_languages
from shatail.log_actions import LogFormatter
from shatail.models import ModelLogEntry, Page, PageLogEntry, PageViewRestriction
from shatail.rich_text.pages import PageLinkHandler


def require_shatail_login(next):
    login_url = getattr(
        settings, "SHATAIL_FRONTEND_LOGIN_URL", reverse("shatailcore_login")
    )
    ...
    for restriction in page.get_view_restrictions():
        if not restriction.accept_request(request):
            if restriction.restriction_type == PageViewRestriction.PASSWORD:
                from shatail.forms import PasswordViewRestrictionForm
                ...
                action_url = reverse(
                    "shatailcore_authenticate_with_password",
                ...
                return require_shatail_login(next=request.get_full_path())
...
if getattr(settings, "SHATAIL_WORKFLOW_ENABLED", True):

    @hooks.register("register_permissions")
    def register_workflow_permissions():
        return Permission.objects.filter(
            content_type__app_label="shatailcore",
...
def describe_collection_children(collection):
    ...
    if descendant_count:
        url = reverse("shatailadmin_collections:index")
        return {
...
def register_core_log_actions(actions):
    ...
    actions.register_action("shatail.create", _("Create"), _("Created"))
    actions.register_action("shatail.edit", _("Edit"), _("Edited"))
    actions.register_action("shatail.delete", _("Delete"), _("Deleted"))
    actions.register_action("shatail.publish", _("Publish"), _("Published"))
    actions.register_action(
        "shatail.publish.scheduled",
        _("Publish scheduled draft"),
        _("Published scheduled draft"),
    )
    actions.register_action("shatail.unpublish", _("Unpublish"), _("Unpublished"))
    actions.register_action(
        "shatail.unpublish.scheduled",
        _("Unpublish scheduled draft"),
        _("Unpublished scheduled draft"),
    )
    actions.register_action("shatail.lock", _("Lock"), _("Locked"))
    actions.register_action("shatail.unlock", _("Unlock"), _("Unlocked"))
    actions.register_action("shatail.moderation.approve", _("Approve"), _("Approved"))
    actions.register_action("shatail.moderation.reject", _("Reject"), _("Rejected"))

    @actions.register_action("shatail.rename")
    ...
    @actions.register_action("shatail.revert")
    ...
    @actions.register_action("shatail.copy")
    ...
    @actions.register_action("shatail.copy_for_translation")
    ...
    @actions.register_action("shatail.create_alias")
    ...
    @actions.register_action("shatail.convert_alias")
    ...
    @actions.register_action("shatail.move")
    ...
    @actions.register_action("shatail.reorder")
    ...
    @actions.register_action("shatail.publish.schedule")
    ...
    @actions.register_action("shatail.schedule.cancel")
    ...
    @actions.register_action("shatail.view_restriction.create")
    ...
    @actions.register_action("shatail.view_restriction.edit")
    ...
    @actions.register_action("shatail.view_restriction.delete")
    ...
    @actions.register_action("shatail.comments.create")
    ...
    @actions.register_action("shatail.comments.edit")
    ...
    @actions.register_action("shatail.comments.delete")
    ...
    @actions.register_action("shatail.comments.resolve")
    ...
    @actions.register_action("shatail.comments.create_reply")
    ...
    @actions.register_action("shatail.comments.edit_reply")
    ...
    @actions.register_action("shatail.comments.delete_reply")
...
def register_workflow_log_actions(actions):
    ...
    @actions.register_action("shatail.workflow.start")
    ...
    @actions.register_action("shatail.workflow.approve")
    ...
    @actions.register_action("shatail.workflow.reject")
    ...
    @actions.register_action("shatail.workflow.resume")
    ...
    @actions.register_action("shatail.workflow.cancel")
