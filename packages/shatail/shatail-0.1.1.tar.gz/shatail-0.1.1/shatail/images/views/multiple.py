...
from shatail.admin.views.generic.multiple_upload import AddView as BaseAddView
from shatail.admin.views.generic.multiple_upload import (
    CreateFromUploadView as BaseCreateFromUploadView,
)
from shatail.admin.views.generic.multiple_upload import (
    DeleteUploadView as BaseDeleteUploadView,
)
from shatail.admin.views.generic.multiple_upload import DeleteView as BaseDeleteView
from shatail.admin.views.generic.multiple_upload import EditView as BaseEditView
from shatail.images import get_image_model
from shatail.images.fields import ALLOWED_EXTENSIONS
from shatail.images.forms import get_image_form, get_image_multi_form
from shatail.images.models import UploadedImage
from shatail.images.permissions import ImagesPermissionPolicyGetter, permission_policy
from shatail.images.utils import find_image_duplicates
from shatail.search.backends import get_search_backends
...
class AddView(BaseAddView):
    ...
    edit_object_url_name = "shatailimages:edit_multiple"
    delete_object_url_name = "shatailimages:delete_multiple"
    edit_object_form_prefix = "image"
    context_object_name = "image"
    context_object_id_name = "image_id"

    edit_upload_url_name = "shatailimages:create_multiple_from_uploaded_image"
    delete_upload_url_name = "shatailimages:delete_upload_multiple"
    ...
    def get_confirm_duplicate_upload_response(self, duplicates):
        return render_to_string(
            "shatailimages/images/confirm_duplicate_upload.html",
            {
