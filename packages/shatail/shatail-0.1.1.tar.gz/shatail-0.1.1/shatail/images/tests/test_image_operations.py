...
from shatail.images import image_operations
from shatail.images.exceptions import InvalidFilterSpecError
from shatail.images.image_operations import TransformOperation
from shatail.images.models import Filter, Image
from shatail.images.tests.utils import (
    get_test_image_file,
...
class TestJPEGQualityFilter(TestCase):
    ...
    @override_settings(SHATAILIMAGES_JPEG_QUALITY=50)
...
class TestWebPQualityFilter(TestCase):
    ...
    @override_settings(SHATAILIMAGES_WEBP_QUALITY=50)
...
class TestWebpFormatConversion(TestCase):
    ...
    @override_settings(SHATAILIMAGES_FORMAT_CONVERSIONS={"webp": "webp"})
    def test_override_webp_convert_to_png(self):
        """SHATAILIMAGES_FORMAT_CONVERSIONS can be overridden to disable webp conversion"""
