...
from shatail.admin.widgets import AdminChooser
from shatail.admin.widgets.button import ListingButton
...
class AdminSnippetChooser(AdminChooser):
    ...
    def get_value_data(self, value):
        ...
        edit_url = reverse(
            "shatailsnippets:edit", args=[app_label, model_name, quoted_id]
        )
    ...
    def render_html(self, name, value_data, attrs):
        ...
        return render_to_string(
            "shatailsnippets/widgets/snippet_chooser.html",
            {
                "widget": self,
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailsnippets/js/snippet-chooser-modal.js"),
                versioned_static("shatailsnippets/js/snippet-chooser.js"),
            ]
        )


class SnippetChooserAdapter(WidgetAdapter):
    js_constructor = "shatail.snippets.widgets.SnippetChooser"
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailsnippets/js/snippet-chooser-telepath.js"),
            ]
        )
