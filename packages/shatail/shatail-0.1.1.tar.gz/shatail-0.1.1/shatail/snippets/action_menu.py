...
from shatail.snippets.permissions import get_permission_name
...
class ActionMenuItem(Component):
    ...
    template_name = "shatailsnippets/snippets/action_menu/menu_item.html"
...
class SaveMenuItem(ActionMenuItem):
    name = "action-save"
    label = _("Save")
    template_name = "shatailsnippets/snippets/action_menu/save.html"
...
class SnippetActionMenu:
    template = "shatailsnippets/snippets/action_menu/menu.html"
