...
from shatail import fields as shatailcore_fields
...
class TagsField(Field):
    ...
    These fields are a common way to link tags to objects in Shatail. The API
...
class BaseSerializer(serializers.ModelSerializer):
    ...
    serializer_field_mapping.update(
        {
            shatailcore_fields.StreamField: StreamField,
        }
    )
