...
class TestLocaleIndexView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shataillocales:index"), params)
...
class TestLocaleCreateView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.english = Locale.objects.get()

    def get(self, params={}):
        return self.client.get(reverse("shataillocales:add"), params)

    def post(self, post_data={}):
        return self.client.post(reverse("shataillocales:add"), post_data)
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataillocales/create.html")
    ...
    def test_create(self):
        ...
        self.assertRedirects(response, reverse("shataillocales:index"))
...
class TestLocaleEditView(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def get(self, params=None, locale=None):
        ...
        return self.client.get(
            reverse("shataillocales:edit", args=[locale.id]), params or {}
        )
    ...
    def post(self, post_data=None, locale=None):
        ...
        return self.client.post(
            reverse("shataillocales:edit", args=[locale.id]), post_data
        )

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataillocales/edit.html")
...
class TestLocaleDeleteView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.english = Locale.objects.get()
    ...
    def get(self, params={}, locale=None):
        locale = locale or self.english
        return self.client.get(
            reverse("shataillocales:delete", args=[locale.id]), params
        )

    def post(self, post_data={}, locale=None):
        locale = locale or self.english
        return self.client.post(
            reverse("shataillocales:delete", args=[locale.id]), post_data
        )
