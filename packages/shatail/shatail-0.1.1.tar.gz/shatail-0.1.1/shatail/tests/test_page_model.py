...
class TestValidation(TestCase):
    ...
    @override_settings(SHATAIL_ALLOW_UNICODE_SLUGS=True)
    ...
    @override_settings(SHATAIL_ALLOW_UNICODE_SLUGS=False)
...
class TestRouting(TestCase):
    ...
    @override_settings(ROOT_URLCONF="shatail.test.non_root_urls")
    ...
    @override_settings(ROOT_URLCONF="shatail.test.headless_urls")
    def test_urls_headless(self):
        default_site = Site.objects.get(is_default_site=True)
        homepage = Page.objects.get(url_path="/home/")

        # The page should not be routable because shatail_serve is not registered
...
class TestRoutingWithI18N(TestRouting):
    ...
    def test_urls_with_region_specific_translation_activated(self):
        ...
        # and the active locale is not in SHATAIL_CONTENT_LANGUAGES
    ...
    def test_urls_with_region_specific_translation_activated_thats_in_shatail_content_languages(
        self,
    ):
    ...
    def test_urls_with_language_not_in_shatail_content_languages(self):
        # If the active locale doesn't map to anything in SHATAIL_CONTENT_LANGUAGES,
...
class TestCopyPage(TestCase):
    ...
    def test_copy_page_does_not_copy_comments(self):
        ...
        christmas_event.shatail_admin_comments = [
        ...
        self.assertEqual(
            christmas_event.shatail_admin_comments.count(),
            1,
        ...
        self.assertFalse(
            new_christmas_event.shatail_admin_comments.exists(),
    ...
    def test_copy_page_copies_tags(self):
        ...
        tagged_page.tags.add("shatail", "bird")
    ...
    def test_copy_subclassed_page_copies_tags(self):
        ...
        sub_tagged_page.tags.add("shatail", "bird")
...
class TestUpdateAliases(TestCase):
    ...
    def test_update_aliases(self):
        ...
        self.assertTrue(
            PageLogEntry.objects.filter(page=alias, action="shatail.publish").exists()
        )
        self.assertTrue(
            PageLogEntry.objects.filter(
                page=alias_alias, action="shatail.publish"
            ).exists()
        )
...
class TestCopyForTranslation(TestCase):
    ...
    def test_copy_homepage(self):
        ...
        # Check log
        log_entry = PageLogEntry.objects.get(action="shatail.copy_for_translation")
    ...
    def test_copy_childpage(self):
        ...
        self.assertEqual(
            log_entry.message,
            "Copied for translation from Welcome to the Shatail test site! (English)",
        )
...
class TestSubpageTypeBusinessRules(TestCase, ShatailTestUtils):
...
class TestPageManager(TestCase):
    ...
    def test_custom_page_manager(self):
        ...
        Shatail should respect this. It is up to the developer to ensure their
    ...
    def test_abstract_base_page_manager(self):
        ...
        and Shatail should respect this. It is up to the developer to ensure
...
class TestUnpublish(TestCase):
    ...
    def test_unpublish_also_unpublishes_aliases(self):
        ...
        self.assertTrue(
            PageLogEntry.objects.filter(page=alias, action="shatail.unpublish").exists()
        )
        self.assertTrue(
            PageLogEntry.objects.filter(
                page=alias_alias, action="shatail.unpublish"
            ).exists()
        )
