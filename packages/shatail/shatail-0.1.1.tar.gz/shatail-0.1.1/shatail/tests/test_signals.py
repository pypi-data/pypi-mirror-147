...
from shatail.signals import page_slug_changed
from shatail.test.testapp.models import SimplePage
from shatail.test.utils import ShatailTestUtils


class TestPageSlugChangedSignal(TestCase, ShatailTestUtils):
    """
    Tests for the `shatail.signals.page_slug_changed` signal
    """
