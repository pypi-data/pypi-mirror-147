...
from shatail.models import Collection, Page, PageLogEntry, PageRevision
from shatail.signals import page_published, page_unpublished
from shatail.test.testapp.models import EventPage, SecretPage, SimplePage
...
class TestPurgeRevisionsCommand(TestCase):
    ...
    def test_revisions_in_moderation_not_purged(self):
        ...
        try:
            from shatail.models import Task, Workflow, WorkflowTask
...
class TestCreateLogEntriesFromRevisionsCommand(TestCase):
    ...
    def test_command_doesnt_crash_for_revisions_without_page_model(self):
        with mock.patch(
            "shatail.models.ContentType.model_class",
            return_value=None,
        ):
            management.call_command("create_log_entries_from_revisions")
