...
from shatail.permission_policies.collections import (
    CollectionMangementPermissionPolicy,
    CollectionOwnershipPermissionPolicy,
    CollectionPermissionPolicy,
)
from shatail.test.utils import ShatailTestUtils
from shatail.tests.test_permission_policies import PermissionPolicyTestUtils


class PermissionPolicyTestCase(PermissionPolicyTestUtils, TestCase, ShatailTestUtils):
    def setUp(self):
        # Permissions
...
class TestCollectionManagementPermission(
    PermissionPolicyTestUtils, TestCase, ShatailTestUtils
):
    def setUp(self):
