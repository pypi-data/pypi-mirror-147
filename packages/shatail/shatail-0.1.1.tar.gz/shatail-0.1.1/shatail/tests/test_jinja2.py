...
from shatail import __version__, blocks
...
class TestCoreGlobalsAndFilters(TestCase):
    ...
    def test_shatail_site(self):
        self.assertEqual(self.render("{{ shatail_site().hostname }}"), "localhost")

    def test_shatail_version(self):
        self.assertEqual(self.render("{{ shatail_version() }}"), __version__)
