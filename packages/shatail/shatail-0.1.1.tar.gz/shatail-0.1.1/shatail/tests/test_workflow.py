...
class TestWorkflows(TestCase):
    ...
    @override_settings(SHATAIL_WORKFLOW_CANCEL_ON_PUBLISH=True)
    ...
    @override_settings(SHATAIL_WORKFLOW_CANCEL_ON_PUBLISH=False)
    ...
    @override_settings(SHATAIL_WORKFLOW_REQUIRE_REAPPROVAL_ON_EDIT=True)
    ...
    @override_settings(SHATAIL_WORKFLOW_REQUIRE_REAPPROVAL_ON_EDIT=False)
