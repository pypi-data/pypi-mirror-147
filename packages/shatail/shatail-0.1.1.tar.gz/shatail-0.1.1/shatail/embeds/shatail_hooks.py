...
from shatail.embeds import urls
from shatail.embeds.rich_text import MediaEmbedHandler
from shatail.embeds.rich_text.contentstate import ContentstateMediaConversionRule
from shatail.embeds.rich_text.editor_html import EditorHTMLEmbedConversionRule


@hooks.register("register_admin_urls")
def register_admin_urls():
    return [
        path("embeds/", include(urls, namespace="shatailembeds")),
    ]
...
def register_embed_feature(features):
    ...
    features.register_editor_plugin(
        ...
        draftail_features.EntityFeature(
            ...
            js=["shatailembeds/js/embed-chooser-modal.js"],
        ),
    )
