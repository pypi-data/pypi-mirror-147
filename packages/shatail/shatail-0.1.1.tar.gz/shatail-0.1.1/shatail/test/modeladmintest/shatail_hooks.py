...
from shatail.contrib.modeladmin.helpers import ShatailBackendSearchHandler
from shatail.contrib.modeladmin.options import (
    ModelAdmin,
    ModelAdminGroup,
    ThumbnailMixin,
    modeladmin_register,
)
from shatail.contrib.modeladmin.views import CreateView, EditView, IndexView
from shatail.models import Page
from shatail.test.testapp.models import BusinessChild, EventPage, SingleEventPage
...
class BookModelAdmin(ThumbnailMixin, ModelAdmin):
    ...
    search_handler_class = ShatailBackendSearchHandler
