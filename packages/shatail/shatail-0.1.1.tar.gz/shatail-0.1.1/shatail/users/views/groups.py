...
from shatail.admin.ui.tables import TitleColumn
from shatail.admin.views import generic, mixins
from shatail.admin.viewsets.model import ModelViewSet
from shatail.users.forms import GroupForm, GroupPagePermissionFormSet
from shatail.users.views.users import index
...
class IndexView(mixins.SearchableListMixin, generic.IndexView):
    ...
    columns = [
        TitleColumn(
            ...
            label=_("Name"),
            sort_key="name",
            url_name="shatailusers_groups:edit",
        ),
    ]

    def get_template_names(self):
        if self.request.headers.get("x-requested-with") == "XMLHttpRequest":
            return ["shatailusers/groups/results.html"]
        else:
            return ["shatailusers/groups/index.html"]


class CreateView(PermissionPanelFormsMixin, generic.CreateView):
    page_title = _("Add group")
    success_message = _("Group '{0}' created.")
    template_name = "shatailusers/groups/create.html"
...
class EditView(PermissionPanelFormsMixin, generic.EditView):
    ...
    template_name = "shatailusers/groups/edit.html"
...
class DeleteView(generic.DeleteView):
    ...
    template_name = "shatailusers/groups/confirm_delete.html"
