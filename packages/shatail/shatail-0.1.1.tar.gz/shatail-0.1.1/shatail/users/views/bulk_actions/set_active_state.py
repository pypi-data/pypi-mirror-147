...
from shatail.users.views.bulk_actions.user_bulk_action import UserBulkAction
from shatail.users.views.users import change_user_perm
...
class SetActiveStateBulkAction(UserBulkAction):
    ...
    template_name = "shatailusers/bulk_actions/confirm_bulk_set_active_state.html"
    action_priority = 20
