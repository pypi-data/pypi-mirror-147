...
from shatail.search import models
from shatail.search.utils import normalise_query_string
...
def chooser(request, get_results=False):
    ...
    if get_results:
        return TemplateResponse(
            request,
            "shatailsearch/queries/chooser/results.html",
            {
                "queries": queries,
            },
        )
        ...
        return render_modal_workflow(
            request,
            "shatailsearch/queries/chooser/chooser.html",
            None,
            {
                "queries": queries,
                "searchform": searchform,
