...
from shatail.search.signal_handlers import register_signal_handlers

from . import checks  # NOQA


class ShatailSearchAppConfig(AppConfig):
    name = "shatail.search"
    label = "shatailsearch"
    verbose_name = _("Shatail search")
    ...
    def ready(self):
        ...
        if connection.vendor == "postgresql":
            ...
            from shatail.search.backends.database.postgres.weights import set_weights
            ...
            if sqlite3.sqlite_version_info < (3, 19, 0):
                return [
                    Warning(
                        ...
                        id="shatailsearch.W002",
                        obj=ShatailSearchAppConfig,
                    )
                ]
