...
from shatail.search.index import (
    AutocompleteField,
    FilterField,
    Indexed,
    RelatedFields,
...
from shatail.utils.utils import deep_update
...
def get_model_root(model):
    ...
    Examples:
    >>> get_model_root(shatailcore.Page)
    shatailcore.Page

    >>> get_model_root(myapp.HomePage)
    shatailcore.Page

    >>> get_model_root(shatailimages.Image)
    shatailimages.Image
    """
...
class Elasticsearch5Mapping:
    ...
    def get_all_content_types(self):
        ...
        For example: ["myapp.MyPageModel", "shatailcore.Page"]
                     ["myapp.MyModel"]
        """
...
class Elasticsearch5Index:
    ...
    def add_model(self, model):
        ...
        self.es.indices.put_mapping(
            ...
            # see https://github.com/shatail/shatail/issues/2968
            index=self.name,
...
class Elasticsearch5SearchBackend(BaseSearchBackend):
    ...
    def __init__(self, params):
        ...
        self.index_name = params.pop("INDEX", "shatail")
