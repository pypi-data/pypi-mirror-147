...
from shatail.search.query import And, MatchAll, Not, Or, Phrase, PlainText, SearchQuery
...
class BM25(Func):
    ...
    def as_sql(
        ...
        sql, params = "bm25(shatailsearch_indexentry_fts)", []
        return sql, params
...
class MatchExpression(Expression):
    filterable = True
    template = (
        "shatailsearch_indexentry_fts MATCH %s"  # TODO: Can the table name be inferred?
    )
