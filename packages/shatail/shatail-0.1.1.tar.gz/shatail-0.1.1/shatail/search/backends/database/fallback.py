...
from shatail.search.backends.base import (
    BaseSearchBackend,
    BaseSearchQueryCompiler,
    BaseSearchResults,
    FilterFieldError,
)
from shatail.search.query import And, Boost, MatchAll, Not, Or, Phrase, PlainText
from shatail.search.utils import AND, OR
...
# * 'shatail.search.backends.database.fallback' is specified directly as the search backend
...
# This line allows using 'shatail.search.backends.database.fallback' as the backend, bypassing the automatic selection of the backend that would get run if the user chose 'shatail.search.backends.database'
