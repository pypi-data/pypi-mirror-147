...
class MatchExpression(Expression):
    ...
    def __init__(
        ...
        self.columns = columns or [
            "title",
            "body",
        ]  # We need to provide a default list of columns if the user doesn't specify one. We have a joint index for for 'title' and 'body' (see shatail.search.migrations.0006_customise_indexentry), so we'll pick that one.
