...
from shatail.search.query import Not, PlainText
from shatail.search.tests.test_backends import BackendTests
...
@override_settings(
    SHATAILSEARCH_BACKENDS={
        "default": {
            "BACKEND": "shatail.search.backends.database.mysql.mysql",
        }
    }
)
class TestMySQLSearchBackend(BackendTests, TransactionTestCase):
    backend_path = "shatail.search.backends.database.mysql.mysql"
