...
from shatail.search.query import And, Or, Phrase, PlainText
...
class TestQueryChooserView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        ...
        self.assertTemplateUsed(response, "shatailsearch/queries/chooser/chooser.html")
