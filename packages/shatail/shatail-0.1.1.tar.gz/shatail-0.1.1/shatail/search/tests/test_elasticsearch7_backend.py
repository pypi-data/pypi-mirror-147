...
from shatail.search.backends.elasticsearch7 import Elasticsearch7SearchBackend
from shatail.search.query import MATCH_ALL, Phrase
...
class TestElasticsearch7SearchBackend(ElasticsearchCommonSearchBackendTests, TestCase):
    backend_path = "shatail.search.backends.elasticsearch7"
...
class TestElasticsearch7SearchResults(TestCase):
    ...
    def test_basic_search(self, search):
        ...
        search.assert_any_call(
            ...
            _source=False,
            stored_fields="pk",
            index="shatail__searchtests_book",
            scroll="2m",
            size=100,
        )
...
@mock.patch("shatail.search.backends.elasticsearch5.Elasticsearch")
