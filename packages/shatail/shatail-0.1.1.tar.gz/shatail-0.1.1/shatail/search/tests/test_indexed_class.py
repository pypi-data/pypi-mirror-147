...
from shatail.test.testapp.models import EventPage, SingleEventPage
...
class TestSearchFields(TestCase):
    ...
    def test_checking_core_page_fields_are_indexed(self):
        ...
        errors = [
            error for error in checks.run_checks() if error.id == "shatailsearch.W001"
        ]
        ...
        with patch_search_fields(
            ...
            errors = [
                ...
                if error.id == "shatailsearch.W001"
            ]
