...
try:
    # If a preference has been explicitly stated in the SHATAILADMIN_STATIC_FILE_VERSION_STRINGS
    # setting, use that
    use_version_strings = settings.SHATAILADMIN_STATIC_FILE_VERSION_STRINGS
except AttributeError:
    # If SHATAILADMIN_STATIC_FILE_VERSION_STRINGS not specified, default to version strings
