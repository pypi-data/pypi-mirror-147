...
from shatail.utils.widgets import WidgetWithScript
...
class AdminPageChooser(AdminChooser):
    ...
    def get_value_data(self, value):
        ...
        return {
            ...
            "edit_url": reverse("shatailadmin_pages:edit", args=[page.pk]),
        }
    ...
    def render_html(self, name, value_data, attrs):
        ...
        return render_to_string(
            "shatailadmin/widgets/page_chooser.html",
            {
                "widget": self,
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailadmin/js/page-chooser-modal.js"),
                versioned_static("shatailadmin/js/page-chooser.js"),
            ]
        )


class PageChooserAdapter(WidgetAdapter):
    js_constructor = "shatail.widgets.PageChooser"
