...
from shatail.models import Task
...
class AdminTaskChooser(AdminChooser):
    ...
    def render_html(self, name, value, attrs):
        ...
        return render_to_string(
            "shatailadmin/workflows/widgets/task_chooser.html",
            {
                "widget": self,
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailadmin/js/task-chooser-modal.js"),
                versioned_static("shatailadmin/js/task-chooser.js"),
            ]
        )
