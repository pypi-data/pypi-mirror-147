...
from shatail.hooks import search_for_hooks
from shatail.utils.registry import ObjectTypeRegistry
...
Handlers for new models can be registered via register_admin_url_finder:
    ...
    class SprocketAdminURLFinder(ModelAdminURLFinder):
        edit_url_name = 'shatailsprockets:edit'
...
class AdminURLFinder:
    ...
    def __init__(self, user=None):
        search_for_hooks()  # ensure shatail_hooks files have been loaded
        self.user = user
