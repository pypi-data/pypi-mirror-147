...
from shatail.admin.ui.tables import Table, TitleColumn
from shatail.log_actions import log

from .base import ShatailAdminTemplateMixin
...
class IndexView(PermissionCheckedMixin, ShatailAdminTemplateMixin, BaseListView):
    model = None
    index_url_name = None
    add_url_name = None
    edit_url_name = None
...
class CreateView(PermissionCheckedMixin, ShatailAdminTemplateMixin, BaseCreateView):
    model = None
    form_class = None
    index_url_name = None
    add_url_name = None
    edit_url_name = None
    template_name = "shatailadmin/generic/create.html"
    ...
    def form_valid(self, form):
        ...
        with transaction.atomic():
            ...
            log(instance=self.object, action="shatail.create")
...
class EditView(PermissionCheckedMixin, ShatailAdminTemplateMixin, BaseUpdateView):
    model = None
    form_class = None
    index_url_name = None
    edit_url_name = None
    ...
    context_object_name = None
    template_name = "shatailadmin/generic/edit.html"
    ...
    def form_valid(self, form):
        ...
        with transaction.atomic():
            self.object = self.save_instance()
            log(instance=self.object, action="shatail.edit")
...
class DeleteView(PermissionCheckedMixin, ShatailAdminTemplateMixin, BaseDeleteView):
    model = None
    index_url_name = None
    delete_url_name = None
    template_name = "shatailadmin/generic/confirm_delete.html"
    context_object_name = None
    ...
    def delete_action(self):
        with transaction.atomic():
            log(instance=self.object, action="shatail.delete")
            self.object.delete()
