...
from shatail.actions.convert_alias import ConvertAliasPageAction
...
def convert_alias(request, page_id):
    ...
    with transaction.atomic():
        ...
        if request.method == "POST":
            ...
            return redirect("shatailadmin_pages:edit", page.id)

    return TemplateResponse(
        request,
        "shatailadmin/pages/confirm_convert_alias.html",
        {
            "page": page,
            "next": next_url,
        },
