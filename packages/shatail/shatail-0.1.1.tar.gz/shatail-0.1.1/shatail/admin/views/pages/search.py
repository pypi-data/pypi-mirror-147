...
from shatail.search.query import MATCH_ALL
from shatail.search.utils import parse_query_string
...
def search(request):
    ...
    if request.headers.get("x-requested-with") == "XMLHttpRequest":
        return TemplateResponse(
            request,
            "shatailadmin/pages/search_results.html",
            {
                "pages": pages,
                "all_pages": all_pages,
                "query_string": q,
        ...
        return TemplateResponse(
            request,
            "shatailadmin/pages/search.html",
            {
                "search_form": form,
                "pages": pages,
                "all_pages": all_pages,
