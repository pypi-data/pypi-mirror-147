...
def index(request, parent_page_id=None):
    ...
    if not (parent_page.pk == root_page.pk or parent_page.is_descendant_of(root_page)):
        return redirect("shatailadmin_explore", root_page.pk)
                    ...
                    "translations": [
                        {
                            ...
                            "url": reverse(
                                "shatailadmin_explore", args=[translation.id]
                            ),
                        }
    ...
    return TemplateResponse(request, "shatailadmin/pages/index.html", context)
