...
class DateRangePickerWidget(SuffixedMultiWidget):
    ...
    template_name = "shatailadmin/widgets/daterange_input.html"
...
class ShatailFilterSet(django_filters.FilterSet):
    @classmethod
...
class ContentTypeModelChoiceField(django_filters.fields.ModelChoiceField):
    ...
    than the default 'shatailcore | page' representation of a ContentType
    """
