...
from shatail.telepath import Adapter, adapter
...
class BaseSidebarAdapter(Adapter):
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailadmin/js/sidebar.js"),
            ]
        )
...
@adapter("shatail.sidebar.LinkMenuItem", base=BaseSidebarAdapter)
...
@adapter("shatail.sidebar.SubMenuItem", base=BaseSidebarAdapter)
...
@adapter("shatail.sidebar.PageExplorerMenuItem", base=BaseSidebarAdapter)
...
@adapter("shatail.sidebar.ShatailBrandingModule", base=BaseSidebarAdapter)
class ShatailBrandingModule:
    def js_args(self):
        return [
            reverse("shatailadmin_home"),
        ]


@adapter("shatail.sidebar.SearchModule", base=BaseSidebarAdapter)
class SearchModule:
...
@adapter("shatail.sidebar.MainMenuModule", base=BaseSidebarAdapter)
class MainMenuModule:
    ...
    def js_args(self):
        from shatail.admin.templatetags.shatailadmin_tags import avatar_url
