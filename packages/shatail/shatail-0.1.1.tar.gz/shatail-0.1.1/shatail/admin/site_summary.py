...
class PagesSummaryItem(SummaryItem):
    order = 100
    template_name = "shatailadmin/home/site_summary_pages.html"
    ...
    def get_context_data(self, parent_context):
        ...
        if root_page:
            ...
            if root_page.is_root():
                # If the root page the user has access to is the Shatail root,
...
class SiteSummaryPanel(Component):
    name = "site_summary"
    template_name = "shatailadmin/home/site_summary.html"
    order = 100
