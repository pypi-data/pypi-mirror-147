...
from shatail.models import Page, PageViewRestriction
from shatail.test.testapp.models import SimplePage
from shatail.test.utils import ShatailTestUtils


class TestSetPrivacyView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_get_public(self):
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:set_privacy", args=(self.public_page.id,))
        )

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/page_privacy/set_privacy.html")
    ...
    def test_get_private(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_pages:set_privacy", args=(self.private_page.id,))
        )
    ...
    def test_get_private_child(self):
        ...
        response = self.client.get(
            reverse(
                "shatailadmin_pages:set_privacy", args=(self.private_child_page.id,)
            )
        )
        ...
        self.assertTemplateUsed(
            response, "shatailadmin/page_privacy/ancestor_privacy.html"
        )
        self.assertEqual(
    ...
    def test_get_private_groups(self):
        ...
        response = self.client.get(
            reverse(
                "shatailadmin_pages:set_privacy", args=(self.private_groups_page.id,)
            )
        )
...
class TestPrivacyIndicators(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_explorer_public(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_explore", args=(self.public_page.id,))
        )
        ...
        self.assertTemplateUsed(response, "shatailadmin/pages/_privacy_switch.html")
    ...
    def test_explorer_private(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_explore", args=(self.private_page.id,))
        )
    ...
    def test_explorer_private_child(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_explore", args=(self.private_child_page.id,))
        )
    ...
    def test_explorer_list_homepage(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_explore", args=(self.homepage.id,))
        )
    ...
    def test_edit_public(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.public_page.id,))
        )
        ...
        # Check the privacy indicator is public
        self.assertTemplateUsed(
            response, "shatailadmin/pages/privacy_switch_panel.html"
        )
        self.assertContains(response, '<div class="privacy-indicator public">')
        self.assertNotContains(response, '<div class="privacy-indicator private">')
    ...
    def test_edit_private(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.private_page.id,))
        )
    ...
    def test_edit_private_child(self):
        ...
        """
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.private_child_page.id,))
        )
