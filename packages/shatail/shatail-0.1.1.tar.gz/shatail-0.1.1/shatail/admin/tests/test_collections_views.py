...
from shatail.models import Collection, GroupCollectionPermission
...
class TestCollectionsIndexViewAsSuperuser(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shatailadmin_collections:index"), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/collections/index.html")
...
class TestCollectionsIndexView(CollectionInstanceTestUtils, TestCase, ShatailTestUtils):
    def setUp(self):
        super().setUp()
...
class TestAddCollectionAsSuperuser(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.root_collection = Collection.get_first_root_node()

    def get(self, params={}):
        return self.client.get(reverse("shatailadmin_collections:add"), params)

    def post(self, post_data={}):
        return self.client.post(reverse("shatailadmin_collections:add"), post_data)
    ...
    def test_post(self):
        ...
        self.assertRedirects(response, reverse("shatailadmin_collections:index"))
...
class TestAddCollection(CollectionInstanceTestUtils, TestCase, ShatailTestUtils):
    def setUp(self):
        super().setUp()
        self.login(self.marketing_user, password="password")
...
class TestEditCollectionAsSuperuser(TestCase, ShatailTestUtils):
    def setUp(self):
...
class TestEditCollection(CollectionInstanceTestUtils, TestCase, ShatailTestUtils):
    def setUp(self):
        super().setUp()
    ...
    def get(self, collection_id, params={}):
        return self.client.get(
            reverse("shatailadmin_collections:edit", args=(collection_id,)), params
        )

    def post(self, collection_id, post_data={}):
        return self.client.post(
            reverse("shatailadmin_collections:edit", args=(collection_id,)), post_data
        )
...
class TestDeleteCollectionAsSuperuser(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.root_collection = Collection.get_first_root_node()
        self.collection = self.root_collection.add_child(name="Holiday snaps")
    ...
    def get(self, params={}, collection_id=None):
        return self.client.get(
            reverse(
                "shatailadmin_collections:delete",
                args=(collection_id or self.collection.id,),
            ),
            params,
        )
    ...
    def test_get(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/generic/confirm_delete.html")
    ...
    def test_get_nonempty_collection(self):
        ...
        self.assertTemplateUsed(
            response, "shatailadmin/collections/delete_not_empty.html"
        )
...
class TestDeleteCollection(CollectionInstanceTestUtils, TestCase, ShatailTestUtils):
    def setUp(self):
        super().setUp()
    ...
    def get(self, collection_id, params={}):
        return self.client.get(
            reverse("shatailadmin_collections:delete", args=(collection_id,)), params
        )

    def post(self, collection_id, post_data={}):
        return self.client.post(
            reverse("shatailadmin_collections:delete", args=(collection_id,)), post_data
        )
