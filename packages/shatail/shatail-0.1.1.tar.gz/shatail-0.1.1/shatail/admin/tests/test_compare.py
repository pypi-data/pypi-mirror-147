...
from shatail.blocks import StreamValue
...
class TestStreamFieldComparison(TestCase):
    ...
    def test_htmldiff_richtext_strips_tags_on_change(self):
        ...
        comparison = self.comparison_class(
            ...
            StreamPage(
                body=StreamValue(
                    field.stream_block,
                    [
                        ("rich_text", "I <b>really</b> like Shatail &lt;3", "1"),
                    ],
                )
            ),
            StreamPage(
        ...
        self.assertEqual(
            comparison.htmldiff(),
            '<div class="comparison__child-object">I really like <span class="deletion">Shatail &lt;3</span><span class="addition">evil code &gt;_&lt; doSomethingBad();</span></div>',
        )
        self.assertIsInstance(comparison.htmldiff(), SafeString)
...
class TestTagsFieldComparison(TestCase):
    ...
    def test_hasnt_changed(self):
        ...
        self.assertEqual(comparison.htmldiff(), "shatail, bird")
        self.assertIsInstance(comparison.htmldiff(), SafeString)
        self.assertFalse(comparison.has_changed())
    ...
    def test_has_changed(self):
        ...
        self.assertEqual(
            comparison.htmldiff(),
            'shatail, <span class="deletion">bird</span>, <span class="addition">motacilla</span>',
        )
        self.assertIsInstance(comparison.htmldiff(), SafeString)
        self.assertTrue(comparison.has_changed())
