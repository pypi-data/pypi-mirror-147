...
class TestLocking(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
    ...
    def test_lock_post(self):
        response = self.client.post(
            reverse("shatailadmin_pages:lock", args=(self.child_page.id,))
        )
    ...
    def test_lock_post_with_good_redirect(self):
        response = self.client.post(
            reverse("shatailadmin_pages:lock", args=(self.child_page.id,)),
            {"next": reverse("shatailadmin_pages:edit", args=(self.child_page.id,))},
        )
    ...
    def test_lock_post_bad_page(self):
        response = self.client.post(reverse("shatailadmin_pages:lock", args=(9999,)))
    ...
    def test_unlock_post(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:unlock", args=(self.child_page.id,))
        )
    ...
    def test_unlock_post_bad_page(self):
        ...
        response = self.client.post(reverse("shatailadmin_pages:unlock", args=(9999,)))
