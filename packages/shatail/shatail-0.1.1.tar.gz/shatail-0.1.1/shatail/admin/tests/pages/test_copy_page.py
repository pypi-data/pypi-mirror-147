...
class TestPageCopy(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
    ...
    def test_page_copy(self):
        response = self.client.get(
            reverse("shatailadmin_pages:copy", args=(self.test_page.id,))
        )

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/pages/copy.html")
    ...
    def test_page_copy_bad_permissions(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:copy", args=(self.test_page.id,)), post_data
        )
    ...
    def test_page_with_exclude_fields_in_copy(self):
        ...
        self.client.post(
            reverse("shatailadmin_pages:copy", args=(original_page.id,)), post_data
        )
        # Get copy
    ...
    def test_page_copy_post_new_parent(self):
        ...
        self.assertRedirects(
            response, reverse("shatailadmin_explore", args=(self.test_child_page.id,))
        )
    ...
    def test_page_copy_post_existing_slug_within_same_parent_page(self):
        ...
        self.assertFormError(
            ...
            "form",
            "new_slug",
            'This slug is already in use within the context of its parent page "Welcome to your new Shatail site!"',
        )
    ...
    def test_page_copy_post_valid_unicode_slug(self):
        ...
        # Check response
        self.assertRedirects(
            response, reverse("shatailadmin_explore", args=(self.test_page.id,))
        )
    ...
    def test_page_copy_alias_post_without_source_publish_permission(self):
        ...
        # Shatail would crash on attempt to copy
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:copy", args=[self.test_child_page.id]),
            post_data,
        )
    ...
    def test_copy_page_with_unique_uuids_in_orderables(self):
        ...
        self.client.post(
            reverse("shatailadmin_pages:copy", args=[event_page.id]), post_data
        )
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=[new_page.id])
        )
