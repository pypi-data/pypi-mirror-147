...
from shatail.admin.views.pages.bulk_actions.page_bulk_action import PageBulkAction
...
class TestBulkUnpublish(TestCase, ShatailTestUtils):
    def setUp(self):
        ...
        self.redirect_url = reverse("shatailadmin_explore", args=(self.root_page.id,))
    ...
    def test_unpublish_view(self):
        ...
        self.assertTemplateUsed(
            response, "shatailadmin/pages/bulk_actions/confirm_bulk_unpublish.html"
        )
...
class TestBulkUnpublishIncludingDescendants(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
        self.root_page = Page.objects.get(id=2)
