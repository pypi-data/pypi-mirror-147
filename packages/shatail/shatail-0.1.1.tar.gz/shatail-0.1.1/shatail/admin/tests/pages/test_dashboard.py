...
from shatail.admin.views.home import RecentEditsPanel
...
class TestRecentEditsPanel(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
...
class TestRecentEditsQueryCount(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
