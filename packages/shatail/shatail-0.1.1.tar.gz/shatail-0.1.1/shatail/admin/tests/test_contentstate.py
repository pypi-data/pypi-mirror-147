...
from shatail.admin.rich_text.converters.contentstate import (
...
class TestHtmlToContentState(TestCase):
    ...
    def test_external_link(self):
        ...
        result = json.loads(
            converter.from_database_format(
                """
            <p>an <a href="http://shatail.org">external</a> link</p>
            """
            )
        )
        self.assertContentStateEqual(
    ...
    def test_link_in_bare_text(self):
        ...
        result = json.loads(
            converter.from_database_format(
                """an <a href="http://shatail.org">external</a> link"""
            )
        )
        self.assertContentStateEqual(
            result,
    ...
    def test_link_at_start_of_bare_text(self):
        ...
        result = json.loads(
            converter.from_database_format(
                """<a href="http://shatail.org">an external link</a> and <a href="http://torchbox.com">another</a>"""
            )
        )
        self.assertContentStateEqual(
            result,
    ...
    def test_image_inside_style(self):
        # https://github.com/shatail/shatail/issues/4602 - ensure that an <embed> inside
    ...
    def test_image_inside_link(self):
        ...
        result = json.loads(
            converter.from_database_format(
                """
            <p><a href="https://shatail.org">before <embed embedtype="image" alt="an image" id="1" format="left" /> after</a></p>
            <p><a href="https://shatail.org"><embed embedtype="image" alt="an image" id="1" format="left" /></a></p>
            """
            )
        )
        self.assertContentStateEqual(
...
class TestContentStateToHtml(TestCase):
    def test_external_link(self):
        ...
        self.assertEqual(
            result,
            '<p data-block-key="00000">an <a href="http://shatail.org">external</a> link</p>',
        )
