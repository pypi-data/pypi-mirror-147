...
from shatail.test.benchmark import Benchmark
from shatail.test.testapp.models import SingleEventPage, StreamPage
from shatail.test.utils import ShatailTestUtils


class BenchPageExplorerWith50LargePages(Benchmark, ShatailTestUtils, TestCase):
    """
...
class BenchPageExplorerWithCustomURLPages(Benchmark, ShatailTestUtils, TestCase):
    """
