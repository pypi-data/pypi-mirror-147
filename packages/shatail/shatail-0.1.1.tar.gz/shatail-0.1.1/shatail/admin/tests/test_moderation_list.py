...
class TestModerationList(TestCase, ShatailTestUtils):
    """Test moderation list rendered by `shatailadmin_home` view"""
    ...
    def setUp(self):
        ...
        self.page = SimplePage(
            title="Shatail, the powerful CMS for modern websites",
            slug="shatail",
        ...
        self.edit_page_url = reverse(
            "shatailadmin_pages:edit", args=(self.revision.page.id,)
        )
    ...
    def get(self):
        return self.client.get(reverse("shatailadmin_home"))
    ...
    def test_edit_page(self):
        ...
        self.assertTemplateUsed(response, "shatailadmin/home.html")
