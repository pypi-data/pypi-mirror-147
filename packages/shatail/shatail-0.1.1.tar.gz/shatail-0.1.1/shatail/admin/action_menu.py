...
class ActionMenuItem(Component):
    ...
    template_name = "shatailadmin/pages/action_menu/menu_item.html"
...
class PublishMenuItem(ActionMenuItem):
    label = _("Publish")
    name = "action-publish"
    template_name = "shatailadmin/pages/action_menu/publish.html"
    icon_name = "upload"
...
class SubmitForModerationMenuItem(ActionMenuItem):
    ...
    def is_shown(self, context):
        if not getattr(settings, "SHATAIL_MODERATION_ENABLED", True):
            return False
...
class WorkflowMenuItem(ActionMenuItem):
    template_name = "shatailadmin/pages/action_menu/workflow_menu_item.html"
...
class UnpublishMenuItem(ActionMenuItem):
    ...
    def get_url(self, context):
        return reverse("shatailadmin_pages:unpublish", args=(context["page"].id,))
...
class DeleteMenuItem(ActionMenuItem):
    ...
    def get_url(self, context):
        return reverse("shatailadmin_pages:delete", args=(context["page"].id,))


class SaveDraftMenuItem(ActionMenuItem):
    name = "action-save-draft"
    label = _("Save Draft")
    template_name = "shatailadmin/pages/action_menu/save_draft.html"
...
class PageLockedMenuItem(ActionMenuItem):
    ...
    label = _("Page locked")
    template_name = "shatailadmin/pages/action_menu/page_locked.html"
...
class PageActionMenu:
    template = "shatailadmin/pages/action_menu/menu.html"
                ...
                for name, label, launch_modal in actions:
                    ...
                    if name == "approve":
                        if is_final_task and not getattr(
                            settings,
                            "SHATAIL_WORKFLOW_REQUIRE_REAPPROVAL_ON_EDIT",
                            False,
                        ):
