...
from shatail.utils.registry import ModelFieldRegistry
...
def register_form_field_override(
    ...
    """
    Define parameters for form fields to be used by ShatailAdminModelForm for a given
    database field.
    """
...
class ShatailAdminModelFormOptions(PermissionedFormOptionsMixin, ClusterFormOptions):
...
class ShatailAdminModelFormMetaclass(PermissionedFormMetaclass, ClusterFormMetaclass):
    options_class = ShatailAdminModelFormOptions
    ...
    def __new__(cls, name, bases, attrs):
        ...
        new_class = super(ShatailAdminModelFormMetaclass, cls).__new__(
    ...
    @classmethod
    def child_form(cls):
        return ShatailAdminModelForm


class ShatailAdminModelForm(
    PermissionedForm, ClusterForm, metaclass=ShatailAdminModelFormMetaclass
):
...
# Now, any model forms built off ShatailAdminModelForm instead of ModelForm should pick up
