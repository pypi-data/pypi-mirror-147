...
class StatusSidePanel(BaseSidePanel):
    ...
    template_name = "shatailadmin/pages/side_panels/status.html"
    order = 100
    ...
    def get_context_data(self, parent_context):
        ...
        if self.page.id:
            context.update(
                {
                    "lock_url": reverse(
                        "shatailadmin_pages:lock", args=(self.page.id,)
                    ),
                    "unlock_url": reverse(
                        "shatailadmin_pages:unlock", args=(self.page.id,)
                    ),
...
class CommentsSidePanel(BaseSidePanel):
    ...
    template_name = "shatailadmin/pages/side_panels/comments.html"
    order = 300
...
class PreviewSidePanel(BaseSidePanel):
    ...
    template_name = "shatailadmin/pages/side_panels/preview.html"
    order = 400
