...
from shatail.contrib.table_block.blocks import DEFAULT_TABLE_OPTIONS, TableBlock
from shatail.models import Page
from shatail.test.testapp.models import TableBlockStreamPage
...
class TestTableBlockForm(ShatailTestUtils, SimpleTestCase):
    def setUp(self):
...
class TestTableBlockPageEdit(TestCase, ShatailTestUtils):
    def setUp(self):
        self.value = {
            "first_row_is_table_header": True,
            "first_col_is_header": True,
    ...
    def test_page_edit_page_view(self):
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.table_block_page.id,))
        )
