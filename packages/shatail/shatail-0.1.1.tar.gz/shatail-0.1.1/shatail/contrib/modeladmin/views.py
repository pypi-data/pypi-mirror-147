...
from shatail.admin.ui.tables import Column, DateColumn, Table, UserColumn
from shatail.admin.views.generic.base import ShatailAdminTemplateMixin
from shatail.admin.views.mixins import SpreadsheetExportMixin
...
class CreateView(ModelFormView):
    ...
    def form_valid(self, form):
        ...
        log(instance=self.instance, action="shatail.create")
        return response
...
class EditView(ModelFormView, InstanceSpecificView):
    ...
    def form_valid(self, form):
        response = super().form_valid(form)
        log(instance=self.instance, action="shatail.edit")
        return response
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            with transaction.atomic():
                log(instance=self.instance, action="shatail.delete")
...
class InspectView(InstanceSpecificView):
    ...
    def get_field_display_value(self, field_name, field=None):
        ...
        # shatail.images might not be installed
        try:
            from shatail.images.models import AbstractImage
        ...
        # shatail.shataildocuments might not be installed
        try:
            from shatail.documents.models import AbstractDocument
    ...
    def get_image_field_display(self, field_name, field):
        """Render an image"""
        from shatail.images.shortcuts import get_rendition_or_not_found
...
class HistoryView(MultipleObjectMixin, ShatailAdminTemplateMixin, InstanceSpecificView):
