...
from shatail.coreutils import safe_snake_case
from shatail.models import UserPagePermissionsProxy, get_page_models
...
def get_form_types():
    ...
    if _FORM_CONTENT_TYPES is None:
        from shatail.contrib.forms.models import AbstractForm
