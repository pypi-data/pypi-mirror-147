...
from shatail import __version__
...
class HTTPBackend(BaseBackend):
    ...
    def purge(self, url):
        ...
        request = PurgeRequest(
            ...
            headers={
                "Host": host,
                "User-Agent": "Shatail-frontendcache/" + __version__,
            },
        )
    ...
    def __init__(self, params):
        ...
        if (
            ...
            raise ImproperlyConfigured(
                "The setting 'SHATAILFRONTENDCACHE' requires both 'EMAIL' and 'API_KEY', or 'BEARER_TOKEN' to be specified."
            )
...
class CloudfrontBackend(BaseBackend):
    def __init__(self, params):
        ...
        try:
            ...
            raise ImproperlyConfigured(
                "The setting 'SHATAILFRONTENDCACHE' requires the object 'DISTRIBUTION_ID'."
            )
...
class AzureBaseBackend(BaseBackend):
    def __init__(self, params):
        ...
        try:
            ...
            raise ImproperlyConfigured(
                "The setting 'SHATAILFRONTENDCACHE' requires 'RESOURCE_GROUP_NAME' to be specified."
            )
...
class AzureFrontDoorBackend(AzureBaseBackend):
    def __init__(self, params):
        ...
        try:
            ...
            raise ImproperlyConfigured(
                "The setting 'SHATAILFRONTENDCACHE' requires 'FRONT_DOOR_NAME' to be specified."
            )
...
class AzureCdnBackend(AzureBaseBackend):
    def __init__(self, params):
        ...
        try:
            ...
            raise ImproperlyConfigured(
                "The setting 'SHATAILFRONTENDCACHE' requires 'CDN_PROFILE_NAME' and 'CDN_ENDPOINT_NAME' to be specified."
            )
