...
from shatail.contrib.redirects.models import Redirect
...
class TestImportAdminViews(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shatailredirects:start_import"), params)

    def post(self, post_data={}, follow=False):
        return self.client.post(
            reverse("shatailredirects:start_import"), post_data, follow=follow
        )

    def post_import(self, post_data={}, follow=False):
        return self.client.post(
            reverse("shatailredirects:process_import"), post_data, follow=follow
        )
    ...
    def test_import_step(self):
        ...
        with open(f, "rb") as infile:
            ...
            self.assertTemplateUsed(
                import_response, "shatailredirects/import_summary.html"
            )
    ...
    def test_import_xls(self):
        ...
        with open(f, "rb") as infile:
            ...
            self.assertTemplateUsed(response, "shatailredirects/confirm_import.html")
            ...
            self.assertTemplateUsed(import_response, "shatailredirects/index.html")
    ...
    def test_not_valid_method_for_import_file(self):
        response = self.client.get(reverse("shatailredirects:process_import"))
    ...
    @override_settings(SHATAIL_REDIRECTS_FILE_STORAGE="cache")
    ...
    def test_process_validation_works_when_using_plaintext_files_and_cache(self):
        ...
        with open(f, "rb") as infile:
            ...
            self.assertTemplateUsed(
                import_response, "shatailredirects/confirm_import.html"
            )
