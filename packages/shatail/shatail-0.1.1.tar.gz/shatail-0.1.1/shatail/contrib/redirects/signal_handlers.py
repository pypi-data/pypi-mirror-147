...
from shatail.coreutils import BatchCreator, get_dummy_request
...
def autocreate_redirects_on_slug_change(
    ...
    if not getattr(settings, "SHATAILREDIRECTS_AUTO_CREATE", True):
        return None
...
def _page_urls_for_sites(
    ...
    for site in sites:
        ...
        if hasattr(cache_target, "_shatail_cached_site_root_paths"):
            request._shatail_cached_site_root_paths = (
                cache_target._shatail_cached_site_root_paths
            )
