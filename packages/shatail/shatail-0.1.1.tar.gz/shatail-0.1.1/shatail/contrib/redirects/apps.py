...
class ShatailRedirectsAppConfig(AppConfig):
    name = "shatail.contrib.redirects"
    label = "shatailredirects"
    verbose_name = _("Shatail redirects")
    default_auto_field = "django.db.models.AutoField"

    def ready(self):
        from shatail.signals import page_slug_changed, post_page_move
