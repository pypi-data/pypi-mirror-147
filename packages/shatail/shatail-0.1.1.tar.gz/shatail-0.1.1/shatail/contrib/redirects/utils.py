...
from shatail.contrib.redirects.tmp_storages import CacheStorage, TempFolderStorage
...
def get_file_storage():
    file_storage = getattr(settings, "SHATAIL_REDIRECTS_FILE_STORAGE", "tmp_file")
...
class RedirectsCacheStorage(CacheStorage):
    CACHE_PREFIX = "shatail-redirects-"
