...
from shatail.blocks.base import Block, DeclarativeSubBlocksMetaclass, get_help_icon
...
class TypedTableBlockValidationErrorAdapter(Adapter):
    js_constructor = "shatail.contrib.typed_table_block.TypedTableBlockValidationError"
...
class BaseTypedTableBlock(Block):
    ...
    def deconstruct(self):
        ...
        """
        path = "shatail.contrib.typed_table_block.blocks.TypedTableBlock"
...
class TypedTableBlockAdapter(Adapter):
    js_constructor = "shatail.contrib.typed_table_block.blocks.TypedTableBlock"
