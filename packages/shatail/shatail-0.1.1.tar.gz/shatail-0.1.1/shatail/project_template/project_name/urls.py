...
urlpatterns = urlpatterns + [
    ...
    # Shatail's page serving mechanism. This should be the last pattern in
    # the list:
    path("", include(shatail_urls)),
    # Alternatively, if you want Shatail pages to be served from a subpath
    # of your site, rather than the site root:
    #    path("pages/", include(shatail_urls)),
]
