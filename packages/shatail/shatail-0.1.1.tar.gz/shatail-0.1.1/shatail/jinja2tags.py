...
from .templatetags.shatailcore_tags import (
    pageurl,
    richtext,
    slugurl,
    shatail_site,
...
class ShatailCoreExtension(Extension):
    tags = {"include_block"}
        ...
        self.environment.globals.update(
            {
                ...
                "shatail_site": jinja2.pass_context(shatail_site),
                "shatail_version": shatail_version,
            }
        )
