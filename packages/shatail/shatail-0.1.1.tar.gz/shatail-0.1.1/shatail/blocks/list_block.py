...
class ListBlockValidationErrorAdapter(Adapter):
    js_constructor = "shatail.blocks.ListBlockValidationError"
...
class ListBlock(Block):
    ...
    def _item_is_in_block_format(self, item):
        ...
        # the new format (https://github.com/shatail/rfcs/blob/main/text/065-listblock.md) for a list item
        return (
...
class ListBlockAdapter(Adapter):
    js_constructor = "shatail.blocks.ListBlock"
...
DECONSTRUCT_ALIASES = {
    ListBlock: "shatail.blocks.ListBlock",
}
