...
from shatail.models import Page as RealPage
...
def create_default_workflows(apps, schema_editor):
    ...
    Workflow = apps.get_model("shatailcore.Workflow")
    GroupApprovalTask = apps.get_model("shatailcore.GroupApprovalTask")
    GroupPagePermission = apps.get_model("shatailcore.GroupPagePermission")
    WorkflowPage = apps.get_model("shatailcore.WorkflowPage")
    WorkflowTask = apps.get_model("shatailcore.WorkflowTask")
    ...
    group_approval_content_type, __ = ContentType.objects.get_or_create(
        model="groupapprovaltask", app_label="shatailcore"
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("shatailcore", "0047_add_workflow_models"),
    ]
