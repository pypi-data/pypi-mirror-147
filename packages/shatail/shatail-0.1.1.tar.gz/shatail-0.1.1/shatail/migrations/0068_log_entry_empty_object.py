...
def replace_empty_string_with_empty_object(apps, schema_editor):
    ModelLogEntry = apps.get_model("shatailcore.ModelLogEntry")
    PageLogEntry = apps.get_model("shatailcore.PageLogEntry")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("shatailcore", "0067_alter_pagerevision_content_json"),
    ]
