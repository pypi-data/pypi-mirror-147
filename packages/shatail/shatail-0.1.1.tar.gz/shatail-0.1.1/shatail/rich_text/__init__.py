...
from shatail.rich_text.rewriters import EmbedRewriter, LinkRewriter, MultiRuleRewriter

features = FeatureRegistry()


# Rewriter function to be built up on first call to expand_db_html, using the utility classes
# from shatail.rich_text.rewriters along with the embed handlers / link handlers registered
...
class RichText:
    ...
    Used as the native value of a shatailcore.blocks.field_block.RichTextBlock.
    """
    ...
    def __html__(self):
        return render_to_string(
            "shatailcore/shared/richtext.html", {"html": expand_db_html(self.source)}
        )
...
class EntityHandler:
    ...
    Currently Shatail supports two kinds of entity: links (represented as <a linktype="...">...</a>)
