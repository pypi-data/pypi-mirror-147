...
class PageQuerySet(SearchableQuerySetMixin, TreeQuerySet):
    ...
    def public_q(self):
        from shatail.models import PageViewRestriction
    ...
    def first_common_ancestor(self, include_self=False, strict=False):
        ...
        are multiple page trees with no common root (a case Shatail does not
        ...
        if common_parent_path == "":
            ...
            # a situation that Shatail does not support;
    ...
    def annotate_approved_schedule(self):
        ...
        Used by `approved_schedule` property on `shatailcore.models.Page`.
        """
    ...
    def annotate_site_root_state(self):
        ...
        Used by `is_site_root` method on `shatailcore.models.Page`.
        """
        return self.annotate(
