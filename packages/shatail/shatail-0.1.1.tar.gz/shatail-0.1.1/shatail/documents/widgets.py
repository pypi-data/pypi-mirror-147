...
class AdminDocumentChooser(AdminChooser):
    ...
    def render_html(self, name, value_data, attrs):
        ...
        return render_to_string(
            "shataildocs/widgets/document_chooser.html",
            {
                "widget": self,
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shataildocs/js/document-chooser-modal.js"),
                versioned_static("shataildocs/js/document-chooser.js"),
            ]
        )


class DocumentChooserAdapter(WidgetAdapter):
    js_constructor = "shatail.documents.widgets.DocumentChooser"
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shataildocs/js/document-chooser-telepath.js"),
            ]
        )
