...
from shatail.admin.ui.tables import Column, DateColumn, Table, TitleColumn
    ...
    return render_modal_workflow(
        ...
        json_data={
            ...
            "result": {
                ...
                "edit_link": reverse("shataildocs:edit", args=(document.id,)),
            },
        },
    )
...
class DownloadColumn(Column):
    cell_template_name = "shataildocs/tables/download_cell.html"
    ...
    def get(self, request):
        ...
        columns = [
            TitleColumn(
                "title",
                label=_("Title"),
                url_name="shataildocs:document_chosen",
...
class ChooseView(BaseChooseView):
    def render_to_response(self):
        return render_modal_workflow(
            self.request,
            "shataildocs/chooser/chooser.html",
            None,
...
class ChooseResultsView(BaseChooseView):
    def render_to_response(self):
        return TemplateResponse(
            self.request, "shataildocs/chooser/results.html", self.get_context_data()
        )
    ...
    return render_modal_workflow(
        ...
        json_data={
            ...
            "htmlFragment": render_to_string(
                "shataildocs/chooser/upload_form.html", {"form": form}, request
            ),
        },
    )
