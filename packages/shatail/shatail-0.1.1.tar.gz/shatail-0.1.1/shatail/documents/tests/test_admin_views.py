...
from shatail.documents import get_document_model, models
from shatail.documents.tests.utils import get_test_document_file
from shatail.models import Collection, GroupCollectionPermission, Page
...
class TestDocumentIndexView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shataildocs:index"), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/documents/index.html")
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse("shataildocs:index"), {"p": 2})
    ...
    def test_edit_document_link_contains_next_url(self):
        ...
        edit_url = reverse("shataildocs:edit", args=(doc.id,))
        next_url = quote(response._request.get_full_path())
        self.assertContains(response, "%s?next=%s" % (edit_url, next_url))


class TestDocumentListingResultsView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shataildocs:listing_results"), params)
...
class TestDocumentAddView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def test_get(self):
        response = self.client.get(reverse("shataildocs:add"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/documents/add.html")
    ...
    @override_settings(SHATAILDOCS_DOCUMENT_MODEL="tests.CustomDocument")
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse("shataildocs:add"), post_data)

        # User should be redirected back to the index
        self.assertRedirects(response, reverse("shataildocs:index"))
...
class TestDocumentAddViewWithLimitedCollectionPermissions(TestCase, ShatailTestUtils):
    def setUp(self):
...
class TestDocumentEditView(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def test_get_with_limited_permissions(self):
        ...
        response = self.client.get(
            reverse("shataildocs:edit", args=(self.document.id,))
        )
    ...
    def test_simple(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/documents/edit.html")
    ...
    def test_next_url_is_present_in_edit_form(self):
        ...
        expected_next_url = (
            reverse("shataildocs:index")
            + "?"
            + urlencode({"collection_id": evil_plans_collection.id})
        )

        response = self.client.get(
            reverse("shataildocs:edit", args=(doc.id,)), {"next": expected_next_url}
        )
        self.assertEqual(response.status_code, 200)
        self.assertContains(
    ...
    def test_post(self):
        ...
        response = self.client.post(
            reverse("shataildocs:edit", args=(self.document.id,)), post_data
        )
    ...
    def test_edit_with_next_url(self):
        ...
        response = self.client.post(
            reverse("shataildocs:edit", args=(doc.id,)),
            {
                "title": "Edited",
                "collection": evil_plans_collection.id,
    ...
    def test_with_missing_source_file(self):
        ...
        response = self.client.get(reverse("shataildocs:edit", args=(document.id,)), {})
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/documents/edit.html")
    ...
    def test_reupload_different_file_size_and_file_hash(self):
        ...
        self.client.post(reverse("shataildocs:add"), post_data)
        ...
        self.client.post(
            reverse("shataildocs:edit", args=(document.pk,)),
            {
    ...
    def test_reupload_same_name(self):
        ...
        response = self.client.post(
            reverse("shataildocs:edit", args=(self.document.pk,)),
            {
...
@override_settings(SHATAILDOCS_DOCUMENT_MODEL="tests.CustomDocument")
class TestDocumentEditViewWithCustomDocumentModel(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def get(self, params={}):
        return self.client.get(
            reverse("shataildocs:edit", args=(self.document.id,)), params
        )
...
class TestDocumentDeleteView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.user = self.login()
    ...
    def test_delete_with_limited_permissions(self):
        ...
        response_get = self.client.get(
            reverse("shataildocs:delete", args=(self.document.id,))
        )
    ...
    def test_simple(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/documents/confirm_delete.html")
...
class TestMultipleDocumentUploader(TestCase, ShatailTestUtils):
    """
    This tests the multiple document upload views located in shataildocs/views/multiple.py
    """
    ...
    def test_add(self):
        ...
        """
        # Send request
        response = self.client.get(reverse("shataildocs:add_multiple"))

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/multiple/add.html")
    ...
    def test_add_post(self):
        ...
        """
        response = self.client.post(
            reverse("shataildocs:add_multiple"),
            {
    ...
    def test_add_post_nofile(self):
        ...
        """
        response = self.client.post(reverse("shataildocs:add_multiple"))
    ...
    def test_edit_get(self):
        ...
        # Send request
        response = self.client.get(
            reverse("shataildocs:edit_multiple", args=(self.doc.id,))
        )
    ...
    def test_delete_get(self):
        ...
        # Send request
        response = self.client.get(
            reverse("shataildocs:delete_multiple", args=(self.doc.id,))
        )
...
@override_settings(SHATAILDOCS_DOCUMENT_MODEL="tests.CustomDocumentWithAuthor")
class TestMultipleCustomDocumentUploaderWithRequiredField(TestMultipleDocumentUploader):
    ...
    def test_create_from_upload_invalid_post(self):
        ...
        response = self.client.post(
            reverse(
                "shataildocs:create_multiple_from_uploaded_document",
    ...
    def test_delete_uploaded_document(self):
        ...
        response = self.client.post(
            reverse(
                "shataildocs:delete_upload_multiple", args=(self.uploaded_document.id,)
            )
        )
...
class TestDocumentChooserView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.user = self.login()

    def test_simple(self):
        response = self.client.get(reverse("shataildocs:chooser"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/chooser/chooser.html")
        response_json = json.loads(response.content.decode())
    ...
    def test_search(self):
        response = self.client.get(
            reverse("shataildocs:chooser_results"), {"q": "Hello"}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context["query_string"], "Hello")
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse("shataildocs:chooser_results"), {"p": 2})

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/chooser/results.html")
    ...
    def test_pagination_invalid(self):
        ...
        response = self.client.get(
            reverse("shataildocs:chooser_results"), {"p": "Hello World!"}
        )
    ...
    def test_pagination_out_of_range(self):
        ...
        response = self.client.get(reverse("shataildocs:chooser_results"), {"p": 99999})
    ...
    def test_construct_queryset_hook_search(self):
        ...
        with self.register_hook(
            ...
            response = self.client.get(
                reverse("shataildocs:chooser_results"), {"q": "Test"}
            )
        self.assertEqual(len(response.context["documents"]), 1)
        self.assertEqual(response.context["documents"][0], document)
    ...
    def test_index_without_collections(self):
        ...
        response = self.client.get(reverse("shataildocs:index"))
        self.assertNotContains(response, "<th>Collection</th>")
        self.assertNotContains(response, "<td>Root</td>")
...
class TestDocumentChooserChosenView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(
            reverse("shataildocs:document_chosen", args=(self.document.id,))
        )
        self.assertEqual(response.status_code, 200)
        response_json = json.loads(response.content.decode())
...
class TestDocumentChooserUploadView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse("shataildocs:chooser_upload"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shataildocs/chooser/upload_form.html")
        response_json = json.loads(response.content.decode())
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse("shataildocs:chooser_upload"), post_data)
    ...
    def test_unique_together_validation(self):
        ...
        response = self.client.post(
            reverse("shataildocs:chooser_upload"),
            {
                "document-chooser-upload-title": "Test document",
...
class TestDocumentChooserUploadViewWithLimitedPermissions(TestCase, ShatailTestUtils):
    def setUp(self):
        add_doc_permission = Permission.objects.get(
            content_type__app_label="shataildocs", codename="add_document"
        )
...
class TestUsageCount(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def test_usage_count_does_not_appear(self):
        ...
        event_page_related_link.link_document = doc
        event_page_related_link.save()
        response = self.client.get(reverse("shataildocs:edit", args=(1,)))
...
class TestGetUsage(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def test_usage_page(self):
        ...
        event_page_related_link.link_document = doc
        event_page_related_link.save()
        response = self.client.get(reverse("shataildocs:document_usage", args=(1,)))
...
class TestEditOnlyPermissions(TestCase, ShatailTestUtils):
    ...
    def test_search(self):
        response = self.client.get(reverse("shataildocs:index"), {"q": "Hello"})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context["query_string"], "Hello")
