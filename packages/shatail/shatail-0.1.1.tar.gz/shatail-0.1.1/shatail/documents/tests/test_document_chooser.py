...
class TestChooser(TestCase, ShatailTestUtils):
    """Test chooser panel rendered by `shataildocs:chooser` view"""
    ...
    def login_as_editor(self):
        ...
        choose_document_permission = Permission.objects.get(
            content_type__app_label="shataildocs", codename="choose_document"
        )
    ...
    def get(self, params=None):
        return self.client.get(reverse("shataildocs:chooser"), params or {})
