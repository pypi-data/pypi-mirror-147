...
from shatail.models import PageLogEntry, PageRevision
...
class Command(BaseCommand):
            ...
            if not PageLogEntry.objects.filter(revision=revision).exists():
                ...
                if previous_revision is not None:
                    ...
                    if (
                        ...
                        self.log_page_action("shatail.publish", previous_revision, True)
                ...
                if is_new_page or has_content_changes or published:
                    ...
                    if published and has_content_changes:
                        ...
                        self.log_page_action(
                            "shatail.edit", revision, has_content_changes
                        )
    ...
    def log_page_action(self, action, revision, has_content_changes):
        PageLogEntry.objects.log_action(
            ...
            action=action,
            data={},
            revision=None if action == "shatail.create" else revision,
            user=revision.user,
