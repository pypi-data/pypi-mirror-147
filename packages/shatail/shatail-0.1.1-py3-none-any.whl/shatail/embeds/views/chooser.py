...
from shatail.embeds import embeds
...
from shatail.embeds.format import embed_to_editor_html
from shatail.embeds.forms import EmbedForm
...
def chooser(request):
    ...
    return render_modal_workflow(
        request,
        "shatailembeds/chooser/chooser.html",
        None,
        {"form": form},
