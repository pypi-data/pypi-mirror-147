...
from shatail.coreutils import camelcase_to_underscore, resolve_model_string
from shatail.rich_text import RichText, get_text_for_indexing
from shatail.telepath import Adapter, register
...
class FieldBlockAdapter(Adapter):
    js_constructor = "shatail.blocks.FieldBlock"
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailadmin/js/telepath/blocks.js"),
            ]
        )
...
class TextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from shatail.admin.widgets import AdminAutoHeightTextInput
...
class DateBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from shatail.admin.widgets import AdminDateInput
...
class TimeBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from shatail.admin.widgets import AdminTimeInput
...
class ChoiceBlock(BaseChoiceBlock):
    ...
    def deconstruct(self):
        ...
        """
        return ("shatail.blocks.ChoiceBlock", [], self._constructor_kwargs)
...
class MultipleChoiceBlock(BaseChoiceBlock):
    ...
    def deconstruct(self):
        ...
        into migrations.
        """
        return ("shatail.blocks.MultipleChoiceBlock", [], self._constructor_kwargs)
...
class RichTextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from shatail.admin.rich_text import get_rich_text_editor_widget
...
class PageChooserBlock(ChooserBlock):
    ...
    def target_model(self):
        ...
        return resolve_model_string("shatailcore.Page")
...
# Ensure that the blocks defined here get deconstructed as shatailcore.blocks.FooBlock
# rather than shatailcore.blocks.field.FooBlock
block_classes = [
    FieldBlock,
    CharBlock,
    URLBlock,
...
DECONSTRUCT_ALIASES = {cls: "shatail.blocks.%s" % cls.__name__ for cls in block_classes}
