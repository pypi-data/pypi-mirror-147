...
class Block(metaclass=BaseBlock):
    ...
    def __eq__(self, other):
        ...
        (https://github.com/shatail/shatail/issues/4298#issuecomment-367656028).
        """
    ...
    def media(self):
        return self.js_context.media + forms.Media(
            js=[
                ...
                versioned_static("shatailadmin/js/telepath/telepath.js"),
                versioned_static("shatailadmin/js/telepath/blocks.js"),
            ],
            css={
                "all": [
                    versioned_static("shatailadmin/css/panels/streamfield.css"),
                ]
            },
        )
...
def get_help_icon():
    return render_to_string(
        "shatailadmin/shared/icon.html", {"name": "help", "class_name": "default"}
    )


DECONSTRUCT_ALIASES = {
    Block: "shatail.blocks.Block",
}
