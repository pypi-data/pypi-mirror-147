...
from shatail.contrib.modeladmin.views import CreateView
from shatail.test.modeladmintest.shatail_hooks import PersonAdmin
from shatail.test.utils import ShatailTestUtils


class TestExtractPanelDefinitionsFromModelAdmin(TestCase, ShatailTestUtils):
    ...
    @mock.patch("shatail.contrib.modeladmin.views.ModelFormView.get_edit_handler")
    ...
    @mock.patch("shatail.contrib.modeladmin.options.ModelAdmin.get_edit_handler")
    def test_model_admin_edit_handler_called(self, mock_modeladmin_get_edit_handler):
        ...
        # as of Shatail 2.17, ModelAdmin.get_edit_handler is NOT passed instance or request
