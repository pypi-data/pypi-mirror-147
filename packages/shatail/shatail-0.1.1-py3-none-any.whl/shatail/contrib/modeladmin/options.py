...
from shatail.admin.admin_url_finder import register_admin_url_finder
from shatail.admin.checks import check_panels_in_model
from shatail.admin.panels import ObjectList, extract_panel_definitions_from_model_class
from shatail.models import Page, TranslatableMixin
...
class ShatailRegisterable:
    """
    Base class, providing a more convenient way for ModelAdmin or
    ModelAdminGroup instances to be registered with Shatail's admin area.
    """

    add_to_settings_menu = False
    exclude_from_explorer = False

    def register_with_shatail(self):
...
class ModelAdmin(ShatailRegisterable):
    """
    The core modeladmin class. It provides an alternative means to
    list and manage instances of a given 'model' within Shatail's admin area.
    ...
    additional functionality available via various Shatail hooks.
    """
    ...
    def __init__(self, parent=None):
        ...
        # See: https://github.com/shatail/shatail/issues/5105
    ...
    def get_list_filter(self, request):
        ...
        if (
            getattr(settings, "SHATAIL_I18N_ENABLED", False)
    ...
    # RemovedInShatail50Warning - remove request arg, included here so that old-style super()
    ...
    def get_index_view_extra_css(self):
        css = ["shatailmodeladmin/css/index.css"]
    ...
    def create_view(self, request):
        ...
        the assigned model, or redirect to Shatail's create view if the
    ...
    def choose_parent_view(self, request):
        ...
        for a new object, where the assigned model extends Shatail's Page
    ...
    def edit_view(self, request, instance_pk):
        ...
        assigned model, or redirect to Shatail's edit view if the assigned
    ...
    def delete_view(self, request, instance_pk):
        ...
        functionality for the assigned model, or redirect to Shatail's delete
    ...
    # RemovedInShatail50Warning - remove instance and request args, included here so that
    ...
    def get_menu_item(self, order=None):
        """
        Utilised by Shatail's 'register_menu_item' hook to create a menu item
    ...
    def get_permissions_for_registration(self):
        """
        Utilised by Shatail's 'register_permissions' hook to allow permissions
        ...
        """
        from shatail.snippets.models import SNIPPET_MODELS
    ...
    def get_admin_urls_for_registration(self):
        """
        Utilised by Shatail's 'register_admin_urls' hook to register urls for
...
class ModelAdminGroup(ShatailRegisterable):
    """
    ...
    def get_menu_item(self):
        """
        Utilised by Shatail's 'register_menu_item' hook to create a menu
...
def modeladmin_register(modeladmin_class):
    """
    Method for registering ModelAdmin or ModelAdminGroup classes with Shatail.
    """
    instance = modeladmin_class()
    instance.register_with_shatail()
