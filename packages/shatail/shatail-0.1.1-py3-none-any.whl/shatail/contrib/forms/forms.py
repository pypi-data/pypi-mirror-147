...
from shatail.contrib.forms.utils import get_field_clean_name
...
class FormBuilder:
    ...
    def get_field_options(self, field):
        ...
        if getattr(settings, "SHATAILFORMS_HELP_TEXT_ALLOW_HTML", False):
    ...
    def get_form_class(self):
        return type(str("ShatailForm"), (BaseForm,), self.formfields)
...
class ShatailAdminFormPageForm(ShatailAdminPageForm):
    def clean(self):
