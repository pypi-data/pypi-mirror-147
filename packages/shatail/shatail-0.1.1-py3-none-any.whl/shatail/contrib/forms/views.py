...
from shatail.contrib.forms.forms import SelectDateForm
...
class FormPagesListView(SafePaginateListView):
    ...
    template_name = "shatailforms/index.html"
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        if self.locale:
            url = reverse("shatailforms:index")
            locale_context = {
                "locale": self.locale,
                "translations": [
...
class DeleteSubmissionsView(TemplateView):
    ...
    template_name = "shatailforms/confirm_delete.html"
    page = None
    submissions = None
    success_url = "shatailforms:list_submissions"
...
class SubmissionsListView(SpreadsheetExportMixin, SafePaginateListView):
    ...
    template_name = "shatailforms/index_submissions.html"
