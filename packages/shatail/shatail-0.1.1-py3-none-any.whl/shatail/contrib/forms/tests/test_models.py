...
class TestFormSubmission(TestCase):
    ...
    @override_settings(SHATAILFORMS_HELP_TEXT_ALLOW_HTML=True)
...
class TestFormWithCustomSubmission(TestCase, ShatailTestUtils):
    def setUp(self):
        # Create a form page
...
class TestFormPageWithCustomFormBuilder(TestCase, ShatailTestUtils):
    def setUp(self):
...
class TestIssue798(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
