...
from shatail.contrib.search_promotions.templatetags.shatailsearchpromotions_tags import (
...
class TestSearchPromotionsIndexView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse("shatailsearchpromotions:index"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsearchpromotions/index.html")

    def test_search(self):
        response = self.client.get(
            reverse("shatailsearchpromotions:index"), {"q": "Hello"}
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse("shatailsearchpromotions:index"), {"p": 2})
    ...
    def test_pagination_invalid(self):
        ...
        response = self.client.get(
            reverse("shatailsearchpromotions:index"), {"p": "Hello World!"}
        )
    ...
    def test_pagination_out_of_range(self):
        ...
        response = self.client.get(
            reverse("shatailsearchpromotions:index"), {"p": 99999}
        )
    ...
    def test_results_ordering(self):
        self.make_search_picks()
        url = reverse("shatailsearchpromotions:index")
        SearchPromotion.objects.create(
...
class TestSearchPromotionsAddView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse("shatailsearchpromotions:add"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsearchpromotions/add.html")
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse("shatailsearchpromotions:add"), post_data)

        # User should be redirected back to the index
        self.assertRedirects(response, reverse("shatailsearchpromotions:index"))
...
class TestSearchPromotionsEditView(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def test_simple(self):
        response = self.client.get(
            reverse("shatailsearchpromotions:edit", args=(self.query.id,))
        )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsearchpromotions/edit.html")
    ...
    def test_post(self):
        ...
        response = self.client.post(
            reverse("shatailsearchpromotions:edit", args=(self.query.id,)), post_data
        )
...
class TestSearchPromotionsDeleteView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(
            reverse("shatailsearchpromotions:delete", args=(self.query.id,))
        )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsearchpromotions/confirm_delete.html")
