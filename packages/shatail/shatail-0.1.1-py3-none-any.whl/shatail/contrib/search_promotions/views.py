...
from shatail.admin.auth import any_permission_required, permission_required
from shatail.admin.forms.search import SearchForm
from shatail.contrib.search_promotions import forms
from shatail.log_actions import log
from shatail.search import forms as search_forms
from shatail.search.models import Query


@any_permission_required(
    "shatailsearchpromotions.add_searchpromotion",
    "shatailsearchpromotions.change_searchpromotion",
    "shatailsearchpromotions.delete_searchpromotion",
)
...
def index(request):
    ...
    if request.headers.get("x-requested-with") == "XMLHttpRequest":
        return TemplateResponse(
            request,
            "shatailsearchpromotions/results.html",
            {
        ...
        return TemplateResponse(
            request,
            "shatailsearchpromotions/index.html",
            {
                "is_searching": is_searching,
                "ordering": ordering,
                "queries": queries,
...
@permission_required("shatailsearchpromotions.add_searchpromotion")
def add(request):
        ...
        if query_form.is_valid():
            ...
            if save_searchpicks(query, query, searchpicks_formset):
                ...
                messages.success(
                    ...
                    buttons=[
                        messages.button(
                            reverse("shatailsearchpromotions:edit", args=(query.id,)),
                            _("Edit"),
                        )
                    ],
                )
                return redirect("shatailsearchpromotions:index")
            else:
    ...
    return TemplateResponse(
        request,
        "shatailsearchpromotions/add.html",
        {
...
@permission_required("shatailsearchpromotions.change_searchpromotion")
def edit(request, query_id):
    ...
    return TemplateResponse(
        request,
        "shatailsearchpromotions/edit.html",
        {
            "query_form": query_form,
            "searchpicks_formset": searchpicks_formset,
            "query": query,
...
@permission_required("shatailsearchpromotions.delete_searchpromotion")
def delete(request, query_id):
    ...
    return TemplateResponse(
        request,
        "shatailsearchpromotions/confirm_delete.html",
        {
            "query": query,
        },
    )
