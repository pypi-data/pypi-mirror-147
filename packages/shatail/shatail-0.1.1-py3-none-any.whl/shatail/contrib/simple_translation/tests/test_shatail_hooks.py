...
from shatail.contrib.simple_translation.shatail_hooks import (
...
class Utils(ShatailTestUtils, TestCase):
    def setUp(self):
...
class TestShatailHooksURLs(TestCase):
...
class TestShatailHooksPermission(Utils):
...
class TestShatailHooksButtons(Utils):
    class PagePerms:
