...
class TestRedirectReport(TestCase, ShatailTestUtils):
    def setUp(self):
        self.user = self.login()

    def get(self, params={}):
        return self.client.get(reverse("shatailredirects:report"), params)
    ...
    def test_empty(self):
        ...
        self.assertTemplateUsed(
            response, "shatailredirects/reports/redirects_report.html"
        )
