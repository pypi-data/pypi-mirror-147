...
from shatail.test.routablepage.models import RoutablePageTest
...
class TestRedirectsIndexView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse("shatailredirects:index"), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailredirects/index.html")
...
class TestRedirectsAddView(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def get(self, params={}):
        return self.client.get(reverse("shatailredirects:add"), params)

    def post(self, post_data={}):
        return self.client.post(reverse("shatailredirects:add"), post_data)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailredirects/add.html")
    ...
    def test_add(self):
        ...
        self.assertRedirects(response, reverse("shatailredirects:index"))
...
class TestRedirectsEditView(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def get(self, params={}, redirect_id=None):
        return self.client.get(
            reverse("shatailredirects:edit", args=(redirect_id or self.redirect.id,)),
            params,
        )
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailredirects/edit.html")
...
class TestRedirectsDeleteView(TestCase, ShatailTestUtils):
    def setUp(self):
        # Create a redirect to edit
        self.redirect = models.Redirect(
            old_path="/test", redirect_link="http://www.test.com/"
    ...
    def get(self, params={}, redirect_id=None):
        return self.client.get(
            reverse("shatailredirects:delete", args=(redirect_id or self.redirect.id,)),
            params,
        )
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailredirects/confirm_delete.html")
