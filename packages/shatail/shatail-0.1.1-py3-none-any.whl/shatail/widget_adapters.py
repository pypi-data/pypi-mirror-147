...
class WidgetAdapter(Adapter):
    js_constructor = "shatail.widgets.Widget"
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailadmin/js/telepath/widgets.js"),
            ]
        )
...
class CheckboxInputAdapter(WidgetAdapter):
    js_constructor = "shatail.widgets.CheckboxInput"
...
class RadioSelectAdapter(WidgetAdapter):
    js_constructor = "shatail.widgets.RadioSelect"
...
class SelectAdapter(WidgetAdapter):
    js_constructor = "shatail.widgets.Select"
...
class ValidationErrorAdapter(Adapter):
    js_constructor = "shatail.errors.ValidationError"
