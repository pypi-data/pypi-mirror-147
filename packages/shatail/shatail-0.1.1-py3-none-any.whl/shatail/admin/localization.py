...
# Shatail languages with >=90% coverage
...
# as the shatailConfig.STRINGS object
...
def get_available_admin_languages():
    return getattr(
        settings, "SHATAILADMIN_PERMITTED_LANGUAGES", SHATAILADMIN_PROVIDED_LANGUAGES
    )
...
def get_available_admin_time_zones():
    ...
    return getattr(settings, "SHATAIL_USER_TIME_ZONES", pytz.common_timezones)
