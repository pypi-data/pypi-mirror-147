...
from shatail.test.testapp.models import SimplePage, StandardChild, StandardIndex
from shatail.test.utils import ShatailTestUtils


class TestPageDelete(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
    ...
    def test_page_delete(self):
        response = self.client.get(
            reverse("shatailadmin_pages:delete", args=(self.child_page.id,))
        )
    ...
    def test_subpage_deletion(self):
        ...
        # Post
        response = self.client.post(
            reverse("shatailadmin_pages:delete", args=(self.child_index.id,))
        )
