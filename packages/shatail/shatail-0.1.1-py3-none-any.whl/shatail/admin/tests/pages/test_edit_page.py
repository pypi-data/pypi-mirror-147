...
from shatail.admin.tests.pages.timestamps import submittable_timestamp
from shatail.exceptions import PageClassNotFoundError
...
from shatail.test.utils.form_data import inline_formset, nested_form_data
from shatail.users.models import UserProfile


class TestPageEdit(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
    ...
    def test_page_edit(self):
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.event_page.id,))
        )
    ...
    def test_edit_draft_page_with_no_revisions(self):
        # Tests that the edit page loads
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.unpublished_page.id,))
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_multipart(self):
        ...
        self.assertTemplateUsed(response, "shatailadmin/pages/edit.html")

        # check for FilePage which has file field
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.file_page.id,))
        )
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'enctype="multipart/form-data"')

    @mock.patch("shatail.models.ContentType.model_class", return_value=None)
    ...
    def test_upload_file_publish(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=[self.file_page.id]), post_data
        )

        # Should be redirected to explorer
        self.assertRedirects(
            response, reverse("shatailadmin_explore", args=[self.root_page.id])
        )
    ...
    def test_upload_file_draft(self):
        ...
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=[self.file_page.id])
        )
    ...
    def test_page_edit_bad_permissions(self):
        ...
        # Get edit page
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.child_page.id,))
        )
    ...
    def test_page_edit_post(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(self.child_page.id,)), post_data
        )

        # Should be redirected to edit page
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=(self.child_page.id,))
        )
    ...
    def test_preview_on_edit(self):
        ...
        preview_url = reverse(
            "shatailadmin_pages:preview_on_edit", args=(self.child_page.id,)
        )
    ...
    def test_preview_on_edit_no_session_key(self):
        ...
        self.assertContains(
            response, "<title>Shatail - Preview error</title>", html=True
        )
    ...
    def test_editor_page_shows_custom_live_url_in_status_when_draft_edits_exist(self):
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.single_event_page.id,))
        )
    ...
    def test_edit_alias_page(self):
        ...
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=[alias_page.id])
        )
        ...
        self.assertTemplateUsed(response, "shatailadmin/pages/edit_alias.html")
        original_page_edit_url = reverse(
            "shatailadmin_pages:edit", args=[self.event_page.id]
        )
        self.assertContains(
            response,
    ...
    def test_post_edit_alias_page(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=[alias_page.id]), post_data
        )
...
class TestPageEditReordering(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
        self.root_page = Page.objects.get(id=2)
    ...
    def test_reorder(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(self.event_page.id,)), post_data
        )

        # Should be redirected back to same page
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=(self.event_page.id,))
        )
...
class TestIssue197(TestCase, ShatailTestUtils):
    def test_issue_197(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(self.tagged_page.id,)), post_data
        )
...
class TestChildRelationsOnSuperclass(TestCase, ShatailTestUtils):
    ...
    def test_post_create_form(self):
        ...
        # Should be redirected to edit page
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=(page.id,))
        )
    ...
    def test_get_edit_form(self):
        response = self.client.get(
            reverse("shatailadmin_pages:edit", args=(self.index_page.id,))
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_post_edit_form(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(self.index_page.id,)), post_data
        )
...
class TestIssue2492(TestCase, ShatailTestUtils):
    """
...
class TestIssue3982(TestCase, ShatailTestUtils):
    """
    ...
    def _create_page(self, parent):
        response = self.client.post(
            reverse("shatailadmin_pages:add", args=("tests", "simplepage", parent.pk)),
            {
                "title": "Hello, world!",
                "content": "Some content",
                "slug": "hello-world",
        ...
        self.assertRedirects(
            response, reverse("shatailadmin_explore", args=(parent.pk,))
        )
    ...
    def _edit_page(self, parent):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(page.pk,)),
            {
                "title": "Hello, world!",
                "content": "Some content",
                "slug": "hello-world",
    ...
    def _approve_page(self, parent):
        ...
        revision.save()
        response = self.client.post(
            reverse("shatailadmin_pages:approve_moderation", args=(revision.pk,)),
            follow=True,
        )
        page = SimplePage.objects.get()
        self.assertTrue(page.live)
...
class TestParentalM2M(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def test_create_and_save(self):
        ...
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=(created_page.id,))
        )
    ...
    def test_create_and_publish(self):
        ...
        self.assertRedirects(
            response, reverse("shatailadmin_explore", args=(self.events_index.id,))
        )
    ...
    def test_edit_and_save(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:edit", args=(self.christmas_page.id,)),
            post_data,
        )
        self.assertRedirects(
            response, reverse("shatailadmin_pages:edit", args=(self.christmas_page.id,))
        )
...
class TestValidationErrorMessages(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
...
class TestNestedInlinePanel(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def test_get_edit_form(self):
        ...
        # there should be no "extra" forms, as the nested formset should respect the extra_form_count=0 set on ShatailAdminModelForm
        self.assertContains(
            response,
...
class TestLocaleSelector(TestCase, ShatailTestUtils):
    fixtures = ["test.json"]
    ...
    def test_locale_selector(self):
        ...
        edit_translation_url = reverse(
            "shatailadmin_pages:edit", args=[self.translated_christmas_page.id]
        )
...
class TestPageSubscriptionSettings(TestCase, ShatailTestUtils):
    def setUp(self):
        # Find root page
        self.root_page = Page.objects.get(id=2)
    ...
    @override_settings(SHATAILADMIN_COMMENTS_ENABLED=False)
...
class TestCommenting(TestCase, ShatailTestUtils):
    """
    ...
    def test_new_comment(self):
        ...
        comment = self.child_page.shatail_admin_comments.get()
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.create")
    ...
    def test_edit_comment(self):
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.edit")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
    ...
    def test_edit_another_users_comment(self):
        ...
        self.assertFalse(
            PageLogEntry.objects.filter(action="shatail.comments.edit").exists()
        )
    ...
    def test_resolve_comment(self):
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.resolve")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
    ...
    def test_delete_comment(self):
        ...
        self.assertFalse(self.child_page.shatail_admin_comments.exists())
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.delete")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
    ...
    def test_new_reply(self):
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.create_reply")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
    ...
    def test_edit_reply(self):
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.edit_reply")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
    ...
    def test_delete_reply(self):
        ...
        # Check audit log
        log_entry = PageLogEntry.objects.get(action="shatail.comments.delete_reply")
        self.assertEqual(log_entry.page, self.child_page.page_ptr)
        self.assertEqual(log_entry.user, self.user)
        self.assertEqual(log_entry.revision, self.child_page.get_latest_revision())
        self.assertEqual(log_entry.data["comment"]["id"], comment.id)
