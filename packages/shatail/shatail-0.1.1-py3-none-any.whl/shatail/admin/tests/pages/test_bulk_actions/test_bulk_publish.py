...
class TestBulkPublish(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def test_publish_view(self):
        ...
        self.assertTemplateUsed(
            response, "shatailadmin/pages/bulk_actions/confirm_bulk_publish.html"
        )
...
class TestBulkPublishIncludingDescendants(TestCase, ShatailTestUtils):
    def setUp(self):
        self.root_page = Page.objects.get(id=2)
