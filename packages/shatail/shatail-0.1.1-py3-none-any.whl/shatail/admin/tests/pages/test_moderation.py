...
from shatail.models import Page, PageRevision
...
class TestApproveRejectModeration(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def test_approve_moderation_view(self):
        ...
        response = self.client.post(
            reverse("shatailadmin_pages:approve_moderation", args=(self.revision.id,))
        )
    ...
    def test_approve_moderation_view_bad_revision_id(self):
        ...
        # Post
        response = self.client.post(
            reverse("shatailadmin_pages:approve_moderation", args=(12345,))
        )
    ...
    def test_reject_moderation_view(self):
        ...
        # Post
        response = self.client.post(
            reverse("shatailadmin_pages:reject_moderation", args=(self.revision.id,))
        )
    ...
    def test_reject_moderation_view_bad_revision_id(self):
        ...
        # Post
        response = self.client.post(
            reverse("shatailadmin_pages:reject_moderation", args=(12345,))
        )
    ...
    def test_preview_for_moderation(self):
        response = self.client.get(
            reverse(
                "shatailadmin_pages:preview_for_moderation", args=(self.revision.id,)
            )
        )
