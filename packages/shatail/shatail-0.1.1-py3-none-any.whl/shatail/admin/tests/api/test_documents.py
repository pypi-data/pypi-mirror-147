...
from shatail.api.v2.tests.test_documents import TestDocumentDetail, TestDocumentListing
...
class TestAdminDocumentListing(AdminAPITestCase, TestDocumentListing):
    ...
    def get_response(self, **params):
        return self.client.get(reverse("shatailadmin_api:documents:listing"), params)
...
class TestAdminDocumentDetail(AdminAPITestCase, TestDocumentDetail):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(
            reverse("shatailadmin_api:documents:detail", args=(image_id,)), params
        )
