...
from shatail.api.v2.tests.test_pages import TestPageDetail, TestPageListing
from shatail.models import GroupPagePermission, Locale, Page, PageLogEntry
...
class TestAdminPageListing(AdminAPITestCase, TestPageListing):
    ...
    def get_response(self, **params):
        return self.client.get(reverse("shatailadmin_api:pages:listing"), params)
...
class TestAdminPageDetail(AdminAPITestCase, TestPageDetail):
    ...
    def get_response(self, page_id, **params):
        return self.client.get(
            reverse("shatailadmin_api:pages:detail", args=(page_id,)), params
        )
...
class TestAdminPageDetailWithStreamField(AdminAPITestCase):
    ...
    def test_can_fetch_streamfield_content(self):
        ...
        response_url = reverse("shatailadmin_api:pages:detail", args=(stream_page.id,))
...
class TestCustomAdminDisplayTitle(AdminAPITestCase):
    ...
    def test_custom_admin_display_title_shown_on_detail_page(self):
        api_url = reverse("shatailadmin_api:pages:detail", args=(self.event_page.id,))
    ...
    def test_custom_admin_display_title_shown_on_listing(self):
        api_url = reverse("shatailadmin_api:pages:listing")
        response = self.client.get(api_url)
        content = json.loads(response.content.decode("utf-8"))
...
class TestCopyPageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id, data):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "copy"]), data
        )
...
class TestConvertAliasPageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "convert_alias"])
        )
    ...
    def test_convert_alias(self):
        ...
        # Check audit log
        log = PageLogEntry.objects.get(action="shatail.convert_alias")
...
class TestDeletePageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "delete"])
        )
...
class TestPublishPageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "publish"])
        )
...
class TestUnpublishPageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id, data):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "unpublish"]), data
        )
...
class TestMovePageAction(AdminAPITestCase):
    ...
    def get_response(self, page_id, data):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "move"]), data
        )
...
class TestCopyForTranslationAction(AdminAPITestCase):
    ...
    def get_response(self, page_id, data):
        return self.client.post(
            reverse(
                "shatailadmin_api:pages:action", args=[page_id, "copy_for_translation"]
            ),
            data,
        )
...
class TestCreatePageAliasAction(AdminAPITestCase):
    ...
    def get_response(self, page_id, data):
        return self.client.post(
            reverse("shatailadmin_api:pages:action", args=[page_id, "create_alias"]),
            data,
        )
