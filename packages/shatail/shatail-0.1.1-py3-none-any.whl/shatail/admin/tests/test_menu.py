...
from shatail.admin.menu import AdminOnlyMenuItem, Menu, MenuItem, SubmenuMenuItem
...
class TestMenuRendering(TestCase, ShatailTestUtils):
    def setUp(self):
