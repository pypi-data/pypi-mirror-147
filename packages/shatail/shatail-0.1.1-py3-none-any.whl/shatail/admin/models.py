...
# shatail admin (namely, base_form_class and get_edit_handler). Importing this within
# shatail.admin.models ensures that this happens in advance of running shatail.admin's
# system checks.
from shatail.admin import panels  # NOQA
...
class Admin(Model):
    class Meta:
        ...
        permissions = [
            ("access_admin", "Can access Shatail admin"),
        ]
