...
from shatail.coreutils import multigetattr
...
class Column(metaclass=MediaDefiningClass):
    ...
    header_template_name = "shatailadmin/tables/column_header.html"
    cell_template_name = "shatailadmin/tables/cell.html"
...
class TitleColumn(Column):
    ...
    cell_template_name = "shatailadmin/tables/title_cell.html"
...
class StatusFlagColumn(Column):
    ...
    cell_template_name = "shatailadmin/tables/status_flag_cell.html"
...
class DateColumn(Column):
    ...
    cell_template_name = "shatailadmin/tables/date_cell.html"


class UserColumn(Column):
    """Outputs the username and avatar for a user"""

    cell_template_name = "shatailadmin/tables/user_cell.html"
...
class Table(Component):
    template_name = "shatailadmin/tables/table.html"
    classname = "listing"
