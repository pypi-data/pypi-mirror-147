...
def get_admin_base_url(context=None):
    """
    Gets the base URL for the shatail admin site. This is set in `settings.SHATAILADMIN_BASE_URL`,
    ...
    admin_base_url = getattr(settings, "SHATAILADMIN_BASE_URL", None)
    if admin_base_url is None and hasattr(settings, "BASE_URL"):
        warn(
            "settings.BASE_URL has been renamed to settings.SHATAILADMIN_BASE_URL",
