...
from shatail.admin import messages, signals
...
from shatail.models import Locale, Page, PageSubscription, UserPagePermissionsProxy
...
def add_subpage(request, parent_page_id):
    ...
    if len(page_types) == 1:
        ...
        return redirect("shatailadmin_pages:add", app_label, model_name, parent_page.id)

    return TemplateResponse(
        request,
        "shatailadmin/pages/add_subpage.html",
        {
...
class CreateView(TemplateResponseMixin, ContextMixin, HookResponseMixin, View):
    template_name = "shatailadmin/pages/create.html"
