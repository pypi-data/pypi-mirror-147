...
def move_choose_destination(request, page_to_move_id, viewed_page_id=None):
    ...
    return TemplateResponse(
        request,
        "shatailadmin/pages/move_choose_destination.html",
        {
...
def move_confirm(request, page_to_move_id, destination_id):
    ...
    if request.method == "POST":
        ...
        messages.success(
            ...
            buttons=[
                messages.button(
                    reverse("shatailadmin_pages:edit", args=(page_to_move.id,)),
                    _("Edit"),
                )
            ],
        )
        ...
        return redirect("shatailadmin_explore", destination.id)

    return TemplateResponse(
        request,
        "shatailadmin/pages/confirm_move.html",
        {
            "page_to_move": page_to_move,
