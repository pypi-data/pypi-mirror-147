...
class WorkflowReportFilterSet(ShatailFilterSet):
...
class WorkflowTasksReportFilterSet(ShatailFilterSet):
...
class WorkflowView(ReportView):
    template_name = "shatailadmin/reports/workflow.html"
    title = _("Workflows")
    header_icon = "tasks"
...
class WorkflowTasksView(ReportView):
    template_name = "shatailadmin/reports/workflow_tasks.html"
