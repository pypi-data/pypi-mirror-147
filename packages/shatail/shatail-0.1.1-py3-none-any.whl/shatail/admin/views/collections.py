...
from shatail.admin.forms.collections import CollectionForm
...
from shatail.permissions import collection_permission_policy
...
class Index(IndexView):
    ...
    template_name = "shatailadmin/collections/index.html"
    add_url_name = "shatailadmin_collections:add"
    index_url_name = "shatailadmin_collections:index"
...
class Edit(EditView):
    ...
    model = Collection
    form_class = CollectionForm
    template_name = "shatailadmin/collections/edit.html"
    ...
    edit_url_name = "shatailadmin_collections:edit"
    index_url_name = "shatailadmin_collections:index"
    delete_url_name = "shatailadmin_collections:delete"
...
class Delete(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if collection_contents:
            ...
            self.template_name = "shatailadmin/collections/delete_not_empty.html"
