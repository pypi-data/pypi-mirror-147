...
from shatail.admin.forms.collections import CollectionViewRestrictionForm
from shatail.admin.modal_workflow import render_modal_workflow
from shatail.models import Collection, CollectionViewRestriction
...
def set_privacy(request, collection_id):
    ...
    if restriction_exists_on_ancestor:
        ...
        return render_modal_workflow(
            request,
            "shatailadmin/collection_privacy/ancestor_privacy.html",
            None,
            {
        ...
        return render_modal_workflow(
            request,
            "shatailadmin/collection_privacy/set_privacy.html",
            None,
            {
