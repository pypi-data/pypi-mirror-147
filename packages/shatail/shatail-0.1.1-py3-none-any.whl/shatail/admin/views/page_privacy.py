...
from shatail.admin.forms.pages import PageViewRestrictionForm
...
def set_privacy(request, page_id):
    ...
    if restriction_exists_on_ancestor:
        ...
        return render_modal_workflow(
            request,
            "shatailadmin/page_privacy/ancestor_privacy.html",
            None,
            {
        ...
        return render_modal_workflow(
            request,
            "shatailadmin/page_privacy/set_privacy.html",
            None,
            {
                "page": page,
                "form": form,
