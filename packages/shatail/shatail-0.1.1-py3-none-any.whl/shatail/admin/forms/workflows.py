...
from shatail.admin.panels import FieldPanel, InlinePanel, ObjectList
from shatail.admin.widgets.workflows import AdminTaskChooser
from shatail.coreutils import get_model_string
from shatail.models import Page, Task, Workflow, WorkflowPage
...
def get_workflow_edit_handler():
    ...
    edit_handler = ObjectList(panels, base_form_class=ShatailAdminModelForm)
