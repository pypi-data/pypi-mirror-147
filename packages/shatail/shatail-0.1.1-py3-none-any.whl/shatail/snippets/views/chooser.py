...
from shatail.snippets.views.snippets import get_snippet_model_from_url_params
...
class ChooseView(BaseChooseView):
    ...
    def render_to_response(self):
        return render_modal_workflow(
            self.request,
            "shatailsnippets/chooser/choose.html",
            None,
            {
...
class ChooseResultsView(BaseChooseView):
    ...
    def render_to_response(self):
        return TemplateResponse(
            self.request,
            "shatailsnippets/chooser/results.html",
            {
                "model_opts": self.model._meta,
                "items": self.paginated_items,
                "table": self.table,
...
def chosen(request, app_label, model_name, pk):
    ...
    snippet_data = {
        ...
        "string": str(item),
        "edit_link": reverse(
            "shatailsnippets:edit", args=(app_label, model_name, quote(item.pk))
        ),
    }
