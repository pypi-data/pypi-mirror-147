...
from shatail import VERSION, __version__
from shatail.models import Page, Site
from shatail.rich_text import RichText, expand_db_html
from shatail.utils.version import get_main_version
...
@register.simple_tag
def shatail_documentation_path():
    major, minor, patch, release, num = VERSION
    if release == "final":
        return "https://docs.shatail.org/en/v%s" % __version__
    else:
        return "https://docs.shatail.org/en/latest"


@register.simple_tag
def shatail_release_notes_path():
...
def richtext(value):
    ...
    return render_to_string("shatailcore/shared/richtext.html", {"html": html})
