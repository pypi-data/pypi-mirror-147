...
from shatail.documents.views.bulk_actions.document_bulk_action import DocumentBulkAction
...
class AddTagsBulkAction(DocumentBulkAction):
    ...
    template_name = "shataildocs/bulk_actions/confirm_bulk_add_tags.html"
    action_priority = 20
    form_class = TagForm
