...
from shatail.documents.models import document_served
from shatail.forms import PasswordViewRestrictionForm
from shatail.models import CollectionViewRestriction
from shatail.utils import sendfile_streaming_backend
from shatail.utils.sendfile import sendfile
...
def serve(request, document_id, document_filename):
    ...
    serve_method = getattr(settings, "SHATAILDOCS_SERVE_METHOD", None)
    ...
    if local_path:
        ...
        # Use shatail.utils.sendfile to serve the file;
