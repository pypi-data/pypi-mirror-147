...
class AddView(BaseAddView):
    ...
    template_name = "shataildocs/multiple/add.html"
    upload_model = UploadedDocument

    edit_object_url_name = "shataildocs:edit_multiple"
    delete_object_url_name = "shataildocs:delete_multiple"
    edit_object_form_prefix = "doc"
    context_object_name = "doc"
    context_object_id_name = "doc_id"

    edit_upload_url_name = "shataildocs:create_multiple_from_uploaded_document"
    delete_upload_url_name = "shataildocs:delete_upload_multiple"
