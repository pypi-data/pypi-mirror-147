...
from shatail.documents.permissions import (
...
def get_document_base_form():
    base_form_override = getattr(settings, "SHATAILDOCS_DOCUMENT_FORM_BASE", "")
...
GroupDocumentPermissionFormSet = collection_member_permission_formset_factory(
    ...
    "shataildocs/permissions/includes/document_permissions_formset.html",
)
