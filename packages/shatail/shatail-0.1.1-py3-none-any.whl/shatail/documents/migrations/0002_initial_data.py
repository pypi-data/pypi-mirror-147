...
def add_document_permissions_to_admin_groups(apps, schema_editor):
    ...
    document_content_type, _created = ContentType.objects.get_or_create(
        model="document", app_label="shataildocs"
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("shataildocs", "0001_initial"),
        # Need to run shatailcores initial data migration to make sure the groups are created
