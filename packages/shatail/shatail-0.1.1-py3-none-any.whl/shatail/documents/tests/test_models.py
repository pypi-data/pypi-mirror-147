...
from shatail.test.testapp.models import CustomDocument, ReimportedDocumentModel
...
class TestDocumentPermissions(TestCase, ShatailTestUtils):
    def setUp(self):
...
@override_settings(SHATAILDOCS_EXTENSIONS=["pdf"])
class TestDocumentValidateExtensions(TestCase):
    ...
    def test_create_doc_invalid_extension(self):
        ...
        mentioned in settings.SHATAILDOCS_EXTENSIONS
...
class TestGetDocumentModel(ShatailTestUtils, TestCase):
    @override_settings(SHATAILDOCS_DOCUMENT_MODEL="tests.CustomDocument")
    ...
    def test_standard_get_document_model(self):
        """Test get_document_model with no SHATAILDOCS_DOCUMENT_MODEL"""
        del settings.SHATAILDOCS_DOCUMENT_MODEL
    ...
    def test_standard_get_document_model_string(self):
        """Test get_document_model_string with no SHATAILDOCS_DOCUMENT_MODEL"""
        del settings.SHATAILDOCS_DOCUMENT_MODEL
        self.assertEqual(get_document_model_string(), "shataildocs.Document")

    @override_settings(SHATAILDOCS_DOCUMENT_MODEL="tests.UnknownModel")
    def test_unknown_get_document_model(self):
        """Test get_document_model with an unknown model"""
        with self.assertRaises(ImproperlyConfigured):
            get_document_model()

    @override_settings(SHATAILDOCS_DOCUMENT_MODEL="invalid-string")
