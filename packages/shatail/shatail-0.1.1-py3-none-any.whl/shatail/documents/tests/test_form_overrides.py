...
from shatail.documents.forms import (
    BaseDocumentForm,
    get_document_base_form,
    get_document_form,
    get_document_multi_form,
)
from shatail.test.testapp.media_forms import AlternateDocumentForm, OverriddenWidget
...
class TestDocumentFormOverride(TestCase):
    ...
    @override_settings(
        SHATAILDOCS_DOCUMENT_FORM_BASE="shatail.test.testapp.media_forms.AlternateDocumentForm"
    )
