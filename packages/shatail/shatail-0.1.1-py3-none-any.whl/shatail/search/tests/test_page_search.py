...
from shatail.search.backends.base import BaseSearchQueryCompiler, BaseSearchResults


class PageSearchTests:
    # A TestCase with this class mixed in will be dynamically created
    # for each search backend defined in SHATAILSEARCH_BACKENDS, with the backend name available
...
for backend_name in settings.SHATAILSEARCH_BACKENDS.keys():
