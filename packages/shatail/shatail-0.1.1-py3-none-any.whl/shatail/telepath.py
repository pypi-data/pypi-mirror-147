...
class ShatailJSContextBase(JSContextBase):
    @property
    def base_media(self):
        return forms.Media(
            js=[
...
class ShatailAdapterRegistry(AdapterRegistry):
    js_context_base_class = ShatailJSContextBase


registry = ShatailAdapterRegistry(
    telepath_js_path="shatailadmin/js/telepath/telepath.js"
)
...
def adapter(js_constructor, base=Adapter):
    ...
    Is equivalent to:
        ...
        class MyWidgetAdapter(Adapter):
            js_constructor = 'shatail.mywidget'
