...
from shatail.admin.ui.tables import Column, TitleColumn
...
from shatail.permissions import locale_permission_policy
...
class LanguageTitleColumn(TitleColumn):
    cell_template_name = "shataillocales/_language_title_cell.html"
...
class CreateView(generic.CreateView):
    ...
    template_name = "shataillocales/create.html"
...
class EditView(generic.EditView):
    ...
    template_name = "shataillocales/edit.html"
    queryset = Locale.all_objects.all()
...
class DeleteView(generic.DeleteView):
    ...
    template_name = "shataillocales/confirm_delete.html"
    queryset = Locale.all_objects.all()
