...
from .shatail_tests import ShatailTestUtils


class ShatailPageTests(ShatailTestUtils, TestCase):
    """
    A set of asserts to help write tests for your own Shatail site.
    """
    ...
    def assertCanCreate(self, parent, child_model, data, msg=None):
        ...
        Shatail admin Page creation method.
        """
        ...
        explore_url = reverse("shatailadmin_explore", args=[parent.pk])
