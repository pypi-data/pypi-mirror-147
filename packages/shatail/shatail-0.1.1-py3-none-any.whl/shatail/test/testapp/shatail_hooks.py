...
from shatail.admin.action_menu import ActionMenuItem
from shatail.admin.menu import MenuItem
from shatail.admin.rich_text.converters.html_to_contentstate import BlockElementHandler
...
from shatail.admin.views.account import BaseSettingsPanel
