...
from shatail.admin.forms.collections import (
    BaseCollectionMemberForm,
    CollectionChoiceField,
    collection_member_permission_formset_factory,
)
from shatail.images.fields import ShatailImageField
from shatail.images.formats import get_image_formats
from shatail.images.models import Image
from shatail.images.permissions import permission_policy as images_permission_policy
...
def formfield_for_dbfield(db_field, **kwargs):
    ...
    if db_field.name == "file":
        return ShatailImageField(label=capfirst(db_field.verbose_name), **kwargs)
...
def get_image_base_form():
    base_form_override = getattr(settings, "SHATAILIMAGES_IMAGE_FORM_BASE", "")
...
GroupImagePermissionFormSet = collection_member_permission_formset_factory(
    ...
    "shatailimages/permissions/includes/image_permissions_formset.html",
)
