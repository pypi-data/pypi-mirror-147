...
class AdminImageChooser(AdminChooser):
    ...
    def render_html(self, name, value_data, attrs):
        ...
        return render_to_string(
            "shatailimages/widgets/image_chooser.html",
            {
                "widget": self,
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailimages/js/image-chooser-modal.js"),
                versioned_static("shatailimages/js/image-chooser.js"),
            ]
        )


class ImageChooserAdapter(WidgetAdapter):
    js_constructor = "shatail.images.widgets.ImageChooser"
    ...
    def media(self):
        return forms.Media(
            js=[
                versioned_static("shatailimages/js/image-chooser-telepath.js"),
            ]
        )
