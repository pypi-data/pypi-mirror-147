...
from shatail.images.models import Filter
from shatail.images.shortcuts import get_rendition_or_not_found
from shatail.images.views.serve import generate_image_url
...
@register.simple_tag()
def image_url(image, filter_spec, viewname="shatailimages_serve"):
    try:
        ...
        raise ImproperlyConfigured(
            ...
            "https://docs.shatail.org/en/stable/advanced_topics/images/image_serve_view.html#setup for instructions."
        )
