...
from shatail.images.rich_text import ImageEmbedHandler as FrontendImageEmbedHandler
from shatail.images.rich_text.editor_html import (
...
class TestEditorHtmlImageEmbedHandler(TestCase, ShatailTestUtils):
...
class TestFrontendImageEmbedHandler(TestCase, ShatailTestUtils):
