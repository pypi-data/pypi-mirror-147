...
from shatail.images import models
from shatail.images.forms import BaseImageForm, get_image_base_form, get_image_form
from shatail.test.testapp.media_forms import AlternateImageForm, OverriddenWidget
...
class TestImageFormOverride(TestCase):
    ...
    @override_settings(
        SHATAILIMAGES_IMAGE_FORM_BASE="shatail.test.testapp.media_forms.AlternateImageForm"
    )
