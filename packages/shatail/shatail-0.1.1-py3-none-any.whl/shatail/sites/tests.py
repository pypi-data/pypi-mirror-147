...
from shatail.models import Page, Site
from shatail.test.utils import ShatailTestUtils


class TestSiteIndexView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)

    def get(self, params={}):
        return self.client.get(reverse("shatailsites:index"), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/generic/index.html")
...
class TestSiteCreateView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)
    ...
    def get(self, params={}):
        return self.client.get(reverse("shatailsites:add"), params)

    def post(self, post_data={}):
        return self.client.post(reverse("shatailsites:add"), post_data)
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsites/create.html")
    ...
    def test_create(self):
        ...
        self.assertRedirects(response, reverse("shatailsites:index"))
...
class TestSiteEditView(TestCase, ShatailTestUtils):
    def setUp(self):
    ...
    def get(self, params={}, site_id=None):
        return self.client.get(
            reverse("shatailsites:edit", args=(site_id or self.localhost.id,)), params
        )
    ...
    def post(self, post_data={}, site_id=None):
        ...
        return self.client.post(
            reverse("shatailsites:edit", args=(site_id,)), post_data
        )

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsites/edit.html")
...
class TestSiteDeleteView(TestCase, ShatailTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)
        self.localhost = Site.objects.all()[0]
    ...
    def get(self, params={}, site_id=None):
        return self.client.get(
            reverse("shatailsites:delete", args=(site_id or self.localhost.id,)), params
        )

    def post(self, post_data={}, site_id=None):
        return self.client.post(
            reverse("shatailsites:delete", args=(site_id or self.localhost.id,)),
            post_data,
        )
...
class TestLimitedPermissions(TestCase, ShatailTestUtils):
    def setUp(self):
        # Create a user
    ...
    def test_get_index(self):
        response = self.client.get(reverse("shatailsites:index"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailadmin/generic/index.html")

    def test_get_create_view(self):
        response = self.client.get(reverse("shatailsites:add"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "shatailsites/create.html")

    def test_create(self):
        response = self.client.post(
            reverse("shatailsites:add"),
            {
                "hostname": "testsite",
                "port": "80",
                "root_page": str(self.home_page.id),
    ...
    def test_get_edit_view(self):
        edit_url = reverse("shatailsites:edit", args=(self.localhost.id,))
    ...
    def test_get_delete_view(self):
        delete_url = reverse("shatailsites:delete", args=(self.localhost.id,))
