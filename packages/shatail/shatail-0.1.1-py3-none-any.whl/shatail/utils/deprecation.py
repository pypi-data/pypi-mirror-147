...
class RemovedInShatail40Warning(DeprecationWarning):
    pass


removed_in_next_version_warning = RemovedInShatail40Warning


class RemovedInShatail50Warning(PendingDeprecationWarning):
    pass
...
class MovedDefinitionHandler:
    ...
    import sys
    from shatail.utils.deprecation import MovedDefinitionHandler, RemovedInShatailXWarning

    MOVED_DEFINITIONS = {
        'SomeClassOrVariableName': 'path.to.new.module',
    }

    sys.modules[__name__] = MovedDefinitionHandler(sys.modules[__name__], MOVED_DEFINITIONS, RemovedInShatailXWarning)
