...
from shatail.models import Locale, Page, PageViewRestriction, Site
...
class TestSpecificQuery(TestCase):
    ...
    def test_specific_query_with_search(self):
        ...
        pages = list(
            ...
            .live()
            .in_menu()
            .search(MATCH_ALL, backend="shatail.search.backends.database")
        )
    ...
    def test_specific_gracefully_handles_missing_rows(self):
        ...
        with mock.patch(
            "shatail.query.ContentType.objects.get_for_id",
