...
from shatail.admin.tests.test_contentstate import content_state_equal
from shatail.models import PAGE_MODEL_CLASSES, Page, Site
...
from shatail.test.utils import ShatailPageTests, ShatailTestUtils
from shatail.test.utils.form_data import (
    inline_formset,
    nested_form_data,
    rich_text,
    streamfield,
...
class TestAssertTagInHTML(ShatailTestUtils, TestCase):
...
class TestShatailPageTests(ShatailPageTests):
    def setUp(self):
        super().setUp()
    ...
    def test_assert_can_create_with_form_helpers(self):
        # same as test_assert_can_create, but using the helpers from shatail.test.utils.form_data
