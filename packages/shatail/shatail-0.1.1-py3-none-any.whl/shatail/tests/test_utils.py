...
class TestGetContentLanguages(TestCase):
    ...
    def test_must_be_subset_of_django_languages(self):
        ...
        self.assertEqual(
            e.exception.args,
            (
                "The language zh is specified in SHATAIL_CONTENT_LANGUAGES but not LANGUAGES. SHATAIL_CONTENT_LANGUAGES must be a subset of LANGUAGES.",
            ),
        )
...
class TestGetSupportedContentLanguageVariant(TestCase):
    ...
    def test_uses_shatail_content_languages(self):
...
@override_settings(
    USE_I18N=False,
    SHATAIL_I18N_ENABLED=False,
    SHATAIL_CONTENT_LANGUAGES=None,
    LANGUAGE_CODE="en-us",
)
class TestGetSupportedContentLanguageVariantWithI18nFalse(TestCase):
    ...
    def test_lookup_language_with_i18n_false(self):
        ...
        # https://github.com/shatail/shatail/issues/6539
