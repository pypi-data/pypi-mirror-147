...
from shatail.blocks import StreamBlockValidationError, StreamValue
...
from shatail.utils.deprecation import RemovedInShatail40Warning
...
class TestSystemCheck(TestCase):
    ...
    def tearDown(self):
        ...
        for package in ("shatailcore", "shatail.tests"):
            try:
...
class TestUseJsonFieldWarning(TestCase):
    ...
    def test_system_check_validates_block(self):
        ...
        with self.assertWarnsMessage(RemovedInShatail40Warning, message):
