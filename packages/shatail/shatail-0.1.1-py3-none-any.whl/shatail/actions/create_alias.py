...
from shatail.models.copying import _copy, _copy_m2m_relations
from shatail.models.i18n import TranslatableMixin
...
class CreatePageAliasAction:
    ...
    :param log_action: Override the log action with a custom one. or pass None to skip logging, defaults to 'shatail.create_alias'
