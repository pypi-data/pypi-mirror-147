...
class TestImageListing(TestCase):
    ...
    def get_response(self, **params):
        return self.client.get(reverse("shatailapi_v2:images:listing"), params)
    ...
    def test_basic(self):
        ...
        for image in content["items"]:
            ...
            # Type should always be shatailimages.Image
            self.assertEqual(image["meta"]["type"], "shatailimages.Image")
...
class TestImageDetail(TestCase):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(
            reverse("shatailapi_v2:images:detail", args=(image_id,)), params
        )
    ...
    def test_basic(self):
        ...
        self.assertEqual(content["meta"]["type"], "shatailimages.Image")
...
class TestImageFind(TestCase):
    ...
    def get_response(self, **params):
        return self.client.get(reverse("shatailapi_v2:images:find"), params)
    ...
    def test_find_by_id(self):
        ...
        self.assertRedirects(
            response,
            "http://localhost" + reverse("shatailapi_v2:images:detail", args=[5]),
