...
def initial_data(apps, schema_editor):
    ...
    homepage = Page.objects.create(
        title="Welcome to your new Shatail site!",
        slug="home",
        content_type=page_content_type,
        path="00010001",
        depth=2,
...
def set_page_path_collation(apps, schema_editor):
    ...
    See: https://groups.google.com/d/msg/shatail/q0leyuCnYWI/I9uDvVlyBAAJ
    """
    if schema_editor.connection.vendor == "postgresql":
        schema_editor.execute(
            """
            ALTER TABLE shatailcore_page ALTER COLUMN path TYPE VARCHAR(255) COLLATE "C"
        """
        )
...
class Migration(migrations.Migration):
    ...
    replaces = [
        ("shatailcore", "0001_initial"),
        ("shatailcore", "0002_initial_data"),
        ("shatailcore", "0003_add_uniqueness_constraint_on_group_page_permission"),
        ("shatailcore", "0004_page_locked"),
        ("shatailcore", "0005_add_page_lock_permission_to_moderators"),
        ("shatailcore", "0006_add_lock_page_permission"),
        ("shatailcore", "0007_page_latest_revision_created_at"),
        ("shatailcore", "0008_populate_latest_revision_created_at"),
        ("shatailcore", "0009_remove_auto_now_add_from_pagerevision_created_at"),
        ("shatailcore", "0010_change_page_owner_to_null_on_delete"),
        ("shatailcore", "0011_page_first_published_at"),
        ("shatailcore", "0012_extend_page_slug_field"),
        ("shatailcore", "0013_update_golive_expire_help_text"),
        ("shatailcore", "0014_add_verbose_name"),
        ("shatailcore", "0015_add_more_verbose_names"),
        ("shatailcore", "0016_change_page_url_path_to_text_field"),
    ]
