...
class KafkaConfig(BaseStreamDSConfig):
    ...
    def __init__(
        ...
        :param watermark_delay_threshold: (Optional) Watermark time interval, e.g: "24 hours", used by Spark Structured Streaming to account for late-arriving data. See: https://docs.tecton.ai/v2/overviews/framework/feature_views/stream_feature_view.html#productionizing-a-stream
        ...
        .. code-block:: python
            ...
            click_stream_kafka_ds = KafkaConfig(watermark_delay_threshold="7 days",
        ...
        if watermark_delay_threshold:
            args.watermark_delay_threshold.FromSeconds(strict_pytimeparse(watermark_delay_threshold))
