...
class KinesisConfig(BaseStreamDSConfig):
    ...
    def __init__(
        ...
        :param watermark_delay_threshold: Watermark time interval, e.g: "24 hours", used by Spark Structured Streaming to account for late-arriving data. See: https://docs.tecton.ai/v2/overviews/framework/feature_views/stream_feature_view.html#productionizing-a-stream
