...
class CloudRequests:
    ...
    def __init__(self, cloud_connection : _cloud.CloudConnection):
        """
        A class for sending information to Scratch via cloud variables. Requires the "CloudRequests" Scratch sprite made by TimMcCool.
        """
    ...
    def request(self, function):
        """
        Decorator. Will be called when the client receives a request with the function's name. The function's returned data will be sent back to the Scratch project.
        """
        self.requests.append(function)

    def event(self, function):
        """
        Will be called on an event, like "on_ready".
        """
    ...
    def _respond(self, request_id, response):
        """
        Don't use this. Inner function for responding to requests.
        """
