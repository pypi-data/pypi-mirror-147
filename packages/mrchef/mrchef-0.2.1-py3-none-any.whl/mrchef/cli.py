...
class MrChefCheck(cli.Application):
...
class MrChefFreeze(cli.Application):
...
class MrChefInit(cli.Application):
...
class MrChefMealAdd(cli.Application):
...
class MrChefMealLs(cli.Application):
    """List meals."""
...
class MrChefMealRm(cli.Application):
...
class MrChefSpiceAdd(cli.Application):
...
class MrChefSpiceExport(cli.Application):
...
class MrChefSpiceRm(cli.Application):
...
class MrChefUpdate(cli.Application):
...
class MrChefWarm(cli.Application):
