...
def disease_estimate_coef(pop_array,time_array,model_type='sir',metric='square_sum'):
    ...
    if model_type.lower()=='exp':
        ...
        x0 = 1
        bounds = [(0,10)]
        res = minimize(est_exp,x0,bounds)
        coefs['lam'] = res['x'][0]
    ...
    #--------------SIS-------------------#
        ...
        x0 = [1,1]
        bounds = [(0,10),(0,10)]
        res = minimize(est_sis,x0,bounds)
    ...
    #--------------SIR-------------------#
        ...
        x0 = [1,1]
        bounds = [(0,10),(0,10)]
        res = minimize(est_sir,x0,bounds)
        coefs['lam'],coefs['mu'] = res['x'][0],res['x'][1]   
    ...
    #--------------SEIR-------------------#
        ...
        res = minimize(est_seir,x0,bounds)
