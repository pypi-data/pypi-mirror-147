...
#This function will read all images under '/home/xxx/image', convert them to a 3D object as name of 'testtemp.pcd'. CAUTION! Unlike the build_on_each_folder() function, this's target is one folder!