...
#   timestamp: 2022-04-19T08:25:38+00:00
...
class Data(BaseModel):
    ...
    street1: Optional[str] = Field(
        None,
        description=(
            "The door number, floor, building number, building name, and/or street name of the billing or shipping"
            " address."
        ),
    ...
    street2: Optional[str] = Field(
        None,
        description=(
            "Secondary house number of the billing or shipping address. Used when more addresses are bundled to the"
            " same primary house number. If present, houseNumber1 is mandatory."
        ),
        example="Loe Street",
        regex="^[\\s\\S]{1,95}$",
    )
...
class NotificationUrl(BaseModel):
    __root__: AnyUrl = Field(
        ...,
        description=(
            "The Peach-provided URL to which the partner is required to send notifications or webhooks when the"
...
class DebitRequest(BaseModel):
    ...
    shopperResultUrl: AnyUrl = Field(
        ...,
        description="Only used to redirect back to Peach.",
