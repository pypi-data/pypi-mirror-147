...
def auto_conf_generator(args):
    ...
    args_name = {
        ...
        "hiveMetastoreUris-input-dataset" : "hive.metastore.uris",
        "hiveMetastoreUris-output-dataset" : "hive.metastore.uris",
        # MinIO
        ...
        "minIO_URL-input-dataset" : "spark.hadoop.fs.s3a.endpoint",
        "minIO_ACCESS_KEY-input-dataset" : "spark.hadoop.fs.s3a.access.key",
        "minIO_SECRET_KEY-input-dataset" : "spark.hadoop.fs.s3a.secret.key",
        "minIO_URL-output-dataset" : "spark.hadoop.fs.s3a.endpoint",
        "minIO_ACCESS_KEY-output-dataset" : "spark.hadoop.fs.s3a.access.key",
        "minIO_SECRET_KEY-output-dataset" : "spark.hadoop.fs.s3a.secret.key"
    }
