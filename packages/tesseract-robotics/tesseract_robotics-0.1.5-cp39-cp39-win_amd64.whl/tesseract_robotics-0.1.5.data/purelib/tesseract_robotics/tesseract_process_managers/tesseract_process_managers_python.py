...
class ProcessPlanningFuture(object, metaclass=_SwigNonDynamicMeta):
    ...
    Notes: This must not go out of scope until the process has finished
    """
    ...
    def getInput(self) -> "tesseract_planning::Instruction &":
        return _tesseract_process_managers_python.ProcessPlanningFuture_getInput(self)

    def getResults(self) -> "tesseract_planning::Instruction &":
        return _tesseract_process_managers_python.ProcessPlanningFuture_getResults(self)

    def getGlobalManipInfo(self) -> "tesseract_planning::ManipulatorInfo":
        return _tesseract_process_managers_python.ProcessPlanningFuture_getGlobalManipInfo(self)

    def getPlanProfileRemapping(self) -> "tesseract_planning::PlannerProfileRemapping":
        return _tesseract_process_managers_python.ProcessPlanningFuture_getPlanProfileRemapping(self)

    def getCompositeProfileRemapping(self) -> "tesseract_planning::PlannerProfileRemapping":
        return _tesseract_process_managers_python.ProcessPlanningFuture_getCompositeProfileRemapping(self)
