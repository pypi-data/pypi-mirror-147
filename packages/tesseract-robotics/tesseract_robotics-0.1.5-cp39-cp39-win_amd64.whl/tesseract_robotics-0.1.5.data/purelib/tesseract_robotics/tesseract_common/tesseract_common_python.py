...
class ManipulatorInfo(object, metaclass=_SwigNonDynamicMeta):
    ...
    """)
    tcp_offset = property(_tesseract_common_python.ManipulatorInfo_tcp_offset_get, _tesseract_common_python.ManipulatorInfo_tcp_offset_set, doc=r""" (Optional) Offset transform applied to the tcp_frame link to represent the manipulator TCP""")
