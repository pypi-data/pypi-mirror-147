...
_MLFLOW_FOR_MLFOUNDRY_ENV_VAR = "MLFLOW_FOR_MLFOUNDRY"
...
_is_for_mlfoundry = bool(os.environ.get(_MLFLOW_FOR_MLFOUNDRY_ENV_VAR))
logging.info("{} env var is set: {}".format(_MLFLOW_FOR_MLFOUNDRY_ENV_VAR, _is_for_mlfoundry))


if _is_for_mlfoundry:
    setup(
