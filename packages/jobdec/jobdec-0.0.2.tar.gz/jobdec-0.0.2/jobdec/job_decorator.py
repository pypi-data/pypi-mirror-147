...
class JobsCollection:
    def __init__(self, folder: Union[str, Path]):
        ...
        # Import modules: this creates a ScheduledJob for any function
        ...
        # TODO: Change this so that copies of jobs are returned?
        #       I'm not sure if this is vital for now but it doesn't
        #       feel ideal using the same global ScheduledJob objects
        #       in different JobsCollection objects.
