...
def anno_class_to_empty_component(anno_class) -> NluComponent:
    ...
    but has no model yet loaded onto it.
...
class ComponentUniverse:
    ...
    components = {
        ...
        H_A.ZERO_SHOT_RELATION_EXTRACTION: partial(NluComponent,
                                                   ...
                                                   description='Zero-shot relation extraction model that leverages BertForSequenceClassificaiton to return, based on a predefined set of relation',
                                                   provider=ComponentBackends.hc,
                                                   license=Licenses.hc,
                                                   computation_context=ComputeContexts.spark,
                                                   output_context=ComputeContexts.spark,
