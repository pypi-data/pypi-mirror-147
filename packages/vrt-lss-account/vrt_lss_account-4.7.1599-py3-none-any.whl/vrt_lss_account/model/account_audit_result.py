...
class AccountAuditResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'actions': ([AuditAction],),  # noqa: E501
            'statistics': (AuditStats,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, actions, statistics, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, actions, statistics, *args, **kwargs):  # noqa: E501
        """AccountAuditResult - a model defined in OpenAPI
