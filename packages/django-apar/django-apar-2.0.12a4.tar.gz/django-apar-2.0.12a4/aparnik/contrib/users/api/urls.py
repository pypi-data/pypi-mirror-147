...
from aparnik.contrib.users.api.views import UserSendSMSAPI, UserVerifySMSAPI, FCMAddTokenAPIView, UserLogoutAPIView, \
    UserTokenAPIView, UserForgetPasswordAPI, UserSubsetListAPIView, ThirdPartyTokenGeneratorApiView
...
urlpatterns = [
    ...
    url(r'^third-party-token-generate', ThirdPartyTokenGeneratorApiView.as_view(), name='third-party-token-generator'),
