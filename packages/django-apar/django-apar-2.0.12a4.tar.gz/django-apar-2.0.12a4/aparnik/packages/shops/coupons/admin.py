...
from .models import CouponForAllUser, CouponForCoustomUser, CouponForLimitedUser, ProductCoupon
...
class PaymentCouponInline(admin.TabularInline):
    model = ProductCoupon
    fields = ['product_obj', ]
