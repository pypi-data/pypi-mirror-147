...
class ClientHandshake(object):
    ...
    @classmethod
    def GetRootAsClientHandshake(cls, buf, offset=0):
...
def Start(builder):
    return ClientHandshakeStart(builder)
...
def AddSystemName(builder, systemName):
    return ClientHandshakeAddSystemName(builder, systemName)
def ClientHandshakeEnd(builder): return builder.EndObject()
def End(builder):
    return ClientHandshakeEnd(builder)