...
class Flowtrace:
    ...
    def serialize(self) -> geojson.feature.FeatureCollection:  # noqa C901
        ...
        # Flip the coords of intersection point so it is output as x,y
        flip_y, flip_x = featurecollection[0]["properties"]["intersection_point"]
        featurecollection[0]["properties"]["intersection_point"] = (flip_x, flip_y)
