...
import strangeworks
from strangeworks.rigetti.program import CompiledProgram, encrypted_program_to_json, program_to_json
from strangeworks.rigetti.compiler import StrangeworksCompiler
import base64
import pickle

class QuantumComputer():
    def __init__(self, name: str, as_qvm: bool):
        self.as_qvm = "True" if as_qvm else "False"
        self.name = name
        self.compiler= StrangeworksCompiler(target=name, as_qvm=self.as_qvm)
