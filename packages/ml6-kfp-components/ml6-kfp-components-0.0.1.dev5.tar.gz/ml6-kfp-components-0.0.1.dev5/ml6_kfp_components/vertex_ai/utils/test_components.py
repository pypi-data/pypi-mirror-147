...
from ml6_kfp_components.vertex_ai.utils import AddServingConfigOp
...
def test_add_serving_config(tmp_path: Path) -> None:
    ...
    _ = AddServingConfigOp.python_func(model=model, configured_model=configured_model, serving_config=serving_config)
