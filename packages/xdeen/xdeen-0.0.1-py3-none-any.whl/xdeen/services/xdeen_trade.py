...
from xdeen.services.auth import get_access_token
...
def report_exception(
    ...
    from xdeen.version import __version__ as xdeen_version
    info = {
        'os': jh.get_os(),
        'python_version': '{}.{}'.format(*jh.python_version()),
        'is_docker': jh.is_docker(),
        'xdeen_version': xdeen_version
    }
    if has_live:
        from xdeen_live.version import __version__ as live_plugin_version
