...
from xdeen.services import logger as xdeen_logger
import threading
import traceback
from xdeen.services.redis import sync_publish
...
def terminate_session():
    ...
    xdeen_logger.error('Session terminated as the result of an uncaught exception')
