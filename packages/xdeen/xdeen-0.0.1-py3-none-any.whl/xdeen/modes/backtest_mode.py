...
import xdeen.services.metrics as stats
import xdeen.services.required_candles as required_candles
import xdeen.services.selectors as selectors
from xdeen import exceptions
from xdeen.config import config
from xdeen.enums import timeframes, order_types
from xdeen.models import Candle, Order, Position
from xdeen.modes.utils import save_daily_portfolio_balance
from xdeen.routes import router
from xdeen.services import charts
from xdeen.services import quantstats
from xdeen.services import report
from xdeen.services.cache import cache
from xdeen.services.candle import generate_candle_from_one_minutes, print_candle, candle_includes_price, split_candle
from xdeen.services.file import store_logs
from xdeen.services.validators import validate_routes
from xdeen.store import store
from xdeen.services import logger
from xdeen.services.failure import register_custom_exception_handler
from xdeen.services.redis import sync_publish, process_status
from timeloop import Timeloop
from datetime import timedelta
from xdeen.services.progressbar import Progressbar
...
def run(
    ...
    from xdeen.config import config, set_config
    ...
    for r in router.routes:
        ...
        try:
            ...
            raise exceptions.InvalidStrategy(
                ...
                "\nIf you need working examples, check out: https://github.com/xdeen-ai/example-strategies"
            )
        except:
            raise
