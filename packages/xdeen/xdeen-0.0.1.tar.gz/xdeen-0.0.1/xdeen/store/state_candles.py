...
from xdeen.enums import timeframes
from xdeen.exceptions import RouteNotFound
from xdeen.libs import DynamicNumpyArray
from xdeen.models import store_candle_into_db
...
class CandlesState:
    ...
    def add_candle(
        ...
        if candle[0] == 0:
            if jh.is_debugging():
                logger.error("DEBUGGING-VALUE: please report to Sherif: candle[0] is zero")
            return
