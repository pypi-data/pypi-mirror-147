...
class_map: Dict[str, Type[JSONMixin]] = {'rectangle': Rectangle, 'sharedStyleContainer': SharedStyleContainer, 'bitmap': Bitmap, 'paragraphStyle': ParagraphStyle, 'swatch': Swatch, 'page': Page, 'shapeGroup': ShapeGroup, 'shapePath': ShapePath, 'MSImmutableOverrideProperty': OverrideProperty, 'group': Group, 'MSImmutableForeignLayerStyle': ForeignLayerStyle, 'assetCollection': AssetCollection, 'MSImmutableFreeformGroupLayout': FreeformGroupLayout, 'sharedStyle': SharedStyle, 'border': Border, 'curvePoint': CurvePoint, 'fontDescriptor': FontDescriptor, 'slice': Slice, 'MSImmutablePatchInfo': PatchInfo, 'MSJSONOriginalDataReference': DataRef, 'exportOptions': ExportOptions, 'MSImmutableColorAsset': ColorAsset, 'color': Color, 'gradientStop': GradientStop, 'MSImmutableForeignSymbol': ForeignSymbol, 'fontReference': FontRef, 'symbolMaster': SymbolMaster, 'artboard': Artboard, 'overrideValue': OverrideValue, 'MSJSONFileReference': FileRef, 'triangle': Triangle, 'attributedString': AttributedString, 'graphicsContextSettings': GraphicsContextSettings, 'symbolInstance': SymbolInstance, 'MSImmutableForeignTextStyle': ForeignTextStyle, 'stringAttribute': StringAttribute, 'innerShadow': InnerShadow, 'style': Style, 'polygon': Polygon, 'simpleGrid': SimpleGrid, 'star': Star, 'symbolContainer': SymbolContainer, 'MSImmutableGradientAsset': GradientAsset, 'imageCollection': ImageCollection, 'rulerData': RulerData, 'swatchContainer': SwatchContainer, 'exportFormat': ExportFormat, 'MSImmutableForeignSwatch': ForeignSwatch, 'textStyle': TextStyle, 'colorControls': ColorControls, 'fill': Fill, 'sharedTextStyleContainer': SharedTextStyleContainer, 'rect': Rect, 'MSImmutableHotspotLayer': Hotspot, 'gradient': Gradient, 'MSImmutableInferredGroupLayout': InferredGroupLayout, 'MSImmutableFlowConnection': FlowConnection, 'text': Text, 'borderOptions': BorderOptions, 'oval': Oval, 'shadow': Shadow, 'layoutGrid': LayoutGrid, 'blur': Blur}