...
def whatsapp_eval_image_overlay(client, update: Update, context: CallbackContext, picture, x_position="left", y_position="up", resize="x"):
    if resize in ["False", "false"]:
        resize = False
    ...
    s3_client.put_object(Bucket="tiergarten-assets-whatsapp",
                            Key="eval_ghost" + "/" + time_str  + "_" +
                            str(update.WaId) + '.png',
                            Body=bio,
                            ACL='public-read',
    ...
    client.messages.create(
            media_url="https://tiergarten-assets.fra1.digitaloceanspaces.com/eval_ghost/" +
            time_str + "_" + str(update.WaId) + '.png',
            from_=update.To,
            to=update.From
        )
...
whatsapp_action_functions = {"eval_gif_generation": whatsapp_eval_gif_generation,
                             "eval_image_overlay": whatsapp_eval_image_overlay
                             }
