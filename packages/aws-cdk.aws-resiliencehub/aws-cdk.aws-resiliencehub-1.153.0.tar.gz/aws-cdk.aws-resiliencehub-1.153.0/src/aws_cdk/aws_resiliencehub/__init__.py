...
class CfnApp(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        resource_mappings: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union["CfnApp.ResourceMappingProperty", aws_cdk.core.IResolvable]]],
...
class CfnResiliencyPolicy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        policy: typing.Union[aws_cdk.core.IResolvable, typing.Mapping[builtins.str, typing.Union[aws_cdk.core.IResolvable, "CfnResiliencyPolicy.FailurePolicyProperty"]]],
