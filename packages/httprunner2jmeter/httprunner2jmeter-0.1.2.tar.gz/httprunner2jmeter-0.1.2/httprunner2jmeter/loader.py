...
from httprunner2jmeter import builtin, utils
from httprunner2jmeter import exceptions
from httprunner2jmeter.models import TestCase, ProjectMeta, TestSuite
...
def load_folder_files(folder_path: Text, recursive: bool = True) -> List:
    ...
    for dirpath, dirnames, filenames in os.walk(folder_path):
        ...
        for filename in filenames:
            if not filename.lower().endswith((".yml", ".yaml", ".json", "_test.jmx")):
                continue
