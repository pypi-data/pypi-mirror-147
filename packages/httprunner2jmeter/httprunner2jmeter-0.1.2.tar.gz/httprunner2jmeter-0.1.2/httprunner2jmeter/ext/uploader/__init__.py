...
from httprunner2jmeter.models import TStep, FunctionsMapping
from httprunner2jmeter.parser import parse_variables_mapping
...
def multipart_encoder(**kwargs):
    ...
    for key, value in kwargs.items():
        ...
        if os.path.isabs(value):
            ...
            from httprunner2jmeter.loader import load_project_meta
