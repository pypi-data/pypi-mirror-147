...
class ActService(object):
    ...
    def placeSecurityListRequestFIX(self, request, timeout=None):
        return self.connector.create_request('placeSecurityListRequestFIX', request, timeout)

    def placeSecurityListRequest(self, request, timeout=None):
        return self.connector.create_request('placeSecurityListRequest', request, timeout)