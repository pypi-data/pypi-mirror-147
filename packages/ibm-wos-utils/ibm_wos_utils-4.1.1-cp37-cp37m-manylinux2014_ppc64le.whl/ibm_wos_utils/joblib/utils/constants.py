...
DELEGATION_TOKEN_PARAMS = ["ae.spark.remoteHadoop.isSecure", "ae.spark.remoteHadoop.services",
                           "ae.spark.remoteHadoop.delegationToken", "spark.hadoop.hive.metastore.kerberos.principal", "spark.hadoop.hive.metastore.uris"]
