...
from errors import M3ELInputNoneError as InputNoneError
from errors import M3ELInputTypeError as TypeError
from errors import M3ELInvalidOperation as InvalidOperation


class M3ELLoaderException(Exception):
    pass


class M3ELStepConfigError(Exception):
    pass
...
class M3ELInputTypeError(Exception):
    pass


class M3ELInputNoneError(Exception):
    pass


class M3ELTypeMismatchError(Exception):
    pass


class M3ELInvalidOperation(Exception):
    pass
