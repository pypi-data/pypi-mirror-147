...
from duplremover.resourse_and_gears import note_printer, printer, hash_str, get_file_size
    ...
    def start(self):
        ...
        if return_dict:
            for the_type, dp_lis in return_dict.items():
                ...
                printer(tn)
                for dpl in dp_lis:
                    note_printer(dpl, top_note=get_file_size(dpl[0]), fill_str='-', disordered_mode=True, front_color="red", item_type='file')
            return return_dict
