    ...
    **Autogenerated function**
    ...
    Args:
        ...
        node_role(Text): The Amazon Resource Name (ARN) of the IAM role to associate with your node group.
            ...
            they are launched.
        resource_id(Text, optional): AWS EKS Node group name to identify the resource
    ...
    if before and before["ret"]:
        ...
        try:
            ...
            try:
                ...
                result["result"] = False
            result["comment"] = f"Created aws.eks.nodegroup '{name}'"
...
async def absent(
    hub, ctx, name: str, cluster_name: str, resource_id: str, timeout: Dict = None
) -> Dict[str, Any]:
    r"""
    **Autogenerated function**
    ...
    Args:
        name(Text): A name, ID to identify the resource.
        cluster_name(Text): The name of the cluster to create the node group in.
        resource_id(Text): AWS EKS Node group ID to identify the resource
    ...
    if not before["ret"]:
        result["comment"] = (f"aws.eks.nodegroup '{name}' already absent",)
        ...
        try:
            ...
            if not result["result"]:
                ...
                try:
                    ...
                    result["result"] = False
            result["comment"] = result["comment"] + (
                f"Deleted aws.eks.nodegroup '{name}'",
            )
        except Exception as e:
            result["comment"] = result["comment"] + (f"{e.__class__.__name__}: {e}",)
