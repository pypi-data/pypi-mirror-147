...
class F5562():
    ...
    def goTo5562(self):
        return [
            ...
            "label": "Start/Edit for 5562 form",
    ...
    def makeFormDps(self):
        ...
        return self.didNotTravel(False)+[
            {
            "action_type": Action.RepeatSection.value,
            "button_text": "Add another", 
            "value": values
        ...
        ]+self.pdf+self.saveContinue() if len(values)>0 else self.didNotTravel(True)
    ...
    def makeFormPaSp(self):
        ...
        if len(self.pa.travel)>0:
            pa_travel_content=self.didNotTravel(False)+pa+self.makeContentPaSp(Role.PA)
        else:
        ...
        return  pa_travel_content+sp_travel_content
