...
LONG_DESCRIPTION = ('This package contains OpenAI Gym environment designed for training RL agents to balance double CartPole. '
                    ...
                    'https://github.com/mareo1208/Double-cartpole-custom-gym-env-for-reinforcement-learning.git you can find a '
                    'detailed description of the environment, along with a description of the package installation and sample '
                    'code made to train and evaluate agents in this environment. Additionally, there is code showing how to '
                    'use the library StableBaselines3 and Optuna to search for the best hyperparameters. All examples are available '
                    'in two versions: as a script ready to run on your computer and as a script ready to run in the Google Colab '
                    'service.<br /><br />This environment was created for the needs of my bachelor\'s thesis, available '
...
setup(
    ...
    url='https://github.com/mareo1208/Double-cartpole-custom-gym-env-for-reinforcement-learning.git',
