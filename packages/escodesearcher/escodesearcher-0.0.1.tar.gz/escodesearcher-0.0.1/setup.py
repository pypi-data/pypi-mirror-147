...
setuptools.setup(
    ...
    url="https://github.com/xTrimy/escodesearcher",
    project_urls={
        "Bug Tracker": "https://github.com/xTrimy/escodesearcher/issues",
        "Documentation": "https://github.com/xTrimy/escodesearcher/README.md",
    ...
    package_dir={"": "escodesearcher"},
    packages=setuptools.find_packages(where="escodesearcher"),
    python_requires=">=3.6",
)
