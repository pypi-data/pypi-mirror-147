...
class CfnDataIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        schedule_config: typing.Union["CfnDataIntegration.ScheduleConfigProperty", aws_cdk.core.IResolvable],
...
class CfnEventIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        event_filter: typing.Union[aws_cdk.core.IResolvable, "CfnEventIntegration.EventFilterProperty"],
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[aws_cdk.core.CfnTag]] = None,
    ) -> None:
