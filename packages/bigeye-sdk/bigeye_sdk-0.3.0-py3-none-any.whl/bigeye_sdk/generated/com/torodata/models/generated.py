...
class ThreeLeggedBoolean(betterproto.Enum):
    ...
    the reciever to tell if there is no filter, or if the filter is set to
    false.
    """
...
class MetricSortField(betterproto.Enum):
    ...
    METRIC_SORT_FIELD_METRIC_TYPE = 1
...
class CatalogIndexWorkflowType(betterproto.Enum):
    CATALOG_INDEX_WORKFLOW_TYPE_UNSPECIFIED = 0
    CATALOG_INDEX_WORKFLOW_TYPE_SOURCE = 1
    CATALOG_INDEX_WORKFLOW_TYPE_SCHEMA = 2
    CATALOG_INDEX_WORKFLOW_TYPE_DATASET = 3
...
class EntityId(betterproto.Message):
    table_id: int = betterproto.int32_field(1, group="id")


@dataclass
class FlatNode(betterproto.Message):
    id: "EntityId" = betterproto.message_field(1)
    parent_relationships: List["Relationship"] = betterproto.message_field(2)
    child_relationships: List["Relationship"] = betterproto.message_field(3)


@dataclass
class RelationshipFlatGraph(betterproto.Message):
    nodes: List["FlatNode"] = betterproto.message_field(1)


@dataclass
class GetRelationshipsResponse(betterproto.Message):
    lineage: "RelationshipFlatGraph" = betterproto.message_field(1)


@dataclass
class Relationship(betterproto.Message):
    id: int = betterproto.int32_field(1)
    parent: "EntityId" = betterproto.message_field(2)
    child: "EntityId" = betterproto.message_field(3)


@dataclass
class CreateRelationshipsRequest(betterproto.Message):
    relationships: List["Relationship"] = betterproto.message_field(1)


@dataclass
class CreateRelationshipsResponse(betterproto.Message):
    relationships: List["Relationship"] = betterproto.message_field(1)


@dataclass
class DeleteRelationshipResponse(betterproto.Message):
    deleted_relationship: "Relationship" = betterproto.message_field(1)


@dataclass
class DeleteRelationshipsResponse(betterproto.Message):
    deleted_relationships: List["Relationship"] = betterproto.message_field(1)
...
class CatalogIndexRequest(betterproto.Message):
    id: int = betterproto.int32_field(1)
    workflow_type: "CatalogIndexWorkflowType" = betterproto.enum_field(2)
...
class LineageServiceStub(betterproto.ServiceStub):
    ...
    async def create_lineage_relationships(
        ...
        return await self._unary_unary(
            "/com.torodata.models.generated.LineageService/CreateLineageRelationships",
            request,
            CreateRelationshipsResponse,
        )

    async def delete_lineage_relationship(
        self, *, lineage_id: int = 0
    ) -> DeleteRelationshipResponse:
        """Delete lineage relationship"""

        request = SinglePathParamLineageIdRequest()
        request.lineage_id = lineage_id
...
class TableServiceStub(betterproto.ServiceStub):
    ...
    async def get_table_lineage(self, *, table_id: int = 0) -> GetRelationshipsResponse:
        ...
        return await self._unary_unary(
            "/com.torodata.models.generated.TableService/GetTableLineage",
            request,
    ...
    async def delete_table_lineage(
        ...
        """Delete lineage for table"""

        request = SinglePathParamTableIdRequest()
        request.table_id = table_id

        return await self._unary_unary(
            "/com.torodata.models.generated.TableService/DeleteTableLineage",
            request,
            DeleteRelationshipsResponse,
        )
