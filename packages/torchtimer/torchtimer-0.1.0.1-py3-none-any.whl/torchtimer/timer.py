...
class ProfilingTimer:
  ...
  def start(self, name, context_name=None):
    if self._enabled:
      if context_name is None:
        context_name = self._main_context_name
  ...
  def end(self, name, context_name=None):
    if self._enabled:
      current_time = self.gct()
      if context_name is None:
        context_name = self._main_context_name
  ...
  def stop(self, name, context_name=None):
    self.end(name, context_name)

  def stop_and_start(self, stop_name=None, start_name=None, context_name=None):
    if stop_name is not None:
      self.stop(stop_name, context_name)
