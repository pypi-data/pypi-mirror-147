...
class Capsule(nn.Module):
    ...
    def save(self, save_to):
        ...
        save_to = save_to.lower().replace(".pth", "") + ".report"
        ...
        try:
            for epoch in range(num_epochs):
                ...
                if val_dl is not None:
                    self.evaluate(val_dl, report=self.report, device=device)
    ...
    def evaluate(self, val_dl, report=None, device="cuda"):
        if report is None:
            show_report = True
            report = Report(1)
        else:
        ...
        for ix, data in enumerate(val_dl):
            ...
            report.record(pos=((ix + 1) / N), **loss, end="\r")
