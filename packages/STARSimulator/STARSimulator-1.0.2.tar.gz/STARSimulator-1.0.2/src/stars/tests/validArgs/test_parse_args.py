...
class TestParseArgs(unittest.TestCase):
    ...
    def test_no_arg(self):
        ...
        values = [args.assemble, args.debug, args.garbage, args.disp_instr_count, args.warnings, args.cli]
    ...
    def test_boolean_long_args(self):
        '''
           Tests the argument parser with all the boolean long argument options except --cli. 
    ...
    def test_required_filename(self):
        '''
            Tests the argument parser with one of the following: --cli, -a/--asssemble, 
            -d/--debug. The argument parser requires a filename.
        '''
        options = ["--cli", "-a", "--assemble", "-d", "--debug"]
