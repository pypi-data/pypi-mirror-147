...
class FeaturesEnricher(TransformerMixin):  # type: ignore
    ...
    def fit_transform(
        ...
        **fit_params : dict
        ...
        try:
            return self.__inner_fit(X, y, eval_set, extract_features=True, **fit_params)
        except Exception as e:
    ...
    def __inner_transform(
        ...
        #     result, result_eval_set = self.__enrich(
        #         df, validation_task.get_all_validation_raw_features(), X.index, self.keep_input
        #     )

        #     sp.ok("Done                         ")
        #     return result, result_eval_set
