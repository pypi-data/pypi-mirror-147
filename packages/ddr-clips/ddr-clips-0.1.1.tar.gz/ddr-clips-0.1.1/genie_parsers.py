...
class ShowPlatformSoftwareSteeringpolicyForwardingmanagerServiceId():
    ...
    def parse(self, output=None):
        ...
        if out:
            steering_dict = parsed_dict.setdefault('steeringpolicy_service', {})
...
class ShowIpLispMapserver():
    ...
    def parse(self, output=None):
        ...
        if out:
            lisp_dict = parsed_dict.setdefault('lispmap_instance', {})
            stebind_dict = lisp_dict.setdefault('per_instance_dict', {})
...
class ShowLispSession():
    ...
    def parse(self, output=None):
        ...
        if out:
            lisp_dict = parsed_dict.setdefault('lispsession_instance', {})
...
class ShowLispInstanceidIpv4Server():
    ...
    def parse(self, output=None):
        ...
        if out:
            lisp_dict = parsed_dict.setdefault('lispmsmr_instance', {})
            stebind_dict = lisp_dict.setdefault('per_instance_dict', {})
