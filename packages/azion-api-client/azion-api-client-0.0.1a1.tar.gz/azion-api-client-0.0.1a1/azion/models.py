...
class EdgeApplication(object):
    ...
    def __init__(self, data):
        self.id = data['id']
        self.name = data['name']
        # TODO: check attributes when listing or single

        #self.delivery_protocol = data['delivery_protocol']
        #self.active = data['active']
        #self.edge_firewall = data['edge_firewall']
        #self.edge_functions = data['edge_functions']
        #self.web_application_firewall = data['web_application_firewall']
