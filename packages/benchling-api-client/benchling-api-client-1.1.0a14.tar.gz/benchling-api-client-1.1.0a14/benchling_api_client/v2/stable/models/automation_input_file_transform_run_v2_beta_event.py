...
from ..models.automation_input_file_transform_run_v2_beta_event_event_type import (
...
T = TypeVar("T", bound="AutomationInputFileTransformRunV2BetaEvent")


@attr.s(auto_attribs=True, repr=False)
class AutomationInputFileTransformRunV2BetaEvent:
    """  """

    _automation_input_file: Union[Unset, AutomationInputGenerator] = UNSET
    _event_type: Union[Unset, AutomationInputFileTransformRunV2BetaEventEventType] = UNSET
    ...
    def __repr__(self):
        fields = []
        fields.append("automation_input_file={}".format(repr(self._automation_input_file)))
        ...
        return "AutomationInputFileTransformRunV2BetaEvent({})".format(", ".join(fields))

    def to_dict(self) -> Dict[str, Any]:
        automation_input_file: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self._automation_input_file, Unset):
            automation_input_file = self._automation_input_file.to_dict()
        ...
        field_dict.update({})
        if automation_input_file is not UNSET:
            field_dict["automationInputFile"] = automation_input_file
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_automation_input_file() -> Union[Unset, AutomationInputGenerator]:
            automation_input_file: Union[Unset, AutomationInputGenerator] = UNSET
            _automation_input_file = d.pop("automationInputFile")
            if not isinstance(_automation_input_file, Unset):
                automation_input_file = AutomationInputGenerator.from_dict(_automation_input_file)

            return automation_input_file

        automation_input_file = (
            get_automation_input_file()
            if "automationInputFile" in d
            else cast(Union[Unset, AutomationInputGenerator], UNSET)
        )

        def get_event_type() -> Union[Unset, AutomationInputFileTransformRunV2BetaEventEventType]:
            event_type = None
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = AutomationInputFileTransformRunV2BetaEventEventType(_event_type)
                except ValueError:
                    event_type = AutomationInputFileTransformRunV2BetaEventEventType.of_unknown(_event_type)
        ...
        event_type = (
            get_event_type()
            if "eventType" in d
            else cast(Union[Unset, AutomationInputFileTransformRunV2BetaEventEventType], UNSET)
        )
        ...
        automation_input_file_transform_run_v2_beta_event = cls(
            automation_input_file=automation_input_file,
        ...
        automation_input_file_transform_run_v2_beta_event.additional_properties = d
        return automation_input_file_transform_run_v2_beta_event
    ...
    @property
    def automation_input_file(self) -> AutomationInputGenerator:
        if isinstance(self._automation_input_file, Unset):
            raise NotPresentError(self, "automation_input_file")
        return self._automation_input_file

    @automation_input_file.setter
    def automation_input_file(self, value: AutomationInputGenerator) -> None:
        self._automation_input_file = value

    @automation_input_file.deleter
    def automation_input_file(self) -> None:
        self._automation_input_file = UNSET

    @property
    def event_type(self) -> AutomationInputFileTransformRunV2BetaEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AutomationInputFileTransformRunV2BetaEventEventType) -> None:
