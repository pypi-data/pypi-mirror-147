...
T = TypeVar("T", bound="NucleotideSequenceBaseRequest")


@attr.s(auto_attribs=True, repr=False)
class NucleotideSequenceBaseRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "NucleotideSequenceBaseRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nucleotide_sequence_base_request = cls(
            aliases=aliases,
        ...
        nucleotide_sequence_base_request.additional_properties = d
        return nucleotide_sequence_base_request
