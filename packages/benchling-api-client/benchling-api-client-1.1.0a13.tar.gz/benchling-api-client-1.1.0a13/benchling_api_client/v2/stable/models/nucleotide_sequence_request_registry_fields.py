...
T = TypeVar("T", bound="NucleotideSequenceRequestRegistryFields")


@attr.s(auto_attribs=True, repr=False)
class NucleotideSequenceRequestRegistryFields:
    """  """
    ...
    def __repr__(self):
        ...
        return "NucleotideSequenceRequestRegistryFields({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nucleotide_sequence_request_registry_fields = cls(
            entity_registry_id=entity_registry_id,
        )

        nucleotide_sequence_request_registry_fields.additional_properties = d
        return nucleotide_sequence_request_registry_fields
