...
def _get_kwargs(
    *,
    client: Client,
    input_processor_id: str,
    json_body: LabAutomationTransformUpdate,
) -> Dict[str, Any]:
    url = "{}/automation-input-file/{input_processor_id}".format(
        client.base_url, input_processor_id=input_processor_id
    )
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        client=client,
        input_processor_id=input_processor_id,
        json_body=json_body,
    )
...
def sync(
    *,
    ...
    """ Update a running Lab Automation input processor """
