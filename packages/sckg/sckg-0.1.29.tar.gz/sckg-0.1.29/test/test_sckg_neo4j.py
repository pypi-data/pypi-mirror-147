...
class TestSckgNeo4j(unittest.TestCase):
    ...
    def test_get_id_by_concept(self):
        ...
        password = 'fdsefdse'
        sckg_neo4j = SoftwareKGSearcher(url, user, password)
        print(sckg_neo4j.get_id_by_concept('d'))
    ...
    def test_get_node_by_concept(self):
        ...
        # print(sckg_neo4j.get_node_by_concept('vuejs'))
    ...
    def test_is_stop_word(self):
        ...
        password = 'fdsefdse'
        sckg_neo4j = SoftwareKGSearcher(url, user, password)
        print(sckg_neo4j.is_stop_word('open'))
    ...
    def test_get_out_relation_by_concept(self):
        ...
        password = 'fdsefdse'
        sckg_neo4j = SoftwareKGSearcher(url, user, password)
        re = sckg_neo4j.get_out_relation_by_concept('vuejs')
        for i in re:
            print(i)
    ...
    def test_find_longest_valid_concept_from_sentence(self):
        ...
        password = 'fdsefdse'
        sckg_neo4j = SoftwareKGSearcher(url, user, password)
        print(sckg_neo4j.t_find_longest_valid_concept_from_sentence(
            'how to open files and write data and paragraphs into it?'))
        print(sckg_neo4j.t_find_longest_valid_concept_from_sentence(
