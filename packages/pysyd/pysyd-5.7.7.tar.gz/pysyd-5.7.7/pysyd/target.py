    ...
    def frequency_spacing(self, n_peaks=10,):
        ...
        # if fit converged, save appropriate results
            ...
            if self.i == 0:
                ...
                self.params['plotting'][self.module].update({
                  'peaks_l':self.peaks_l,'peaks_a':self.peaks_a,'best_lag':self.params['best_lag'],
                  'best_auto':self.params['best_auto'],'obs_dnu':gauss[2], 
