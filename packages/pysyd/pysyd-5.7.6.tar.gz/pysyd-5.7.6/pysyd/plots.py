...
def _plot_parameters(star, subfilename='background_only.png', filename='global_fit.png', n_peaks=5, cmap='binary',):
    ...
    ax4.scatter([f], [p], s=35.0, edgecolor='orange', marker='d', facecolor='none', linewidths=1.0, zorder=5)
    ...
    ax4.plot([ff], [pp], color='cyan', marker='s', markersize=7.5, zorder=2)
    ...
    ax5.scatter(params['peaks_f'], params['peaks_p'], s=30.0, edgecolor='orange', marker='o', facecolor='none', linewidths=1.0)
