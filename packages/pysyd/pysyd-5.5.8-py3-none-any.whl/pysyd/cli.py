...
####
    ...
    parent_parser = argparse.ArgumentParser(description="High-level functionality")
...
####
    ...
    data_parser = argparse.ArgumentParser(description="Input data & manipulation")
...
####
    ...
    main_parser = argparse.ArgumentParser(description="Core pipeline analyses")
