...
def _plot_parameters(star, subfilename='background_only.png', filename='global_fit.png', n_peaks=10, cmap='binary',):
    ...
    ax4.scatter(params['region_freq'][idx], params['region_pow'][idx], edgecolor='cyan', marker='d', facecolor='none', linewidths=1.0, markersize=25.0, zorder=5)
...
#    peaks_f, peaks_p = utils._max_elements(freq, psd, star.params['n_peaks'])
    peaks_idx, _ = find_peaks(params['zoom_pow'], distance=star.params['obs_dnu']/6.)
...
#    ax5.scatter(peaks_f, peaks_p, s=25.0, edgecolor='r', marker='s', facecolor='none', linewidths=1.0)
    ...
    peaks_idx, _ = find_peaks(params['auto'], distance=star.params['obs_dnu']/6.)
