...
class CfnDetector(
    ...
    def __init__(
        ...
        *,
        ...
        event_type: typing.Union["CfnDetector.EventTypeProperty", aws_cdk.core.IResolvable],
...
class CfnEventType(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        entity_types: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, "CfnEventType.EntityTypeProperty"]]],
