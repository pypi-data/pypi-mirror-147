...
def rotate_func(args):
    ...
    xyz_py.rotate_coords(coords, args.alpha, args.beta, args.gamma)
...
def read_args(arg_list=None):
    ...
    rotate = subparsers.add_parser(
        'rotate',
        description="Rotate xyz file by alpha, beta, gamma in radians using \
                     Easyspin convention"
    )
    ...
    rotate.add_argument(
        'alpha',
        type=float,
        help='Alpha angle in radians'
    )

    rotate.add_argument(
        'beta',
        type=float,
        help='Beta angle in radians'
    )

    rotate.add_argument(
        'gamma',
        type=float,
        help='Gamma angle in radians'
    )
