...
class MeasurementFormSchemaDto(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        part_number: str,
        exclude_from_customer_documentation: bool,
        versions: List["_models.MeasurementFormVersionDto"],
        is_used: bool,
        status: Union[str, "_models.MeasurementFormStatus"],
        source: Union[str, "_models.MeasurementFormSource"],
        extra_schemas: List["_models.MeasurementFormLinkedSchemaDto"],
...
class MeasurementFormVersionDto(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        specification: Optional[str] = None,
        elements: Optional[List["_models.MeasurementFormElementDto"]] = None,
        **kwargs
    ):
        """
        :keyword id:
