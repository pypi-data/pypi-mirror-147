...
class CfnApplication(
    ...
    def __init__(
        ...
        *,
        ...
        resource_lifecycle_config: typing.Optional[typing.Union["CfnApplication.ApplicationResourceLifecycleConfigProperty", aws_cdk.core.IResolvable]] = None,
    ) -> None:
...
class CfnApplicationVersion(
    ...
    def __init__(
        ...
        *,
        ...
        source_bundle: typing.Union[aws_cdk.core.IResolvable, "CfnApplicationVersion.SourceBundleProperty"],
        description: typing.Optional[builtins.str] = None,
    ) -> None:
