...
class BaseSerializer(BaseField):
    ...
    def protobuf(self):
        ...
        fields = self.child.fields.values() if hasattr(self, 'child') else self.fields.values()
        removable = [field.field_name for field in fields if field.db_only]
