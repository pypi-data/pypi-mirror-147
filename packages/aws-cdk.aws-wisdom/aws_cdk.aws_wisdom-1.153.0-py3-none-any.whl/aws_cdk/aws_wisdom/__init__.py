...
class CfnAssistant(
    ...
    def __init__(
        ...
        *,
        ...
        server_side_encryption_configuration: typing.Optional[typing.Union["CfnAssistant.ServerSideEncryptionConfigurationProperty", aws_cdk.core.IResolvable]] = None,
...
class CfnAssistantAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        association: typing.Union[aws_cdk.core.IResolvable, "CfnAssistantAssociation.AssociationDataProperty"],
