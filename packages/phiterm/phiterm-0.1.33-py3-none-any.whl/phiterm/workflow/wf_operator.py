...
def run_workflow(
    ...
    print_info(f"Running workflow: {wf_description}")
    ...
    if workflow_name is None and task_name is not None:
        logger.warning(f"Task: {task_name} provided without a Workflow")
