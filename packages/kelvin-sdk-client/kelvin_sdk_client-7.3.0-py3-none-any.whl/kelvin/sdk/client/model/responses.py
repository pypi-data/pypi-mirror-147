...
class AssetClass(DataModelBase):
    ...
    created: Optional[datetime] = None
    entity_type_name: Optional[str] = Field(None, max_length=64)
    entity_type_title: Optional[str] = Field(None, max_length=64)
    name: Optional[str] = Field(None, max_length=64)
    owner: Optional[str] = Field(None, max_length=64)
    title: Optional[str] = Field(None, max_length=64)
    updated: Optional[datetime] = None
    ...
    def list_asset_class(
        ...
        **Permission Required:** `kelvin.permission.asset_class.read`.
        ...
        entity_type_name : :obj:`Sequence[str]`
            Filter by Entity Type Name. Prefix any `entity_type_name` with the
            character `!` for a NOT operation
...
class AssetType(DataModelBase):
    ...
    asset_class_entity_type_name: Optional[str] = Field(None, max_length=64)
    asset_class_entity_type_title: Optional[str] = Field(None, max_length=64)
    ...
    def list_asset_type(
        ...
        **Permission Required:** `kelvin.permission.asset_type.read`.
        ...
        owner : :obj:`str`
            Filter Asset Class by owner. Possible Values: kelvin/custom
        entity_type_name : :obj:`Sequence[str]`
            Filter by asset class entity type Name. Prefix any `entity_type_name`
            with the character `!` for a NOT operation
...
class MapItem(DataModelBase):
    ...
    def create_map(
        ...
        **kwargs:
        ...
        result = self_or_cls._make_request(
            ...
            requests.MapCreate,
            False,
            {"201": Map, "400": errors.ErrorMessage, "401": errors.ErrorMessage},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_maps(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[MapItem], MapListPaginated]:
        """
        List Maps

        **Pagination Sortable Columns:** `map.name`, `map.title`, `map_version.start_date`
        ...
        **Permission Required:** `kelvin.permission.maps.read`.
        ...
        ----------
        timestamp : :obj:`str`
            Timestamp to search for a specific version (supports RFC3339 and Unix
    ...
    @instance_classmethod
    @DataModelBase.translate({"map_name": "name"})
    def delete_map(self_or_cls, map_name: str, _dry_run: bool = False, _client: Any = None) -> None:
        """
        Delete Map
    ...
    def list_versions(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[MapVersionItem], MapVersionListPaginated]:
        """
        List Versions for a single map

        **Pagination Sortable Columns:** `map.name`, `map_version.start_date`
...
class MapListPaginated(PaginatorDataModel[MapItem]):
    ...
    data: Optional[List[MapItem]] = None
    pagination: Optional[pagination.Pagination] = None
...
class MapVersionListPaginated(PaginatorDataModel[MapVersionItem]):
    ...
    data: Optional[List[MapVersionItem]] = None
    pagination: Optional[pagination.Pagination] = None
...
class User(DataModelBase):
    ...
    def list_user_settings(
        ...
        _dry_run: bool = False,
        _client: Any = None,
    ) -> Union[Sequence[UserSettingItem], UserSettingsListPaginated]:
        """
        List User Settings
...
class AssetItem(DataModelBase):
    ...
    def list_asset(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        entity_type_name : :obj:`Sequence[str]`
            Filter assets by entity type. Prefix any `entity_type_name` with the
            character `!` for a NOT operation
        page_size : :obj:`int`
            Number of objects to be returned, between 1 and 1000. Default: 20
        starting_after : :obj:`str`
    ...
    def list_asset_template(
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        entity_type_names : :obj:`Sequence[str]`
            Entity Type Names. Prefix any `entity_type_name` with the character
            `!` for a NOT operation
