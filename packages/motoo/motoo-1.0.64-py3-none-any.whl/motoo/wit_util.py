...
def greater_than_float(operands):
    return sequantial_compare_calculation(lambda data1, data2 : np.nan if np.isnan(data1) or np.isnan(data2) else 1.0 if data1 > data2 else 0.0, operands)
...
def not_equals_float(operand1, operand2):
    return two_elements_calculation(lambda data1, data2 : np.nan if np.isnan(data1) or np.isnan(data2) else 1.0 if data1 != data2 else 0.0, operand1, operand2)
