...
class recset(Generic[T]):
    ...
    def filter(self, w):
        ...
        # セッションチェック
        self.__checkSession(False, False)
    ...
    def __checkSession(self, __autoCommit = True, __beginTransaction = False):
        ...
        if self.__session is None:
            ...
            # autocommit=Onの場合はtrunsactionを開始する
